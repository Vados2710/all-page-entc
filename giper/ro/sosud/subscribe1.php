...
curl_setopt($ch, CURLOPT_URL, '13-ro.frio-card.ru/submit' );
	...
	<div class="content">
		<div class="panel">
			<div class="panel-body">
				<div class="thank-you">Mulțumesc! Comanda dvs. <span class="thank-you__order-id">№<?php echo $_SESSION['conversion_id']; ?></span> este cu succes acceptat!</div>
                    <div class="we-will-call-you we-will-call-you__timer" style="display: none;">
                        Vă vom contacta în <span class="we-will-call-you__countdown">00:07:00</span> minute
                    </div>
                    <div class="we-will-call-you we-will-call-you__title">
                        În viitorul apropiat, managerul vă va suna înapoi pentru a clarifica detaliile.
                    </div>
				<form class="parent x_resubmit_form">
					<div class="data js-data">
						<div class="data__block">
							<div class="data__item">
								<span class="data__key">Numele dvs.:</span>
								<span class="x_client_name"><?php echo $_POST["name"]?></span>
							</div>
							<div class="data__item">
								<span class="data__key">Numarul dvs. de telefon:</span>
				...
				<div class="cta">
					<div class="cta__item">
						...
						Verificați dacă telefonul este introdus corect
					</div>
					<div class="cta__item">
						<svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
							<circle cx="20" cy="20" r="19" stroke="#FFD028" stroke-width="2" />
					...
					<div class="cta__item">
						...
						Răspundeţi la apel de la un număr necunoscut
					</div>
				</div>
			</div>
			<div class="subscribe__bar" style="display: none;">
				<span>Primiți o reducere permanentă</span>
				<svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path d="M1 6L7 12L13 6M1 1L7 7L13 1" stroke="black"></path>
				</svg>
			</div>
			<div class="subscribe">
				<div class="subscribe__cta">Obțineți o reducere permanentă de 50% la următoarea dvs. achiziție!</div>
				<form class="subscribe__input" action="/mail-subscribe.php" method="post">
					<input
						type="email" name="email" placeholder="Introduceți adresa dvs. de email" autocomplete="email" required
					>
					<input type="hidden" name="order_id" value="<?php echo $_SESSION['conversion_id']; ?>">
					<button type="submit">
						<span class="subscribe__submit-text">Abonaţi-vă</span>
