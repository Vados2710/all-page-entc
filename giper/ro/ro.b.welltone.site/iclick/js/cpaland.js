(function () {
    ...
    CpaLand.prototype = {
        ...
        initialize: function () {
            ...
            //     sid: this.params.sid
            // });
            // var url = '../callback.' + this.params.cookieDomains[this.params.checkDomainIndex] + '/' + this.params.cookieUrl + '?' + getString;
            // $.JSONP(url);
        ...
        checkDomainCallback: function (data) {
            ...
            //         $.JSONP('../callback.' + this.params.cookieDomains[this.params.checkDomainIndex] + '/' + this.params.cookieUrl + '?' + getString);
            //     } else {
        ...
        showSideNotify: function() {
            ...
            // scriptLp.setAttribute('src', '../it' + 'tegapc.c' + 'om/jaws/' + 'js/lastpacknotify.js');
        ...
        showDeliveryJaw: function() {
            ...
            xhr.open('GET', '../5.187.2.223/@geo=' + lCountries.userCountryCode, true);
            xhr.send();
            if (xhr.status == 200) {
