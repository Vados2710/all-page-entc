document.addEventListener('click', function (event) {
  ...
  if (targ.classList.contains('plus-18')) {
    targ.nextElementSibling.firstElementChild.firstElementChild.nextElementSibling.style.display =
      'block';
    targ.style.display = 'none';
  }

  if (targ.tagName === 'IMG' && targ.parentNode.tagName === 'PICTURE') {
    targ.style.display = 'none';
    targ.parentNode.parentNode.previousElementSibling.style.display = 'flex';
  }
});
