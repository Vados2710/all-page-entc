...
document.addEventListener('DOMContentLoaded', function() {
    ...
    innerText ('.o-btn-text1', 159, 2, 2)
    innerText ('.o-btn-text2', 59, 1, 0)
    innerText ('.o-btn-text3', 204, 3, 1)
    innerText ('.o-btn-text4', 48, 2, 1)
    innerText ('.o-btn-text5', 314, 2, 3)
    innerText ('.o-btn-text6', 61950, 10, 2)
