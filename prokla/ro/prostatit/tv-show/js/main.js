...
var Test = function() {
	...
	var dataTestResult = [{
			title: 'Vă mulțumim pentru răspunsuri! Din păcate, ești la doar câțiva pași de consecințe fatale. Pentru a nu înceta să fii bărbat în sensul cel mai adevărat al cuvântului, începe terapia acum!',
	}, {
			title: 'Vă mulțumim pentru răspunsuri! Din păcate, ești la doar câțiva pași de consecințe fatale. Pentru a nu înceta să fii bărbat în sensul cel mai adevărat al cuvântului, începe terapia acum!',
	}];
	return {
			...
			showQuestion: function showQuestion() {
					...
					btnTest.click(function(e) {
							...
							if (count == 4) {
									btnTest.text("Obțineți rezultatul");
							}
