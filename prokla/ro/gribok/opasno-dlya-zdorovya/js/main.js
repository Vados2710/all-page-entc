  ...
  function initFeatures(settings) {
      ...
      if (!settings.formApi || !settings.formApi.isNeeded) {
          var featuresFilesSrc = (window.location.protocol == 'file:') ? {
              ...
              autoCommStyles: 'css/autoCom.css',
  ...
  var currencyMain = ' ' + settings.formApi.currencyMain;        
      ...
      var commBlocks = {
          'mk': {
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Нарачав. Со попуст! Се надевам дека сè ќе биде во ред</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Не бери гајле! Не ми е прв пат да нарачувам ' + settings.product + ', сите нарачки ги доставуваат цели и во пакување</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Денеска ми стаса  ' + settings.product + '. Ќе го употребувам, треба да помогне.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Фала за можноста да се нарача со попуст! И порано имам нарачувано ' + settings.product + ', но многу поскапо. Нема што, за ефикасност треба да се плаќа, ама вредеше.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Импресивен напис, ќе пробам. Нарачав неколку, се надевм ќе помогне </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Се разбира дека ќе помогне! За мене овој производ не е актуален, но неколку мои пријатели го користеа и многу го фалеа.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">Произведувач ' + settings.product + '</span>Внимание! Во врска со тоа што ' + settings.product + ' скоро ќе почне да се продава во аптеките, количината е ограничена, за сите нема да стаса. Денеска се купени над 5000 пакувања.  </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Нарачав неколку, скоро ќе престане он-лајн купувањето. А во аптеките цените ќе бидат повисоки.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Мојот другар се врати денес од Јапонија и замислете само – видел во аптека ' + settings.product + '. Таму коштал околу $70 за 1 пакување, и дури и за таа цена купуваат! Чудно!</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Да, нарачав. Фала, порано не знаев за  ова средство. Ги читав одзивите и коментарите – па сите се задоволни, главно е да купиш фалсификат, така што подобро е овде за нарачување.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',
          ...
          'ru': {
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>' + genGenderWords(0) + ' заказ. ' + genGenderWords(1) + ' со скидкой! Надеюсь все будет хорошо</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Не волнуйся! Я уже не первый раз заказываю ' + settings.product + ', все заказы доставляются в целости в упаковке</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Сегодня ' + genGenderWords(2) + ' ' + settings.product + '. Буду использовать, должно помочь.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Спасибо за возможность заказать со скидкой! Я и раньше ' + genGenderWords(3) + ' ' + settings.product + ', но значительно дороже. Что поделать, за эффективность нужно было платить, но оно того стоило.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Очень впечатлила статья, буду пробовать. ' + genGenderWords(4) + ' сразу несколько штук, надеюсь поможет</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Конечно поможет! Для меня этот продукт не актуален, но несколько моих знакомых пользовались  и все очень хвалили.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">Производитель ' + settings.product + '</span>Внимание! В связи с тем, что ' + settings.product + ' скоро начнет продаваться в аптеках, количество товара ограничено, товара на всех может не хватить. За сегодня куплено более 5 000 упаковок. </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>' + genGenderWords(5) + ' заказать несколько штук ,ведь скоро планируют прекратить онлайн-продажу. А в аптеках точно цены будут выше.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Мой друг сегодня вернулся из Японии и представляете - он видел в аптеке ' + settings.product + '. Там он стоил около $70 за одну упаковку, и люди даже за эту цену покупают! Обалдеть!</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Фух, ' + genGenderWords(6) + ' заказать. Спасибо, раньше не ' + genGenderWords(7) + ' про это средство. ' + genGenderWords(8) + ' отзыва в интернете - вроде все довольны, главное не купить подделку, так что лучше тут заказывать.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',
           ...
           'lt': {
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>' + genGenderWords(0) + ' tvarka. ' + genGenderWords(1) + ' su nuolaida! Tikiuosi, kad viskas bus gerai</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Nesijaudinkite! Aš ne pirmas kartas ' + settings.product + ', visi užsakymai pristatomi saugiai pakuotėje</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Šiandien ' + genGenderWords(2) + ' ' + settings.product + '. Aš naudosiu, turėčiau padėti.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Dėkojame už galimybę užsakyti su nuolaida! Aš anksčiau ' + genGenderWords(3) + ' ' + settings.product + ', bet daug brangiau. Ką daryti, reikėjo mokėti už efektyvumą, bet tai buvo verta.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Labai sužavėtas straipsnis, aš pabandysiu. ' + genGenderWords(4) + ' tik kelis gabalus, tikiuosi padėti</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Žinoma, tai padės! Man šis produktas nėra aktualus, tačiau keletas mano draugų jį naudojo ir labai gyrė visus.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">Gamintojas ' + settings.product + '</span>Dėmesio! Dėl to, kad ' + settings.product + ' Netrukus jis bus parduodamas vaistinėse, prekių kiekis yra ribotas, prekės visiems gali būti nepakankamos. Šiandien nupirkta daugiau nei 5000 paketų. </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>' + genGenderWords(5) + ' užsakyti kelis gabalus, nes netrukus planuojate sustabdyti pardavimą internetu. Ir vaistinėse kainos bus didesnės.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Mano draugas šiandien grįžo iš Japonijos ir įsivaizduoja - jis matė vaistinėje ' + settings.product + '. Ten jis kainuoja apie 70 JAV dolerių už vieną paketą, o žmonės netgi nusipirko už šią kainą! Tai nuostabus!</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Wow, ' + genGenderWords(6) + ' pagal. užsakymą Ačiū, ne anksčiau ' + genGenderWords(7) + ' apie šį įrankį. ' + genGenderWords(8) + ' atsiliepimai internete - visi atrodo laimingi, svarbiausia yra ne pirkti netikrą, todėl geriau užsisakyti čia.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',
            ...
            'pl': {
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>' + genGenderWords(0) + ' zamówienie ' + genGenderWords(1) + ' ze zniżką! Mam nadzieję, że wszystko będzie dobrze</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Nie martw się! Nie po raz pierwszy zamawiam ' + settings.product + ', wszystkie zamówienia są dostarczane bezpiecznie w paczce</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Dzisiaj ' + genGenderWords(2) + ' ' + settings.product + '. Będę używał, powinien pomóc.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Dziękujemy za możliwość zamówienia ze zniżką! Ja wcześniej ' + genGenderWords(3) + ' ' + settings.product + ', ale znacznie droższe. Co trzeba zrobić, trzeba było zapłacić za wydajność, ale było warto.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Pod wrażeniem tego artykułu, spróbuję. ' + genGenderWords(4) + ' tylko kilka kawałków, mam nadzieję, że pomogę</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Oczywiście, że pomoże! Dla mnie ten produkt nie jest istotny, ale kilku moich znajomych go użyło i bardzo chwalił wszystkich.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">Producent ' + settings.product + '</span>Uwaga! Ze względu na to, że ' + settings.product + ' Wkrótce będzie sprzedawany w aptekach, ilość towarów jest ograniczona, towary dla wszystkich mogą nie wystarczyć. Ponad 5000 paczek zostało dzisiaj kupionych. </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>' + genGenderWords(5) + ' zamów kilka sztuk, ponieważ wkrótce planują zatrzymać sprzedaż online. A w aptekach ceny będą wyższe.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Mój przyjaciel dzisiaj wrócił z Japonii i wyobraził sobie - zobaczył w aptece ' + settings.product + '. Tam kosztuje około 70 dolarów za jedną paczkę, a ludzie nawet kupują za tę cenę! To niesamowite!</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Wow, ' + genGenderWords(6) + ' zamówić. Dzięki, nie wcześniej ' + genGenderWords(7) + ' o tym narzędziu. ' + genGenderWords(8) + ' recenzje w Internecie - wszyscy wydają się szczęśliwi, najważniejsze, żeby nie kupować fałszywek, więc lepiej tu zamówić.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',
          ...
          'hu': {
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>' + genGenderWords(0) + ' megbízás. ' + genGenderWords(1) + ' kedvezménnyel! Remélem, minden rendben lesz</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Ne aggódj! Nem én vagyok az első alkalom, amikor megrendelek ' + settings.product + ', az összes megrendelést biztonságosan szállítjuk a csomagban</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Ma' + genGenderWords(2) + ' ' + settings.product + '. Segíteni fogok.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Köszönjük a lehetőséget, hogy kedvezményt kapjon! Én korábban ' + genGenderWords(3) + ' ' + settings.product + ', de sokkal drágább. Mi a teendő, a hatékonyságért kellett fizetni, de megéri.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Nagyon megdöbbent a cikk, megpróbálom. ' + genGenderWords(4) + ' csak néhány darab, remélem, hogy segítek</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Természetesen segít! Számomra ez a termék nem releváns, de néhány barátom ezt használta, és mindenkit dicsérte.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">Gyártó ' + settings.product + '</span>Figyelem! Az a tény, hogy ' + settings.product + ' Hamarosan a gyógyszertárakban értékesítik, az áruk mennyisége korlátozott, lehet, hogy nem lesz elég áru mindenkinek. Több mint 5000 csomag vásárolt ma. </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>' + genGenderWords(5) + ' rendeljen néhány darabot, mert hamarosan meg akarja állítani az online értékesítést. És a gyógyszertárakban az árak magasabbak lesznek.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>A barátom ma Japánból jött vissza és elképzelte - látta a gyógyszertárban ' + settings.product + '. Ott körülbelül 70 dollárba kerül egy csomag, és az emberek még ezt az árat is megvásárolják! Ez félelmetes!</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Wow, ' + genGenderWords(6) + ' rendelésre Köszönöm, nem korábban ' + genGenderWords(7) + ' erről az eszközről. ' + genGenderWords(8) + ' vélemények az interneten - mindenki boldognak tűnik, a fő dolog nem hamisítvány megvásárlása, ezért jobb itt megrendelni.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',
          ...
          'lv': {
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>' + genGenderWords(0) + ' kārtībā. ' + genGenderWords(1) + ' ar atlaidi! Es ceru, ka viss būs labi</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Neuztraucieties! Es neesmu pirmā reize, kad es pasūtu ' + settings.product + ', visi pasūtījumi tiek piegādāti drošā iepakojumā </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Šodien ' + genGenderWords(2) + ' ' + settings.product + '. Man būs jāpalīdz.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Paldies par iespēju pasūtīt ar atlaidi! Es iepriekš ' + genGenderWords(3) + ' ' + settings.product + ', bet daudz dārgāk. Ko darīt, bija jāmaksā par efektivitāti, bet tas bija tā vērts.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Ļoti pārsteigts ar rakstu, es centīšos. ' + genGenderWords(4) + ' tikai daži gabali, es ceru palīdzēt</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Protams, tas palīdzēs! Man šis produkts nav būtisks, bet daži no maniem draugiem to izmantoja un ļoti slavēja ikvienu.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">Ražotājs ' + settings.product + '</span>Uzmanību! Sakarā ar to, ka ' + settings.product + ' Drīz tas tiks pārdots aptiekās, preču daudzums ir ierobežots, preces visiem var nebūt pietiekamas. Šodien ir nopirkti vairāk nekā 5000 iepakojumu. </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>' + genGenderWords(5) + ' pasūtīt dažus gabalus, jo drīz plāno pārtraukt pārdošanu tiešsaistē. Un aptiekās cenas būs augstākas.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Mans draugs šodien atgriezās no Japānas un iedomāties - viņš redzēja aptiekā ' + settings.product + '. Tur tas maksā apmēram 70$ dolārus par vienu paketi, un cilvēki pat par šo cenu pērk! Tas ir awesome!</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Wow, ' + genGenderWords(6) + ' pēc pasūtījuma Paldies, ne agrāk ' + genGenderWords(7) + ' par šo rīku. ' + genGenderWords(8) + ' pārskati internetā - visi šķiet laimīgi, galvenais nav pirkt viltotu, tāpēc ir labāk pasūtīt šeit.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>' + genGenderWords(0) + ' objednávky. ' + genGenderWords(1) + ' so zľavou! Dúfam, že všetko bude v poriadku</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Nebojte sa! Nie som prvýkrát, čo som si objednal ' + settings.product + ', všetky objednávky sú dodávané bezpečné v balení</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Dnes ' + genGenderWords(2) + ' ' + settings.product + '. Budem používať, by som mal pomôcť.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Ďakujeme Vám za možnosť objednať si zľavu! Ja predtým ' + genGenderWords(3) + ' ' + settings.product + ', ale oveľa drahšie. Čo robiť, bolo potrebné zaplatiť za efektívnosť, ale stálo to za to.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a> Veľmi dojem na článok, budem sa snažiť ' + genGenderWords(4) + ' len pár kusov, dúfam, že pomôžem </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Samozrejme to pomôže! Pre mňa tento produkt nie je relevantný, ale niektorí z mojich priateľov to využili a všetci veľmi chválili.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">Výrobca ' + settings.product + '</span>Varovanie! Vzhľadom k tomu, že ' + settings.product + ' Čoskoro sa bude predávať v lekárňach, množstvo tovaru je obmedzené, nemusí byť dostatok tovaru pre každého. Dnes bolo zakúpených viac ako 5000 balíčkov.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>' + genGenderWords(5) + ' objednať niekoľko kusov, pretože čoskoro plánujú zastaviť online predaj. A v lekárňach budú ceny vyššie.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Moja priateľka sa dnes vrátila z Japonska a predstavila si - videl v lekárni ' + settings.product + '. Tam to stálo asi 70 dolárov za jeden balík, a ľudia dokonca kúpiť za túto cenu! To je úžasné!</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Wow, ' + genGenderWords(6) + ' na objednávku Ďakujem, predtým ste to nevedeli ' + genGenderWords(7) + ' o tomto nástroji. ' + genGenderWords(8) + ' recenzie na internete - všetci sa zdajú šťastní, hlavnou vecou nie je kúpiť falošný, takže je lepšie objednať tu.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',		
          ...
          'si': {
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>' + genGenderWords(0) + ' sem. ' + genGenderWords(1) + ' sem naročiti po nižji ceni! Upam, da bo vse v redu</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Brez skrbi! Ne naročam prvič ' + settings.product + ', vsa naročila dobim v celoti</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Danes sem ' + genGenderWords(2) + ' ' + settings.product + '. Bom  ' + genGenderWords(10) + ', moralo bi pomagati.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Hvala za možnost naročila po nižji ceni! Prej sem tudi  ' + genGenderWords(3) + ' ' + settings.product + ', bilo je veliko dražje. Kaj češ, učinkovitost nekaj stane.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Članek je name naredil vtis, bom  ' + genGenderWords(4) + ' sem takoj nekaj kosov, upam, da bo šlo na boljše</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Seveda bo! Zame ta izdelek ni potreben, ampak ga je nekaj mojih znancev uporabljalo, so zelo zadovoljni.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">Proizvajalec ' + settings.product + '</span>Pozor! Glede dejstva da se bo ' + settings.product + ' začel prodajati tudi v lekarnah, količina je omejena, možno je da ne bo dovolj za vse. Danes so kupili 5 000 paketov.  </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>' + genGenderWords(5) + ' sem naročiti nekaj kosov, saj se bo kmalu končala spletna prodaja. V lekarnah pa bodo cene ziher višje.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Moj prijatelj se je danes vrnil iz Japonske in si lahko zamislite - da je videl v lekarni ' + settings.product + '. Stal je tam približno $70 en paket, tudi to kupujejo! Ne morem verjeti!</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Joj, ' + genGenderWords(6) + ' sem naročiti. Hvala, nisem prej ' + genGenderWords(7) + ' za tole sredstvo.  ' + genGenderWords(8) + ' sem vtise na spletu - vsi so nekakor zadovoljni, pomembno je da ne kupite ponaredka, tako da je bolje naročiti kar tu.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',
          ...
          'sg': {
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>訂單。 管理（一）折扣！ 我希望一切都會好起來的</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>別擔心！ 我不是第一次訂購' + settings.product + ', 所有訂單都在包裹中安全送達</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>今天收到' + settings.product + '. 我會用，應該幫忙。</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>感謝您有機會以折扣價訂購！ 我以前訂購了' + settings.product + '但要貴得多。 該怎麼做，有必要為效率付出代價，但這是值得的。</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>文章印象非常深刻，我會盡力。 我一次訂購了幾件，我希望它會有所幫助</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>當然會有所幫助！ 對我來說，這個產品並不重要，但我的一些朋友使用它並非常讚揚所有人。</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">生產廠家' + settings.product + '</span>注意! 由于' + settings.product + '很快就會在藥店出售，商品數量有限，所有商品可能都不夠。 今天已經購買了5,000多個包裹 </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a> 管理到訂購幾件，因為很快計劃停止在線銷售。 在藥店，價格會更高。</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>我的朋友今天從日本回來想像 - 他在藥店看到了' + settings.product + '. 一個套餐的價格大約是70美元，人們甚至買這個價格！ 太棒了！</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>啊，訂購了。 謝謝，之前不知道這個工具。 我在互聯網上閱讀評論 - 每個人似乎都很開心，最主要的不是購買假貨，所以最好在這裡訂購。</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',
          ...
          'ro': {
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Am făcut comandă, Am prins cu reducere! Sper că totul va fi bine</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Nu îți face griji! Nu e prima oară când fac comandă ' + settings.product + ', toate comenzile se adaugă întregi în pachet</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Azi am primit ' + settings.product + '. Îl voi folosi, îmi trebuie ajutor.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Mulțumesc pentru posibilitatea de a comanda cu reducere! Și înainte făceam comenzi ' + settings.product + ' dar erau mai scumpe. Nu aveam ce face, pentru efectivitate trebuia să plătesc, dar a meritat aceasta.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>M-a impresionat foarte mult articolul, voi încerca. Am comandat deodată câteva bucăți, sper că mă v-a ajuta.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Sigur că te ajută! Pentru mine, acest produs nu este actual, dar câteva dintre cunoștințele mele l-au folosit și l-au lăudat.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">Producător ' + settings.product + '</span>Atenție! Datorită faptului, că ' + settings.product + ' în curând se va vinde în farmacii , iar cantitatea produsului este limitată, produsul nu va fi îndeajuns pentru toți. Azi au fost cumpărate mai mult de 5000 de pachete. </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Am reușit să comand câteva bucăți, deoarece în curând se plănuiește să se întrerupă vânzarea online. Iar în farmacii sigur prețurile vor fi mai mari.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Prietenul meu s-a întors din Japonia și imaginați-vă – l-a văzut în farmacie ' + settings.product + '. Acolo costă în jur de $70 pentru un pachet, și lumea cumpără chiar și la acest preț! Uimitor!</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Pff, am reușit să comand. Mulțumesc, înainte nu știam de acest mijloc, Am citit pe internet recenzii – toți par mulțumiți, important este să nu cumperi făcături, așa că cel mai bine comandă aici.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',
          ...
          'cz': {
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>' + genGenderWords(0) + '  si. ' + genGenderWords(1) + ' se slevou! Doufám, že bude vše v pořádku</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Nebojte se! Objednávám si ne poprvé  ' + settings.product + ', všechny objednávky se doručují v pořádku v balení</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Dnes ' + genGenderWords(2) + ' ' + settings.product + '. Budu používat, mělo by zabrat.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Děkuji za možnost si objednat se slevou! I dřív jsem ' + genGenderWords(3) + ' ' + settings.product + ', ale dražší. Nedá se nic dělat, za efektivitu se musí platit, ale stálo to za to.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Překvapil mě moc článek, budu zkoušet. ' + genGenderWords(4) + ' jsem si hned několik balení, doufám, že pomůže</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Určitě pomůže! Pro mě tento výrobek není aktuální, ale několik známých ho zkoušeli a moc doporučovali.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">Výrobce ' + settings.product + '</span>Pozor! Vzhledem k tomu, že ' + settings.product + ' začne se brzy prodávat v lékárnách, je množství výrobků omezené, může se stát, že pro někoho už nezbyde. Dnes je zakoupeno vice než 5000 balení. </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>' + genGenderWords(5) + ' jsem objednat několik balení, vždyť brzy plánují přestat prodávat online. A v lékárnách ceny budou vyšší.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Můj kamarád se dnes vrátil z Japonska a představte si – viděl v lékárnách ' + settings.product + '. Tam to stálo kolem $70 za jedno balení, a lidé dokonce kupují i za takovou cenu! To je něco!</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Ufff, ' + genGenderWords(6) + ' jsem. Děkuji, dřív jsem ' + genGenderWords(7) + ' o tomto přípravku. ' + genGenderWords(8) + ' jsem si recenze na internetu – všichni jsou spokojeni, hlavně nenarazit na padělek, takže lepší objednávejte tady.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',
          ...
          'ph': {
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Umorder. Nakakuha ng diskwento! Sana ay ayos ang lahat.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Huwag mag alala! Hindi ito ang unang beses kong pag order ng  ' + settings.product + ' Lahat ng order ay naibibigay ng ligtas at maayos na nakaimpake.  </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Natanggap ang ' + settings.product + '. ngayong araw. Gagamitin ito para makatulong. </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Salamat sa pagkakataon na maka order ng may diskwento! Naka order na ako ng ' + settings.product + ', noon pa, ngunit ito ay mas mahal. Pero ano ang magagawa mo? Dapat bayaran ang magandang serbisyo at ito ay sulit.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Kahanga-hangang artikulo kaya susubukan ito. Umorder ng ilang piraso, sana makakatulong ito. </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Siguradong makakatulong ito! Ang produktong ito ay hindi nakakabagay sa akin, pero ang ilang kaibigan ko ay gumagamit nito at tuwang-tuwa sila sa naging resulta.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">Tagagawa ng ' + settings.product + '</span>Atensyon!  Dahil ang  ' + settings.product + ' ay malapit ng ibebenta sa parmasya, at limitado lang ang pwedeng ibenta, kaya maaaring hindi sapat para sa lahat. Mahigit 5000 na pakete ang naibenta ngayon. </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Nagawang umorder ng ilang piraso bago matapos ang online sale. Mas mataas ang presyo nito sa mga parmasya.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Kauuwi lang ng kaibigan ko galing Japan at alam mo ba kung ano ang nakita niya – nakita niya ang ' + settings.product + '. sa mga lokal na parmasya. Nagkakahalaga ng $70 sa bawat pakete doon, at binibili pa rin ng mga tao! Wow!</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Phew, nagawang umorder sa tamang oras, Maraming salamat, hindi ko alam ang tungkol sa gamot na ito dati. Nabasa ko ang mga kumento sa internet – mukhang masaya ang lahat. Ang pinaka mahalaga ay huwag makabili ng peke, kaya mas mabuting umorder dito. </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',
          ...
          'vn': {
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Mình vừa đặt mua hàng xong. Vẫn kịp mua giá khuyến mãi! Hy vọng là mọi thứ đều tốt đẹp.</div><div class="comment-action"><span class="like">Thích</span><span class="reply">Trả lời</span><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">Vừa xong</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Đừng lo! Đây không phải là lần đầu tiên tôi đặt mua ' + settings.product + ', tất cả các đơn hàng đều được mang đến nguyên vẹn trong bỏ vọc.</div><div class="comment-action"><span class="like">Thích</span><span class="reply">Trả lời</span><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">Vừa xong</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Hôm nay tôi đã nhận dược ' + settings.product + '. Tôi sẽ dùng thử, chắc chắn là phải có hiệu quả.</div><div class="comment-action"><span class="like">Thích</span><span class="reply">Trả lời</span><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">Vừa xong</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Xin cảm ơn về giá khuyến mãi! Trước đây tôi cũng đã từng đặt mua ' + settings.product + ', nhưng với giá cao hơn khá nhiều. Biết phải làm sao bây giờ, của nào thì tiền đấy thôi, nhưng mà phải công nhận là rất đáng đồng tiền bát gạo.</div><div class="comment-action"><span class="like">Thích</span><span class="reply">Trả lời</span><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">Vừa xong</span></div></div>',	
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Bài viết rất ấn tượng, tôi sẽ dùng thử. Tôi đã đặt mua liền mấy gói, hy vọng là đạt được kết quả mong muốn.</div><div class="comment-action"><span class="like">Thích</span><span class="reply">Trả lời</span><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">Vừa xong</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Tất nhiên là có hiệu quả rồi! Tôi thì bây giờ không còn cần đến nó nữa, nhưng nhiều người quen của tôi đã dùng thử và nói dùng rất thích.</div><div class="comment-action"><span class="like">Thích</span><span class="reply">Trả lời</span><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">Vừa xong</span></div></div>',
              autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">Nhà sản xuất ' + settings.product + '</span>Xin lưu ý! Vì lý do ' + settings.product + ' sắp được bày bán tại các hiệu thuốc, số lượng sản phẩm có hạn, có thể không đủ cho tất cả nhu cầu người dùng. Ngày hôm nay đã bán được hơn 5 000 sản phẩm.</div><div class="comment-action"><span class="like">Thích</span><span class="reply">Trả lời</span><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">Vừa xong</span></div></div>',
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Tôi đã kịp đặt mua vài gói bởi vì sắp tới họ dự kiến ngừng việc bán hàng online. Mà ở ngoài hiệu thuốc thì giá chắc chắn là sẽ cao hơn rồi.</div><div class="comment-action"><span class="like">Thích</span><span class="reply">Trả lời</span><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">Vừa xong</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Bạn tôi vừa đi Nhật về và mọi người có biết điều gì không? Cậu ấy đã nhìn thấy ' + settings.product + ' ở trong hiệu thuốc. Ở đó, nó được bày bán với giá khoảng $70 cho một sản phẩm mà người ta vẫn đổ xô đi mua nó! Thật không thể tin được!</div><div class="comment-action"><span class="like">Thích</span><span class="reply">Trả lời</span><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">Vừa xong</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Phù, may quá đã kịp đặt mua. Xin cảm ơn vì trước đây tôi không hề biết đến sản phẩm này. Sau khi đọc các bình luận trên mạng internet, có vẻ như tất cả mọi người đều rất hài lòng, quan trọng là không mua phải hàng giả, vì vậy nên đặt mua ở đây luôn.</div><div class="comment-action"><span class="like">Thích</span><span class="reply">Trả lời</span><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">Vừa xong</span></div></div></div>',	
          },
          'fr': {
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>J’ai fait la commande. J’ai eu le temps de le faire au rabais! J\'espère que tout ira bien</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Ne t\'inquiète pas! Ce n\'est pas la première fois que je commande ' + settings.product + ', toutes les commandes sont livrées en toute sécurité dans le colis.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Aujourd\'hui j’ai reçu ' + settings.product + '. Je vais l’utiliser, cela devrait aider.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Merci pour l\'opportunité de commander au rabais! J\'ai déjà commandé ' + settings.product + ', mais beaucoup plus cher. Que faire! Il fallait payer pour l\'efficacité, mais ça valait la peine.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>L\'article est impressionnant, je vais essayer. J\'ai commandé plusieurs pièces à la fois, j\'espère que cela aidera. </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Bien sûr, ça va aider! Pour moi, ce produit n\'est pas d\'actualité, mais plusieurs de mes amis l\'ont utilisé et tout le monde en louait. </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">Fabricant de  ' + settings.product + '</span>Attention! En raison du fait que ' + settings.product + ' va bientôt commencer à être vendu dans les pharmacies, la quantité du produit est limitée, il est possible qu’il n’y ait pas de quantité suffisante pour tout le monde. Plus de 5 000 plaquettes ont été achetées aujourd\'hui. </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>J’ai eu le temps de commander quelques pièces, car bientôt, il planifie d\'arrêter les ventes en ligne. Et dans les pharmacies, les prix seront plus élevés..</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Mon ami est revenu aujourd\'hui du Japon et imagine - il a vu dans la pharmacie ' + settings.product + '. Là, son prix était environ 70 $ pour une plaquette, et les gens achètent même pour ce prix! C\'est génial!</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Whew, j’ai eu le temps de faire la commande. Merci, je ne connaissais pas ce produit auparavant. J’ai lu des avis sur Internet - tout le monde semble heureux, l\'essentiel est de ne pas acheter d’imitation, il est donc préférable de commander ici.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',		
          },
          'hr': {
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>' + genGenderWords(0) + ' sam narudžbu. ' + genGenderWords(1) + ' sam kupiti na popust! Nadam se da će sve biti u redu.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Ne brini! Već kupujem mnogo puta ' + settings.product + ', sve online narudžbe dostavljaju se u cijelosti.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Danas sam  ' + genGenderWords(3) + ' ' + settings.product + '. Koristit ću, nadam se da će vam pomoći.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Hvala vam na prilici da naručite na popust!! Ja sam ' + genGenderWords(4) + ' već ' + settings.product + ', ali mnogo skuplji. Što mi možemo učiniti, učinkovitost je morala biti plaćena, ali to je bilo vrijedno.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Vrlo zanimljiv članak, pokušat ću. ' + genGenderWords(5) + ' sam nekoliko komada odjednom, nadam se da će to pomoći.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Naravno, to će vam pomoći! Za mene ovaj proizvod nije relevantan, ali moji prijatelji su se to koristili i svi su bili vrlo zadovoljni</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">Proizvođač ' + settings.product + '</span>Upozorenje! Zbog činjenice, da ' + settings.product + ' če se uskoro prodati u ljekarni, količina robe je ograničena, možda neće biti dovoljno robe za sve. Danas su ljudi kupili više od 5.000 paketa. </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>' + genGenderWords(5) + ' sam naručiti nekoliko paketa , jer ubrzo neće biti online prodaja. А cijene u ljekarnama će biti znatno veće.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Moj prijatelj danas se vratio iz Japana, i zamislite - on je vidio u lijekarni ' + settings.product + '. Tamo on košta oko $70 za jedan paket, i ljudi ga ionako kupuju za ovu cijenu! Ovo je šok!</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Fuuh, ' + genGenderWords(6) + ' sam naručiti. Hvala, nisam ' + genGenderWords(7) + ' o ovom lijeku. ' + genGenderWords(8) + ' sam recenzije na internetu - svi su ljudi sretni, glavna stvar je ne kupiti varanje, pa mislim da je bolje naručiti ovdje.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',
          ...
          'it': {
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Ho effettuato l\'ordine. Con lo sconto! Spero andrà tutto bene</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Non ti preoccupare! Non è la prima volta che ordino ' + settings.product + ', tutti gli ordini arrivano senza problemi</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Oggi ho riveuto ' + settings.product + '. Lo userò, dovrebbe aiutarmi.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Grazie per la possibilità di ordinare con lo sconto! Io anche proma ordinavo ' + settings.product + ', ma costava di più. Che dire, costava tanto, ma per questa efficacia non ho paura a spendere.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>L\'articolo è interessante, ci proverò. Ne ho ordinato subito diversi, spero aiuti.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Certo che aiuta! Per me già non è necessario, ma conosco molte persone che lo usano</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">Produttore ' + settings.product + '</span>Attenzione! Per via del fatto che ' + settings.product + ' a breve sarà in vendita nelle farmacie, la quantità di prodotto disponibile è limitata, potrebbe non bastare per tutti. Solo oggi ne abbiamo vendute 5000 confezioni. </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Ne ho ordinate diverse confezioni visto che tra poco sarà in vendita solo in farmacia. E si sa che costerà il doppio.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Un mio amico è appena tornato dal Giappone e li già vendono in farmacia ' + settings.product + '. Li costa $70 una confezione, e la gente lo compra! Incredibile!</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Meno male, appena in tempo. Grazie, prima non conoscevo questo prodotto. Ho letto una recensione su internet, sono tutti contenti, basta non comprarlo falso, meglio ordinare qui.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',
          ...
          'en': {
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Made an order. Managed to get it with a discount! I hope everything will be okay</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Don’t worry! It’s not the first time I order ' + settings.product + ', all orders are delivered safe and sound in a package </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Received ' + settings.product + ' today. Will use it, it must help.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Thank you for the opportunity to order with a discount! I’ve ordered ' + settings.product + ', before, but it cost much more. But what can you do? One has to pay for the efficiency, but it was worth it.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Very impressed by the article, will try it. Ordered several pieces, hope it will help.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Sure it will help! This product is not relevant for me, but a few of my friends used it and were very happy with the results.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">' + settings.product + ' Manufacturer </span>Attention! Due to the fact, that ' + settings.product + ' will soon be sold in pharmacies, the number of pieces is limited, there may not be enough packages for everyone. More than 5000 packages were bought today. </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Managed to order a few pieces, as they soon plan to close online sale. In pharmacies the price will be definitely be higher.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>My friend just got back from Japan and guess what – he saw ' + settings.product + ' in the local pharmacies. It costs about $70 per one package there, and people still buy it! Wow!</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Phew, managed to order in time. Thank you, didn’t know about this remedy before. Read reviews on the Internet – everyone seems happy, the most important thing is not to buy a fake one, so it’s better to order here.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',
          ...
          'th': {
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>ทำการสั่งซื้อ พร้อมส่วนลด! ฉันหวังว่าทุกอย่างจะเป็นไปได้ด้วยดี</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>ไม่ต้องกังวล! นี่ไม่ใช่ครั้งแรกที่ฉันสั่งซื้อ ' + settings.product + ', สินค้าทั้งหมดจะถูกจัดส่งอย่างปลอดภัยในกล่อง </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>ฉันได้รับสินค้าวันนี้ ' + settings.product + '.และฉันจะใช้มันวันนี้</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>ขอบคุณสำหรับส่วนลดสินค้า! ฉันเคยสั่งซื้อสินค้าตัวนี้มาก่อน ' + settings.product + ', ซึ่งมันแพงมาก แต่ตอนนั้นฉันก็สั่งซื้อมันเพื่อประสิทธิภาพที่คุ้มค่า</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>เป็นบทความที่น่าสนใจมาก ฉันอยากลองมัน ฉันสั่งซื้อมันมาหลายชิ้น และหวังว่ามันจะช่วย</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>แน่นอนว่ามันจะช่วย! ส่วนตัวฉันมองว่ามันอาจจะไม่ได้ผล แต่คนที่ฉันรู้จักหลายคนบอกว่าใช้ดีมากและพวกเขาก็ชอบมัน</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">ผู้ผลิต ' + settings.product + ' </span>คำเตือน! เนื่องจาก '+ settings.product +' จะเริ่มจำหน่ายในร้านขายยาในเร็ว ๆ นี้ สินค้ามีจำนวนจำกัดซึ่งอาจมีสินค้าไม่เพียงพอสำหรับทุกคน ซื้อสินค้าวันนี้ จำนวน  5,000 ชิ้น</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>ฉันทำการสั่งซื้อสินค้ามาไว้แล้วบางส่วนเพราะจะมีการยุติการขายทางออนไลน์ในเร็วๆนี้ และร้านขายยาก็จะขึ้นราคาสินค้าตัวนี้</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>เพื่อนของฉันเพิ่งกลับมาจากญี่ปุ่น เขาเห็น ' + settings.product + ' ตามร้านขายยาทั่วไปในราคา $70 นั่นเป็นราคาที่แพงมาก</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>ฉันได้ทำการสั่งซื้อสินค้าตัวนี้แล้ว ขอบคุณมาก ฉันไม่เคยรู้จักสินค้าตัวนี้มาก่อนเลย ฉันอ่านรีวิวจากอินเทอร์เน็ต – ทุกคนที่ใช้ดูจะชอบมัน สิ่งสำคัญคือการไม่ซื้อของปลอมเพราะฉะนั้นจึงควรสั่งซื้อมัน</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',
          ...
          'de': {
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Ich habe die Bestellung aufgegeben. Mit dem Rabatt! Ich hoffe, alles wird gut gehen.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Mach dir keine Sorgen! Ich bestelle nicht zum ersten Mal ' + settings.product + ', alle Bestellungen kommen problemlos an </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Heute habe ich ' + settings.product + ' erhalten. Ich werde es benutzen, es sollte mir helfen.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Danke für die Möglichkeit, mit dem Rabatt zu bestellen! Ich habe vorher auch ' + settings.product + ' bestellt, aber es hat mehr gekostet. Was zu sagen ist, es kostete viel, aber für diese Wirksamkeit habe ich keine Angst Geld auszugeben.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Der Artikel ist interessant, ich werde es ausprobieren. Ich habe gleich mehrere bestellt, ich hoffe, es hilft</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Natürlich hilft es! Für mich ist das nicht schon notwendig, aber ich kenne viele Leute, die es benutzen</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">Hersteller ' + settings.product + ' </span>Achtung! Aufgrund der Tatsache, dass ' + settings.product + ' in Kürze in Apotheken erhältlich sein wird, ist die Menge des verfügbaren Produkts begrenzt und kann nicht für jeden ausreichend sein. Nur heute haben wir 5000 Packungen verkauft. </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Ich habe mehrere Packungen bestellt, da es bald nur in der Apotheke erhältlich sein wird. Und man weiß, dass es doppelt so viel kosten wird</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Ein Freund von mir ist gerade aus Japan zurückgekehrt und dort verkauft man schon ' + settings.product + ' in den Apotheken. Dort kostet eine Packung $70 und die Leute kaufen es! Unglaublich!</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Zum Glück, gerade noch rechtzeitig. Danke, ich kannte dieses Produkt vorher nicht. Ich habe eine Rezension im Internet gelesen, alle sind zufrieden, Hauptsache man kauft es nicht gefälscht, es ist besser hier zu bestellen.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',
          ...
          'es': {
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>¡Lo conseguí con el descuento! Espero que vaya todo bien.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>¡No te preocupes! No es la primera vez que pido ' + settings.product + ', todos los pedidos se entregan intactos en su caja.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Hoy mismo recibí ' + settings.product + '. Lo voy a usar, debería ayudar.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>¡Gracias por la posibilidad de hacer el pedido con descuento! Antes también pedía ' + settings.product + ', pero salía mucho más caro. Qué le vamos a hacer, la eficacia tiene su precio, pero vale la pena.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Artículo muy interesante, voy a intentarlo. Pedí enseguida unos cuantos, espero que me ayude.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>¡Claro que te va ayudar! Para mí este producto no es muy actual, sin embargo mucho de mis amigos lo usan y no paran de elogiarlo.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              ...
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Conseguí pedir unos cuantos, puesto que pronto van a cerrar la tienda online.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Mi amigo ha vuelto hoy de Japón y vio ' + settings.product + ' en una farmacia. Allí cuesta más o menos 70 $, ¡pero a pesar del precio la gente lo compra igualmente! ¡Increíble! </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Logré hacer un pedido por los pelos. Gracias, antes no conocía este producto. Leí los comentarios en internet, y todos estaban muy satisfechos. Lo más importante es no comprar una falsificación, por eso mejor pedir en este sitio.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',
          ...
          'id': {
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Sudah pesan. Dapat diskon pula! Semoga semua baik-baik saja</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Jangan khawatir! Saya sudah sering pesan ' + settings.product + ', semua pesanan dikemas dalam kemasan yang aman </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Hari ini saya menerima ' + settings.product + '. Akan saya coba gunakan, semoga manjur.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Terima kasih atas diskon yang diberikan saat saya memesannya! Saya sebelumnya juga pernah memesan ' + settings.product + ', meski tidak begitu mahal. Mau bagaimana lagi, demi produk manjur harus siap bayar, meski tanpa potongan harga.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Artikel yang mengesankan, saya akan coba juga. Saya sudah pesan beberapa bungkus, semoga manjur</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Tentu saja manjur! Bagi saya produk ini sudah tidak aneh, soalnya semua kenalan saya juga pakai dan memuji kemanjurannya.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">Pemroduksi ' + settings.product + '</span>Perhatian! Seiring kabar bahwa  ' + settings.product + ' segera dipasarkan di apotek, maka jumlah barang akan dibatasi, persediaan mungkin tidak akan cukup. Untuk hari ini sudah terjual lebih dari 5000 paket.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Sudah pesan langsung beberapa bungkus karena kabarnya tidak akan dijual secara online lagi. Sedangkan harga di apotek biasanya lebih mahal.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Teman saya baru saja pulang dari Jepang dan dia bilang kalau sudah lihat  ' + settings.product + ' di apotek. Dia lihat harga sekitar $70 untuk satu bungkus, orang-orang tetap beli meski semahal itu! Gila!</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Fiuh, saya sudah berhasil pesan. Terima kasih, sebelumnya saya tidak tahu tentang produk ini. Saya baca ulasannya di internet, tampaknya semua puas. Yang terpenting jangan beli barang tiruan, jadi mending pesan di sini langsung.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',
          ...
          'al': {
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Sapo e porosita. Arrita ta marr me zbritje! Shpresoj që gjithçka të shkoj mirë</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Mos u shqetësoni! Nuk është hera e parë që unë porosis ' + settings.product + ', të gjitha porositë i sjellin të paketuara me kujdes</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Sot më në fund morra ' + settings.product + '. Do filloj ta përdor menjëherë, me siguri do më ndihmojë.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Ju faleminderit për mundësinë që na ofroni, që porosinë ta bëjmë me zbritje! E kam porositur edhe më parë ' + settings.product + ', por sigurisht me një çmim më të lart. Çfarë të bëja, për efektivitetin duhet të paguash, por mund të them që ia ka vlejtur.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Më ka bërë përshtypje të madhe artikulli, do ta provoj patjetër. Kam porositur menjëherë disa copë, shpresoj se do më ndihmojë.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Sigurisht që ndihmon! Për mua ky produkt nuk është aktual, por disa të njohurit e mi e kanë përdorur dhe të gjithë e mburrin shumë.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">Prodhuesi ' + settings.product + ' </span>Vëmendjen këtu! Duke qenë se, ' + settings.product + ' së shpejti do të filloj të shitet nëpër farmaci, sasia e produktit është e limituar, ky produkt mund të mos mjaftojë për të gjithë. Vetëm sot janë blerë më shumë se 5 000 pako. </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Arrita të porosis disa copë, duke qenë se së shpejti ky produkt nuk do të shitet më përmes internetit. Ndërkohë që nëpër farmaci çmimi me siguri që do të jetë më i lartë.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Një miku im sot u kthye nga Japonia dhe e merrni dot me mend – ai kishte parë në farmaci atje ' + settings.product + '. Çmimi atje ishte rreth $70 për një copë, dhe njerëzit edhe me këtë çmim e blejnë! E çuditshme!</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Uhh, arrita ta porosis. Ju faleminderit shumë, nuk kisha dëgjuar më parë për këtë produkt. Pastaj lexova komentet në internet – me aq sa pashë të gjithë pak a shumë janë të kënaqur, e rëndësishme është të mos blesh produkt fallco, kështu që më mirë porositeni këtu.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',
          ...
          'bg': {
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Направих поръчка. Хванах промоцията! Надявам се, че всичко ще бъде наред</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Не се притеснявай! Аз вече не за пръв път поръчвам ' + settings.product + ', всички поръчки се доставят в здрава опаковка </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Днес получих ' + settings.product + '. Ще го използвам, трябва да помогне.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Благодаря Ви за възможността да поръчам с отстъпка! Аз и преди съм си ' + genGenderWords(3) + ' ' + settings.product + ', но доста по-скъпо. Какво да правя, за ефективността трябваше да се плащат, но си струва.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Много се впечатлих от тази статия, ще опитам. Поръчах веднага няколко броя, надявам се да помогне</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Разбира се, че ще помогне! За мен този продукт не е важен, но някои мои познати са го използвали и всички много го хвалят.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">Производител на ' + settings.product + ' </span>Внимание! Във връзка с това, че ' + settings.product + ' скоро ще започне да се продава в аптеките, количеството стока е ограничено, продуктът  може да не стигне за всички. Днес са купени над 5 000 опаковки. </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Успях да си поръчам няколко бройки, защото скоро се канят да спрат онлайн продажбата. А в аптеките, със сигурност, цените ще са по-високи.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Един мой приятел днес се върна от Япония и познайте - той виждал в аптеките ' + settings.product + '. Там той е струвал около $70 за една опаковка, и хората, дори и на такава цена го купуват! Невереятно!</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Ох, успях да поръчам. Благодаря, не знаех за това лекарство преди. Прочетох коментарите в интернет, изглежда всички са доволни, важното е да не си купите фалшификат, така че по-добре поръчайте от тук.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',
          ...
          'gr': {
              ...
              autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Έκανα την παραγγελία. Πρόλαβα με έκπτωση! Ελπίζω ότι όλα θα είναι καλά</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Μην ανησυχείς! Δεν είναι η πρώτη φορά που παραγγέλνω ' + settings.product + ', όλες οι παραγγελίες αποστέλλονται σε ασφαλή συσκευασία</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Σήμερα έλαβα ' + settings.product + '. Θα χρησιμοποιήσω, θα πρέπει να βοηθήσει.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Ευχαριστώ για την ευκαιρία να παραγγείλω με έκπτωση! Εγώ και παλιά είχα παραγγείλει  ' + settings.product + ', αλλά ήταν σημαντικά πιο ακριβά. Τι να κάνω, για την αποτελεσματικότητα έπρεπε να πληρώσω, αλλά άξιζε τον κόπο.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Εξαιρετικά εντυπωσιασμένος είμαι με το άρθρο, θα το δοκιμάσω. Παρήγγειλα αμέσως μερικά κομμάτια, ελπίζω θα βοηθήσει</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Θα βοηθήσει σίγουρα! Για μένα αυτό το προϊόν είναι άσχετο, αλλά κάποιοι από τους γνωστούς μου είχαν χρησιμοποιήσει, και όλοι έμειναν πολύ ευχαριστημένοι.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">Κατασκευαστής ' + settings.product + '</span>Προσοχή! Σχετικά με ό,τι ' + settings.product + ' σύντομα θα αρχίσει να πωλείται στα φαρμακεία, ο αριθμός των προϊόντων είναι περιορισμένος και το προϊόν σε όλους μπορεί να μην φτάσει. Για σήμερα πουλήθηκε πάνω από 5 000 συσκευασίες. </div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Πρόλαβα να παραγγείλω μερικά κομμάτια, γιατί σύντομα σχεδιάζουν να σταματήσουν την πώληση στο διαδίκτυο. Και στα φαρμακεία σίγουρα οι τιμές θα είναι υψηλότερες.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
              autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Ο φίλος μου σήμερα επέστρεψε από την Ιαπωνία και φαντάζεστε – αυτός είδε στο φαρμακείο ' + settings.product + '. Εκεί κοστίζει περίπου $70 για ένα πακέτο, και οι άνθρωποι ακόμα και για αυτή την τιμή αγοράζουν! Είμαι σοκαρισμένος!</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
              autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><a class="to_form" href="{url}"><span class="comment-username">' + genLocalName() + '</span></a>Ουχ, πρόλαβα να παραγγείλω. Ευχαριστώ, δεν το ήξερα για αυτό το σκεύασμα. Διάβασα σχόλια στο διαδίκτυο - φαίνεται να είναι όλοι ευχαριστημένοι, το βασικό είναι να μην αγοράσετε μια απομίμηση, οπότε καλύτερα είναι εδώ να παραγγείλετε.</div><div class="comment-action"><a class="to_form" href="{url}"><span class="like">' + commActions[settings.lang].likeWord + '</span></a><a class="to_form" href="{url}"><span class="reply">' + commActions[settings.lang].replyWord + '</span></a><a class="to_form" href="{url}"><span class="like-count">0</span></a><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',
