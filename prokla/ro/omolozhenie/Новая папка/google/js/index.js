$(document).ready(function() {
    ...
    sendMessage('form', 'btn', 'input', 'textarea', 'sucses'); */
    ...
    for(var i = $item.length - 1; i > $item.length - 13; i--) {
        $item.eq(i).hide().addClass('z6XoBf_active');
    }

    $('.gp0lg').click(function () {
        $('.z6XoBf_active').show();
        $('html, body').animate({
            scrollTop: $('.z6XoBf_active').first().offset().top 
        }, 300);
