!(function (t) {
  ...
  (s.prototype = {
    ...
    build: function () {
      !0 === this.showCursor &&
        ((this.cursor = t('<span class="typed-cursor">' + this.cursorChar + '</span>')), this.el.after(this.cursor)),
        this.init();
    },
    typewrite: function (t, s) {
      ...
      r.timeout = setTimeout(function () {
        ...
        if ('^' === o.charAt(0)) {
          var i = 1;
          /^\^\d+/.test(o) && ((i += (o = /\d+/.exec(o)[0]).length), (e = parseInt(o))),
          ...
          if (s === t.length) {
            if (
              ...
              r.arrayPos === r.strings.length - 1 &&
                (r.options.callback(), r.curLoop++, !1 === r.loop || r.curLoop === r.loopCount))
            )
              return;
            r.timeout = setTimeout(function () {
              r.backspace(t, s);
          ...
          s > r.stopNum
            ...
            : s <= r.stopNum &&
              ...
              r.arrayPos === r.strings.length
                ? ((r.arrayPos = 0), r.shuffle && (r.sequence = r.shuffleArray(r.sequence)), r.init())
