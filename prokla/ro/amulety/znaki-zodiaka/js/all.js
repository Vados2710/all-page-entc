var signs = {
  aries: ["Berbeci", "Berbeci"],
  taurus: ["Tauri", "Tauri"],
  twins: ["Gemeni", "Gemeni"],
  cancer: ["Raci", "Raci"],
  leo: ["Lei", "Lei"],
  virgo: ["Fecioare", "Fecioare"],
  libra: ["Balanță", "Balanță"],
  scorpio: ["Scorpioni", "Scorpioni"],
  sagittarius: ["Săgetători", "Săgetători"],
  сapricorn: ["Capricorni", "Capricorni"],
  аquarius: ["Vărsători", "Vărsători"],
  pisces: ["Peşti", "Peşti"],
};
