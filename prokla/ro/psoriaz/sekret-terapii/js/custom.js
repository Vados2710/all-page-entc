...
$(document).on('click', 'a[href^="#"], .comments-form__unauthorized, .comments-toggle, .comments-choose__btn, .comments-choose, .hidden-xs, .hidden-sm, .like-count, .comments-refreshing-wrapper', function (event) {
