...
$('.percent-box').hide();
$('.interview__info').hide();

$(".interview__button").click(function () {
 $('.percent-box').show();
 $(this).hide();
 $('.interview__info').show();
 $('.interview').addClass('active');
  $('.interview-result__line').removeClass('hide-line');
...
// function showResult(){
//     for (let i=0;i < itemTest.length;i++){
//         if (itemTest[i].classList.contains('active')){
//             document.querySelector('#loader').classList.add('active')
//             document.querySelector('.simptom__item').style.display = 'none'
