...
$(".btn--submit").click(function () {
    $(".bottom-link").text('Partecipa all‏´‏‎estrazione!'),
...
$(function () {
 $("#calcweight").click(function (a) {
  ...
  Number($("#weight").val()) > Number($("#minus_weight").val()) + 40
   ? $(".formResult").html(
    "<p><b>Se segui le istruzioni qui sotto, potrai perdere " + $("#minus_weight").val() +
    " chili in soli " + a + " giorni senza dieta ed esercizio fisico!</b></p><p>" +
    "Pensi che non sia possibile? Leggi l’articolo che cambierà la tua opinione. Credo che cambierà anche la tua vita!</p>"
   )
   : $(".formResult").html(
    "<p><b>\u041d\u0435\u043a\u043e\u0440\u0440\u0435\u043a\u0442\u043d\u044b\u0435" +
    " \u0434\u0430\u043d\u043d\u044b\u0435.</b></p>"
