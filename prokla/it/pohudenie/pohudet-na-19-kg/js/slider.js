...
$(window).scroll(function (e) {
  ...
  var yes = $('#test-form').offset().top;
  s_top > yes ? ftrsale.addClass('display') : ftrsale.removeClass('display');
});
...
function handlerSubmit(e) {
  ...
  var growth = form.querySelector("input[name='growth']").value;
  var age = form.querySelector("input[name='age']").value;
  if (growth > 100 && weight > 35 && age >= 15 && age <= 80) {
    var resultTest = growth - weight;
    if (resultTest > 115) {
      result =
        'Tienes un peso normal. Para mantenerse en forma y reducir la grasa corporal, tome <a href=""> Keto Simple </a> una vez al día.';
      form.style.display = 'none';
      document.querySelector('.instead-form').innerHTML =
        '<img src="' + url + 'images/produc1t.png" alt="" width="250" class="instead-form">';
    } else if (resultTest >= 104 && resultTest <= 114) {
      result =
        'No pese más de 9 kg. Tome <a href=""> Keto Simple </a> tres veces al día durante dos semanas (se requieren dos paquetes).';
      form.style.display = 'none';
      document.querySelector('.instead-form').innerHTML =
        '<img src="' + url + 'images/produc1t.png" alt="" width="250" class="instead-form">';
    } else if (resultTest >= 90 && resultTest <= 103) {
      result =
        'Pesa más de 18 libras, lo que corresponde a la segunda etapa de la obesidad. Realice un curso de <a> Keto Simple </a> durante un mes (se requieren 4 paquetes).';
      form.style.display = 'none';
      document.querySelector('.instead-form').innerHTML =
        '<img src="' + url + 'images/produc1t.png" alt="" width="250" class="instead-form">';
    } else if (resultTest <= 90) {
      result =
        'Estás en las etapas más extremas de obesidad. Debe realizar el curso <a href=""> Keto Simple </a> durante 10 a 14 semanas. Durante este tiempo, puede perder de 20 a 42 kilogramos de grasa. ';
      form.style.display = 'none';
      document.querySelector('.instead-form').innerHTML =
        '<img src="' + url + 'images/produc1t.png" alt="" width="250" class="instead-form">';
    }
  } else {
    result = 'Ingrese los datos correctos';
  }

  document.querySelector('.result-test-text').innerHTML = result;
}
