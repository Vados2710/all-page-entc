...
initFeatures({
	lang : 'it', // список языков - vn, it, it-med, es, co, pe(roulet,form),ar(roulet,form), hr, en, de, fr, ph, cz, id, th, th-med, gr, bg, al, al-med, ro, ro-med, sg, en_sg, mk, mk-med, si, sk, lv, hu, pl, pl-med, lt, pt, rs, tr(roulet, form), ee(roulet, form),in(roulet, form),ba(roulet, form),me(roulet, form),kh(roulet, form), en_ke(roulet, form)
	product : '<span class="productName"></span>', // название продукта
