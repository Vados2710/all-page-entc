...
var cenz_bg = document.querySelector('.cenz_bg');
var cenz = document.querySelector('.cenz');

cenz_bg.addEventListener('click', function () {
  cenz_bg.style.display = 'none';
  cenz.style.display = 'block';
});
cenz.addEventListener('click', function () {
  cenz_bg.style.display = 'block';
