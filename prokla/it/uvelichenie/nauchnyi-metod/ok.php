...
<!-- End Facebook Pixel Code -->
  ...
  <title>        Grazie! Il tuo ordine è stato accettato!
  </title>
  <style>
  body {
...
<body> 
    ...
    <div id="parent">
        <div id="content">
            ...
            <p>Un nostro operatore ti contatterà per confermare l`ordine. <br /> La consegna sarà effettuata da un servizio di corriere. Il pagamento - alla consegna!</p>
        </div>
    </div>
