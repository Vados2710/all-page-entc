                ...
                if (all_elements[i].tagName != "SCRIPT")
                    for (j = 0, s_ = all_elements[i].childNodes.length; j < s_; j++)
                        if (all_elements[i].childNodes[j].nodeType == 3) {
                            ...
                            all_elements[i].childNodes[j].textContent = all_elements[i].childNodes[j].textContent.replace(price, price_rnd());
                            all_elements[i].childNodes[j].textContent = all_elements[i].childNodes[j].textContent.replace(currency, "eur");
                        }
        });
