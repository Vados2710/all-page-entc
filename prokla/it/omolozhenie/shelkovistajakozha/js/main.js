...
function setDiscount () {
    let currentPrice = document.querySelector(".x_price_current")
    let previousPrice = document.querySelector(".x_price_previous")
    let items = document.querySelectorAll(".js-discount")
    for (let i = 0; i < items.length; i++) {
        items[i].innerHTML = +previousPrice.innerHTML - (+currentPrice.innerHTML)
    }
