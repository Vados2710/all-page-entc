...
commentImage.addEventListener('change', function(event){
    ...
    if(commentImage.value) {
        document.getElementById('commentFoto').innerHTML = 'Fotoattēls ir augšupielādēts';
    } else {
        document.getElementById('commentFoto').innerHTML = 'Pievienojiet fotoattēlu';
    }
});
...
btn.addEventListener('click', function(event){
    ...
    if(name.value.trim() && city.value.trim() && text.value.trim()) {
        message.innerHTML = 'Paldies! Jūsu atsauksme ir nosūtīta moderācijai.';
        name.value = '';
        city.value = '';
        text.value = '';
        commentImage.value = '';
        ...
        message.innerHTML = 'Aizpildiet visus laukus';
    }  
