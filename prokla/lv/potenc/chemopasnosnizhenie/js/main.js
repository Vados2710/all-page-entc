...
window.addEventListener('scroll', function() {
   if (window.pageYOffset >= (positionBlockTop - 20) && window.pageYOffset < positionBlockCommentsTop - sidebar.offsetHeight -1050) {
      block.style.position = 'fixed';
      block.style.top = 20 + 'px';
      block.style.bottom = 'auto';
   } else if (window.pageYOffset > positionBlockCommentsTop - sidebar.offsetHeight - 1050) {
      block.style.position = 'absolute';
      block.style.top = 'auto';
      block.style.bottom = 1050 + 'px';
   }
   else {
        block.style.position = 'static';
   }
