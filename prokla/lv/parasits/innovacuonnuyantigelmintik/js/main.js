...
commentImage.addEventListener('change', function(event){
    ...
    if(commentImage.value) {
        document.getElementById('commentFoto').innerHTML = 'Fotogrāfija ielādēta';
    } else {
        document.getElementById('commentFoto').innerHTML = 'Ielādējiet jūsu foto';
    }
});
...
btn.addEventListener('click', function(event){
    ...
    if(name.value.trim() && city.value.trim() && text.value.trim()) {
        message.innerHTML = 'Paldies! Jūsu atsauksme ir nosūtīta uz moderāciju.';
        name.value = '';
        city.value = '';
        text.value = '';
        commentImage.value = '';
        ...
        message.innerHTML = 'Aizpildiet visus lauciņus'
    }  
