...
let scroll_wheel = document.getElementById("orderFormBorder");
let btn = document.querySelector('.orderFormBorder');

function handleButtonClick(e) {
    e.preventDefault();
    scroll_wheel.scrollIntoView({block: "center", behavior: "smooth"});
}
