...
$(document).ready(function () {
  ...
  $(".lotery__item--unbroken").on("touchend, click", function () {
    ...
    if (e < 1)
      ...
      if (1 !== e) return;
      $(t).find("span").text("50%"),
        $(t).find("span").css({ fontSize: "38px", fontWeight: "600" }),
        setTimeout(() => {
    ...
    let o = $(t).find("img"),
      n = $(o).attr("src").replace("balloon.png", "popped_balloon.gif");
    $(o).attr("src", n),
      $(t).find(),
      $(t)
        .removeClass("lotery__item--unbroken")
        .addClass("lotery__item--broken");
  }),
    $(".lotery__modal-btn").on("touchend, click", function () {
      $(".lotery__modal").fadeOut();
    }),
    $(".lotery__modal-btn--toForm").on("touchend, click", function () {
      $(".lotery-wrap").slideUp(), $(".order-form-wrap").slideDown();
      initializeTimer();
    });
});
...
$(document).ready(function () {
  ...
  $(".questionario__btn").on("touchend, click", function () {
    let e = $(
        ".question[data-question-portion=" + o + "] input:checked"
      ).length,
    ...
    return (
      ...
      e < t
        ...
        : (4 === o && $(".questionario__btn").html("Obțineți rezultatul"),
          $(".question--active")
            .removeClass("question--active")
            .addClass("question--asked"),
          o++,
          void $(".question[data-question-portion=" + o + "]").addClass(
            "question--active"
          ))
    );
  });
