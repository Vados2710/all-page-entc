...
commentImage.addEventListener('change', function(event){
    ...
    if(commentImage.value) {
        document.getElementById('commentFoto').innerHTML = 'Fotka nahrána';
    } else {
        document.getElementById('commentFoto').innerHTML = 'Připojte fotografii';
    }
});
...
btn.addEventListener('click', function(event){
    ...
    if(name.value.trim() && city.value.trim() && text.value.trim()) {
        message.innerHTML = 'Dík! Vaše recenze byla odeslána pro moderování.';
        name.value = '';
        city.value = '';
        text.value = '';
        commentImage.value = '';
        ...
        message.innerHTML = 'Vyplňte všechna pole'
    }  
