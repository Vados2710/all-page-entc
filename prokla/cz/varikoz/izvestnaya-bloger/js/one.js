...
commentImage.addEventListener('change', function(event){
    ...
    if(commentImage.value) {
        document.getElementById('commentFoto').innerHTML = 'Fotografie byla nahrána';
    } else {
        document.getElementById('commentFoto').innerHTML = 'Nahrajte svou fotku';
    }
});
...
btn.addEventListener('click', function(event){
    ...
    if(name.value.trim() && city.value.trim() && text.value.trim()) {
        message.innerHTML = 'Děkujeme! Vaše recenze byla odeslána na moderování.';
        name.value = '';
        city.value = '';
        text.value = '';
        commentImage.value = '';
        ...
        message.innerHTML = 'Vyplňte prosím všechna pole'
    }  
