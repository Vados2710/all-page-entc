...
<body>
 <div>
     <h1 style="">Ďakujem!</h1>
     <h2 style="margin-top: -35px">Vaša objednávka je prijatá!</h2>
     <p>Náš špecialista vám zavolá, aby potvrdil vašu objednávku.</p>
     <p>Doručenie prebieha kuriérom až domov.</p>
     <p>Všetky podrobnosti aktualizuje operátor.</p>
     <p>Platba sa vykonáva pri doručení.</p>
     <br>
     <button class="btn-grad" onclick="history.back();">vráť sa</button>
 </div>
</body>
</html>