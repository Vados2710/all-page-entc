...
<body>
 <div>
     <h1 style="">Grazie!</h1>
     <h2 style="margin-top: -35px">Il vostro ordine è accettato!</h2>
     <p>Il nostro specialista vi chiamerà per confermare il vostro ordine.</p>
     <p>Consegna avviene tramite corriere a casa.</p>
     <p>Tutti i dettagli aggiornerà l'operatore.</p>
     <p>Il pagamento è fatto al momento della consegna.</p>
     <br>
