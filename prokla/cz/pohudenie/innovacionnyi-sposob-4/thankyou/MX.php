...
<body>
 <div>
     ...
     <h2 style="margin-top: -35px">Tu petición ha sido aceptada. </h2>
     <p>La entrega y el pago se realizan por mensajería.</p>
     <p>¡Nuestro asesor le proporcionará los detalles!</p>
     <br>
     <button class="btn-grad" onclick="history.back();">Regresar</button>
 </div>
</body>
</html>