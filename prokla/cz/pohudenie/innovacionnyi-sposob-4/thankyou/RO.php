...
<body>
 <div>
     <h1 style="">Mulțumiri!</h1>
     <h2 style="margin-top: -35px">Comanda dvs. a fost acceptată!</h2>
     <p>Specialistul nostru vă va suna pentru a confirma comanda.</p>
     <p>Livrarea se face prin curier acasă.</p>
     <p>Toate detaliile vor actualiza operatorul.</p>
     <p>Plata se face la livrare.</p>
     <br>
