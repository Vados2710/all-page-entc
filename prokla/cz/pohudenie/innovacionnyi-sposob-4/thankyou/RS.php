...
<body>
 <div>
     <h1 style="">Хвала за поруџбину</h1>
     <h2 style="margin-top: -35px">Ваша поруџбина је прихваћена!</h2>
     <p>Наш стручњак ће вас позвати да потврди вашу поруџбину.</p>
     <p>Достава се врши курирском службом до ваше куће.</p>
     <p>Све детаље ће ажурирати оператер.</p>
     <p>Плаћање се врши приликом испоруке.</p>
     <br>
     <button class="btn-grad" onclick="history.back();">врати се</button>
 </div>
</body>
</html>