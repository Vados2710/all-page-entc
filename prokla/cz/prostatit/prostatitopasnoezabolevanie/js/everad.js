...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let popupOverlay = document.querySelector('.modal__overlay');
    let closeBtn = document.querySelector('.modal__close');
    let flag = true;
    document.body.addEventListener('mouseleave', function(e) {
        if (flag && e.clientY < 50) {
...
function postDate() {
    ...
    var sa = body.getAttribute('data-post-format') || 'dd.mm.yyyy',
        msInDay = 86400000,
        counterLength = 380,  // Максимальна кількість вімотаних днів. Змінюємо за необхідності.
        months, 
