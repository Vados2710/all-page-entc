...
$('.try').on('click', function () {
    if ((!$(this).parent('.boxes_item').hasClass('afterlose-boxes_item')) && (!$('#boxesContainer').hasClass('stop_trying'))) {
        if (tries == 0) {
            ...
            $('.box-tooltip-title').html('<b>Nic jsi nevyhrál</b><br> Zbývá vám  <span style="color: red;">1 pokus</span>! Zkus to znovu!');
            $('.box-tooltip-btn').html('Snaž se');
            setTimeout(function () {
        ...
        if (tries == 1) {
            ...
            $('.box-tooltip-title').html('<b>Gratulujeme!</b><br>Vyhráli jste <br>zlevněný<b style="color: red;"> Uromexil Forte!</b>');
            $('.box-tooltip-btn').html('Získejte Uromexil Forte se&nbsp;slevou');
