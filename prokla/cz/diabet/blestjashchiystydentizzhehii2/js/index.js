...
function Datee() {
    var msInDay = 86400000,
        counterLength = 90,
        seasons, months, countryName = "cz",  // Встановлюємо мову для місяців.
    ...
    switch(countryName) {
        ...
        case "hu":  // Hungary (Румунія)
            seasons = ["Téli", "Tavaszi", "Nyári", "Ősz"];
...
window.addEventListener('DOMContentLoaded', function () {
    var closeBanner = document.querySelector('.mainfoot .cls');

    closeBanner.addEventListener('click', function () {
        var body = document.querySelector('body');

        body.classList.remove('banner');
    });



    var popup = document.querySelector('#ouibounce-modal'),
        indicator = true;
    ...
    var closePopup = document.querySelector('.close-ex'),
        popupBackground = document.querySelector('#ouibounce-modal .underlay');
