...
$(".opinions_slider").slick({
  ...
  arrows: true,
  adaptiveHeight: true,
  nextArrow: '<div class="arrow_prev slick-arrow" style="display: block;"><div>‹</div></div>', 
  prevArrow: '<div class="arrow_next slick-arrow" style="display: block;">›</div>'
});
...
/* $('.slick-arrow').click(function(e) {
  for (let i = 0; i < $('slick-list').length; i++) {
    console.log($('slick-list')[i]);
    $('slick-list')[i].classList.remove('active');
  }
...
$('.read_more').click(function(e) {
  ...
  let data_attr = e.target.getAttribute('data-target');
  let btn = document.querySelector(`[data-target="${data_attr}"]`);

  console.log(btn);
  btn.previousElementSibling.style.overflow = 'visible';
