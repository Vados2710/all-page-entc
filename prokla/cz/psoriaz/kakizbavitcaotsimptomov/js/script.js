...
$(".show-img").click(function (event) {
  var text =
    $(this).html() == "Klikněte pro zobrazení"
      ? "Skrýt"
...
let reviews = function () {
  ...
  commentFileInput.change(function (e) {
    commentFileText.html("Fotografie byla nahrána");
  ...
  $(".reviews-form").submit(function (e) {
    ...
    e.preventDefault();
    commentFileText.html("Nahrajte svou fotku");
    commentFileText.css("color", "#000");
    commentTextArea.val("");
    commentName.val("");
    alert("Děkujeme za ohlas, Vaše recenze čeká na moderování");
