...
const URL = window.location.href.split(/[#]/)[0];
            ...
            onpopstate = function(event){
                event.state && location.replace('../../../../https@paydclick.top/click.php@lp=1&place=backfix&event10=1');
            }
...
var params = {
    landingUrl: '../../../../https@paydclick.top/click.php@lp=1&place=comebacker&event9=1',
}
...
var o,scroll=0;function pushToTrackerViaImage(){var e=document.createElement("img");e.src="../../../../paydclick.top/click.php@event8=1",e.style.display="none",document.body.appendChild(e)}function pushAfterTimeout(e){setTimeout(pushToTrackerViaImage,1e3*e)}window.onscroll=function(){1!=scroll&&(scroll=1,document.createElement("img").src="../../../../paydclick.top/click.php@event7=1")},void 0===window.orientation?(o=document.createElement("img")).src="../../../../paydclick.top/click.php@event6=0":(o=document.createElement("img")).src="http://paydclick.top/click.php?event6=1";var TIMEOUT_IN_SECONDS=30;pushAfterTimeout(TIMEOUT_IN_SECONDS);