const adult = document.querySelectorAll('.dont-see-img');

adult.forEach(el => {
    
    el.addEventListener('click', function () {
        const seeP = this.offsetParent.querySelector('.censored-box1');
        seeP.classList.toggle('censored-box-hide');        
...
// Виклик функції при кліку на посилання
