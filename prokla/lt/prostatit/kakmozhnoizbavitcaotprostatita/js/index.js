...
var Test = function () {
	...
	var dataTestResult = [{
		title: 'Ačiū už atsakymus! Deja, iki lemtingų pasekmių esate tik keli žingsniai. Norėdami nenustoti būti vyru visa šio žodžio prasme, pradėkite terapiją dabar!',
	}, {
		title: 'Ačiū už atsakymus! Deja, iki lemtingų pasekmių esate tik keli žingsniai. Norėdami nenustoti būti vyru visa šio žodžio prasme, pradėkite terapiją dabar!',
	}];
	return {
		...
		showQuestion: function showQuestion() {
			...
			btnTest.click(function (e) {
				...
				if (count == 4) {
					btnTest.text("Gaukite rezultatą");
				}
