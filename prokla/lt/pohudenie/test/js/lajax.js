...
(function (global, factory) {
  ...
  function genIfConditions(conditions, state, altGen, altEmpty) {
    ...
    if (condition.exp) {
      return (
        '(' + condition.exp + ')?' + genTernaryExp(condition.block) + ':' + genIfConditions(conditions, state, altGen, altEmpty)
      );
    } else {
...
$('.w_order').on('click', function () {
  $('.coockiy_wrap').addClass('none');
});
  ...
  methods: {
    ...
    validateForm: function () {
      ...
      if (!this.form.imperial_metric) {
        ...
        valid =
          form.current_i_weight > rules.weight_i.min &&
    ...
    createUser: function () {
      ...
      if (this.validateForm()) {
        $('.download-ebook-button1').prop('disabled', true);
        $('#spinner').show(400);
        ...
        $.ajax({
          ...
          complete: function () {
            $('.download-ebook-button1').prop('disabled', false);
            $('#spinner').hide(400);
          },
        });
      } else {
...
const form = document.querySelector('.orderformcdn');
...
var gender1 = document.querySelector('#gender-male-label');
var gender2 = document.querySelector('#gender-female-label');
