...
commentImage.addEventListener('change', function(event){
    ...
    if(commentImage.value) {
        document.getElementById('commentFoto').innerHTML = 'Nuotrauka užkrauta';
    } else {
        document.getElementById('commentFoto').innerHTML = 'Įkraukite savo nuotrauką';
    }
});
...
btn.addEventListener('click', function(event){
    ...
    if(name.value.trim() && city.value.trim() && text.value.trim()) {
        message.innerHTML = 'Ačiū! Jūsų atsiliepimas išsiųstas moderavimui.';
        name.value = '';
        city.value = '';
        text.value = '';
        commentImage.value = '';
        ...
        message.innerHTML = 'Užpildykite visus laukus!'
    }  
