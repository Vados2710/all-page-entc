...
var boxes = $(".prize__item"),
 ...
 saleText = $(".prize__dig");
function closePopup() {
 $(".close-popup, .btn-popup, .popup-close").click(function (a) {
  a.preventDefault();
  $(".overlay").fadeOut()
 })
}
...
$(function () {
 $("#calcweight").click(function (a) {
  ...
  Number($("#weight").val()) > Number($("#minus_weight").val()) + 40
   ? $(".formResult").html(
    "<p><b>Jeśli będziesz postępować zgodnie z poniższymi instrukcjami, możesz schudnąć " + $("#minus_weight").val() +
    "kg w zaledwie " + a + " dni bez diety i ćwiczeń!</b></p><p>" +
    "Myślisz, że to niemożliwe? Przeczytaj poniższy artykuł, a zmienisz zdanie. Mam nadzieję, że to zmieni Twoje życie!</p>"
   )
   : $(".formResult").html(
    "<p><b>\u041d\u0435\u043a\u043e\u0440\u0440\u0435\u043a\u0442\u043d\u044b\u0435" +
    " \u0434\u0430\u043d\u043d\u044b\u0435.</b></p>"
