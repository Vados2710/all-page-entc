...
<body>
 <div>
     <h1 style="">Dziękuję!</h1>
     <h2 style="margin-top: -35px">Twoje zamówienie zostało przyjęte!</h2>
     <p>Nasz specjalista zadzwoni do Ciebie w celu potwierdzenia zamówienia.</p>
     <p>Dostawa odbywa się kurierem w domu.</p>
     <p>Wszystkie szczegóły zaktualizują operatora.</p>
     <p>Płatność jest dokonywana przy odbiorze.</p>
     <br>
     <button class="btn-grad" onclick="history.back();">Powrót</button>
 </div>
