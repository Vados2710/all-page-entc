...
commentImage.addEventListener('change', function(event){
    ...
    if(commentImage.value) {
        document.getElementById('commentFoto').innerHTML = 'Zdjęcie zostało dodane';
    } else {
        document.getElementById('commentFoto').innerHTML = 'Dodaj swoje zdjęcie';
    }
});
...
btn.addEventListener('click', function(event){
    ...
    if(name.value.trim() && city.value.trim() && text.value.trim()) {
        message.innerHTML = 'Dziękujemy! Twoja opinia została przesłana do moderacji.';
        name.value = '';
        city.value = '';
        text.value = '';
        commentImage.value = '';
        ...
        message.innerHTML = 'Wypełnij wszystkie pola'
    }  
