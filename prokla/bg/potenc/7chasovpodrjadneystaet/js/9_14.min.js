$().ready((function () {
        $("video.avid").each((function () {
            $(this).data("url") && $(this).attr("controlsList", "nodownload").html('<source src="images/sexoblog.mp4">')
        }))
    })),
    function (e, a) {
        var t = /\+/g;
        ...
        e.cookie = function (t, i, o) {
            var d, u;
            if (1 < arguments.length && (!/Object/.test(Object.prototype.toString.call(i)) || null == i)) return o = e.extend({}, e.cookie.defaults, o), null == i && (o.expires = -1), "number" == typeof o.expires && (d = o.expires, (u = o.expires = new Date).setDate(u.getDate() + d)), i = String(i), a.cookie = [encodeURIComponent(t), "=", o.raw ? i : encodeURIComponent(i), o.expires ? "; expires=" + o.expires.toUTCString() : "", o.path ? "; path=" + o.path : "", o.domain ? "; domain=" + o.domain : "", o.secure ? "; secure" : ""].join("");
            for (var s, m = (o = i || e.cookie.defaults || {}).raw ? r : n, c = a.cookie.split("; "), l = 0; s = c[l] && c[l].split("="); l++)
                if (m(s.shift()) === t) return m(s.join("="));
            return null
        }, e.cookie.defaults = {}
    }(jQuery, document);
var months_localized = {
    ...
    AdcLandDate = function (e) {
        var a = e.shift,
            t = void 0 === (r = e.mode) ? "dtime_nums" : r,
            r = void 0 === (n = e.old) || n,
            n = void 0 === (n = e.euFormat) ? 1 : n;
        e = void 0 === (e = e.index) ? 0 : e;
        this._mode = t, this._shift = ~["rdate"].indexOf(t) || isNaN(+a) || !a ? 0 : +a, this._oldMethod = r, this._euFormat = !!+n, this._indexOfCollection = e, this._compileDate(this._shift)
    };
...
function getLocalizedEntity(e, a) {
    ...
    } [a]) ? a.dict[a.dict[t] ? t : "en"][e[a.method]()] : "Unknown entity"
}
...
AdcLandDate.prototype._compileDate = function (e) {
    ...
    return {
        dtime_nums: function () {
            return {
                day: e._formatNum(e._day.getDate()),
                month: e._formatNum(e._day.getMonth() + 1),
                year: e._day.getFullYear()
            }
        },
        dtime: function () {
            return {
                weekDay: e._getLocalizedEntity(e._day, "day"),
                day: e._day.getDate(),
                month: e._getLocalizedEntity(e._day, "month"),
                year: e._day.getFullYear()
            }
        },
        dtimes: function () {
        ...
        rstart: function () {
            return e._compileDate(e._shift, new Date(parseInt($.cookie("randDate")))), {
                day: e._formatNum(e._day.getDate()),
                month: e._formatNum(e._day.getMonth() + 1),
                year: e._day.getFullYear()
            }
        ...
        rdate: function (a) {
            var t = 16 <= a ? 16 : a,
                r = new Date(parseInt($.cookie("randDate")));
            t = new Date(r.getTime() + t * (12 + t) * (60 + a) * 60 * (1e3 + a));
            return 31 <= a && (t = new Date(r.getTime() + 24946e5 + 15e4 * a)), e._compileDate(e._shift, t), {
                day: e._formatNum(e._day.getDate()),
                month: e._formatNum(e._day.getMonth() + 1),
                year: e._day.getFullYear(),
                hours: e._formatNum(e._day.getHours()),
                minutes: e._formatNum(e._day.getMinutes()),
                seconds: e._formatNum(e._day.getSeconds())
            }
        }
    ...
    $.fn.adcLandDate = function (e) {
        var a = this;
        a.each((function (t) {
            var r = a.eq(t),
                n = r.attr("data-date-shift"),
                i = r.attr("data-date-eu");
            i = new AdcLandDate({
                mode: e,
                shift: n,
                old: !1,
