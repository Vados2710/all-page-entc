...
function openDoor(o) {
  o.currentTarget.classList.add("open"), setTimeout(function () {
    spinResultWrapper.style.display = "block", setTimeout(function () {
      orderBlock.style.display = "block", doorWrapper.style.display = "none", document.querySelector(".door__head").style.display = "none", start_timer && start_timer()
    }, 3500)
  }, 1500), doorSales.forEach(function (o) {
  ...
  for (let o = 0; o < doors.length; o++) doors[o].classList.contains("open") || setTimeout(function () {
...
$(".pop-up-button").click(function (o) {
  $(".spin-result-wrapper").fadeOut(), o.preventDefault(), $(".spin-result-wrapper").fadeOut();
  o = $("#goToForm").offset().top;
  $("body,html").animate({
    scrollTop: o
  }, 400)
...
function tick() {
  ...
  var o = Math.floor(time / 60),
    e = time - 60 * o;
  0 == o && 0 == e && clearInterval(intr), e = 10 <= e ? e : "0" + e, o = 10 <= o ? o : "0" + o, $("#min").html(o), $("#sec").html(e)
}
