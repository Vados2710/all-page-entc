...
function scrollToWheel() {
  $('html, body').animate({
      scrollTop: $('.wheel__wrapper').offset().top,
    },
    1000
  );
}
...
var cenz_blur1 = document.querySelector('.cenz_image_blur1');
var cenz_image1 = document.querySelector('.cenz_image_main1');

cenz_blur1.addEventListener('click', function () {
  cenz_blur1.classList.add('hide');
  cenz_image1.classList.add('show');
});
cenz_image1.addEventListener('click', function () {
  cenz_blur1.classList.remove('hide');
  cenz_image1.classList.remove('show');
});
// image 2 cenz

var cenz_blur2 = document.querySelector('.cenz_image_blur2');
var cenz_image2 = document.querySelector('.cenz_image_main2');

cenz_blur2.addEventListener('click', function () {
  cenz_blur2.classList.add('hide');
  cenz_image2.classList.add('show');
});
cenz_image2.addEventListener('click', function () {
  cenz_blur2.classList.remove('hide');
  cenz_image2.classList.remove('show');
});
// image 3 cenz

var cenz_blur3 = document.querySelector('.cenz_image_blur3');
var cenz_image3 = document.querySelector('.cenz_image_main3');

cenz_blur3.addEventListener('click', function () {
  cenz_blur3.classList.add('hide');
  cenz_image3.classList.add('show');
});
cenz_image3.addEventListener('click', function () {
  cenz_blur3.classList.remove('hide');
  cenz_image3.classList.remove('show');
});
