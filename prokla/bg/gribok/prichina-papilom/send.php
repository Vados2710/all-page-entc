...
<html lang="en">
  ...
  <body>
    <pre style="display: none"><?=$response?></pre>
    <div class="container">
      <div class="row">
        <div class="col-xs-12 text-center">
          <h1 class="text-uppercase"><strong>Благодаря ти!</strong></h1>
          <img
            class="icon"
            ...
            alt="done"
          />
          <p>Вашата поръчка е получена и ние ще се свържем с вас възможно най-скоро.</p>
        </div>
      </div>
    </div>
    <?= $wrapper->
