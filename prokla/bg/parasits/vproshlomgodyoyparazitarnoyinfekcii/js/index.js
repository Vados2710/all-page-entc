...
const questionOptionBody = document.querySelector(".question__body");
const questionButton = document.querySelector(".answers-btn");
const questionResult = document.querySelector(".question-hidden");
const questionOptions = document.querySelectorAll(".answer-option");

questionButton.addEventListener("click", function () {
  for (let i = 0; i < questionOptions.length; i++) {
    if (questionOptions[i].checked) {
      questionOptionBody.style.display = "none";
