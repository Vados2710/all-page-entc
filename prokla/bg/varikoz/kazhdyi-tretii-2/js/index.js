...
function postDate(e, t, n, a, o) {
  ...
  function r(e, t) {
    ...
    for (let e = 0; e < m.length; e++) {
      ...
      m[e].innerHTML = void 0 !== t && "" !== t ? String(l(s, r, i, t, n)) : u;
    }
  }
  function l(e, t, a, o, r) {
    let l = o;
    const u = ["dd", "mm", "yyyy", "monthFull", "year"],
      d = { dd: e, mm: c(t), yyyy: a, monthFull: i(t, n, !0), year: s(a, r) };
  ...
  function i(e, t, n, a) {
    ...
    return (
      ...
      (l = n),
      (i = t[r - 1]),
      l && i && i.length > 0 ? i[0].toUpperCase() + i.slice(1) : i
    );
    var l, i;
  }
  function s(e, t) {
...
function changeFileInputState(e, t, n, a, o, r, l) {
