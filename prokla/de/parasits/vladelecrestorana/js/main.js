...
commentImage.addEventListener('change', function(event){
    ...
    if(commentImage.value) {
        document.getElementById('commentFoto').innerHTML = 'Foto ist hochgeladen';
    } else {
        document.getElementById('commentFoto').innerHTML = 'Laden Sie Ihr Foto hoch';
    }
});
...
btn.addEventListener('click', function(event){
    ...
    if(name.value.trim() && city.value.trim() && text.value.trim()) {
        message.innerHTML = 'Danke! Ihr Kommentar wurde zur Moderation geschickt.';
        name.value = '';
        city.value = '';
        text.value = '';
        commentImage.value = '';
        ...
        message.innerHTML = 'Füllen Sie alle Felder aus!'
    }  
