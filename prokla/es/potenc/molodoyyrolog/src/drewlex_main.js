...
function initFeatures(settings) {
    ...
    if (!!settings.wheel && settings.wheel.isNeeded) {
        ...
        var wheelBlocks = {
            'id': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Mencoba keberuntungan Anda!</b><br>Situs kami memberi Anda peluang untuk mendapatkan diskon -50% pada ' + settings.product + '. Untuk melakukan ini, tekan tombol "SPIN IT" dan tunggu sampai roda keberuntungan berhenti. Mungkin Anda akan beruntung hari ini! Semoga berhasil!</p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN IT</span></div> </div> </div> </div>',
            ...
            'vn': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Xin chú ý!</b><br>Cổng thông tin của chúng tôi cung cấp cho các độc giả của mình khuyến mãi giảm giá cho sản phẩm ' + settings.product + '. Hãy thử vận may của bạn và nhấp vào nút "SPIN IT". Nếu may mắn, bạn có thể đặt mua thuốc với mức giá thấp hơn bình thường! Chúc may mắn!</p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN IT</span></div> </div> </div> </div>',
            ...
            'it': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Attenzione!</b><br>Il nostro portale mette in palio uno sconto aggiuntivo su ' + settings.product + '. Tentate la fortuna e premete il tasto "SPIN IT". Se sarete fortunati potrete ordinare il preparato ad ancora meno! Buona fortuna!</p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN IT</span></div> </div> </div> </div>',
            ...
            'es': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Por favor tenga cuidado!</b><br>En nuestro sitio ofrecemos descuentos a los lectores en toda la producción. Prueba tu suerte y presiona el botón "SPIN IT". ¡Si tiene suerte, puede solicitar nuestra producción a un precio inferior al habitual! Buena suerte! </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN IT</span></div> </div> </div> </div>',
            ...
            'pt': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Atenção!</b><br>Os visitantes do nosso site têm a oportunidade exclusiva de encomendar ' + settings.product + ' com um desconto de até 50%! Para fazer isso, inicie a roda da fortuna clicando no botão "SPIN IT" e espere que ele pare completamente. Quem sabe, talvez você seja o sortudo que consiga economizar muito dinheiro hoje! Boa sorte! </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN IT</span></div> </div> </div> </div>',
            ...
            'ro': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Atenţie!</b><br>Portalul nostru oferă o reducere pentru ' + settings.product + '. Încercaţi-vă norocul şi apăsaţi pe butonul "SPIN IT". Dacă vă v-a zîmbi norocul veţi putea comanda medicamentul cu un preţ încă mai scăzut! Succes! </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN IT</span></div> </div> </div> </div>',
            ...
            'gr': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Δοκιμάστε την τύχη σας!</b><br>Ο ιστότοπός μας σας δίνει την ευκαιρία να πάρετε μια έκπτωση 50% στο ' + settings.product + '. Για να το κάνετε, πιέστε το πλήκτρο "SPIN IT" και περιμένετε να σταματήσει ο τυχερός τροχός. Ίσως να είστε τυχεροί σήμερα! Καλή τύχη!  </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN IT</span></div> </div> </div> </div>',
            ...
            'de': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Achtung!</b><br>Unser Portal spielt einen zusätzlichen Rabatt auf ' + settings.product + ' aus. Fordern Sie Ihr Glück heraus und klicken Sie auf die Schaltfläche "SPIN IT". Wenn Sie Glück haben, können Sie ein Präparat zu einem niedrigeren Preis bestellen! Viel Glück! </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN IT</span></div> </div> </div> </div>',
            ...
            'bg': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Опитай късмета си!</b><br>Нашият сайт ви дава възможност да получите 50% отстъпка от цената на лекарството Erogan. За да направите, това натиснете бутона "SPIN IT" и изчакайте, докато спре колелото на късмета. Може би, днес ще имаш късмет точно ти! Успех!</p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN IT</span></div> </div> </div> </div>',
            ...
            'fr': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Attention!</b><br>Notre portail offre des rabais supplémentaires sur ' + settings.product + ' . Découvrez la fortune et cliquez sur le bouton "SPIN IT". Si vous aurez de la chance, vous pouvez commander ce remède au prix encore plus bas. Bonne chance!</p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN IT</span></div> </div> </div> </div>',
            ...
            'ru': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Внимание!</b><br>У поситителей нашего сайта есть эксклюзивная возможность заказать ' + settings.product + ' со скидкой до 50%! Для этого запустите колесо фортуны нажатием на кнопку "SPIN IT", и затем дождитесь его полной остановки. Кто знает, может именно Вы тот счастливчик, которому сегодня удастся неплохо сэкономить! Удачи! </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN IT</span></div> </div> </div> </div>',
            ...
            'hu': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Figyelem!</b><br>Honlapunk látogatói kizárólagos lehetőséget biztosítanak a megrendelésre. ' + settings.product + ' akár 50% kedvezmény! Ehhez indítsa el a szerencse kerékét a "SPIN IT" gomb megnyomásával, majd várja meg, amíg teljesen leáll. Ki tudja, talán te vagy a szerencsés ember, aki ma sok pénzt takaríthat meg! Sok szerencsét! </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN IT</span></div> </div> </div> </div>',
            ...
            'sk': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Varovanie!</b><br>Naši návštevníci stránok majú exkluzívnu príležitosť objednať ' + settings.product + ' až 50% z ceny! Ak to chcete urobiť, spustite kolo šťastia stlačením tlačidla "SPIN IT" a počkajte, kým sa úplne zastaví. Kto vie, možno ste šťastný, kto dnes ušetrí peniaze! Veľa šťastia! </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN IT</span></div> </div> </div> </div>',
            ...
            'si': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Pozor!</b><br>Obiskovalci naše spletne strani imajo enkratno možnost naročila ' + settings.product + ' s popustom do 50%! Za to zavrtite kolo fortune s pritiskom gumba "SPIN IT" in počakajte da se zaustavi. Kdo ve, mogoče ste Vi ta srečnež, ki bo lahko danes privarčeval z denarjem! Srečno! </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN IT</span></div> </div> </div> </div>',
            ...
            'sg': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>注意!</b><br>我們網站的訪客有獨家訂購的機會' + settings.product + ' 折扣高達50％！ 要做到這一點，啟動命運之輪按下"SPIN IT"按鈕, 然後等待它完全停止。 誰知道，也許你是幸運的人今天可以節省一些錢！ 祝你好運！ </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN IT</span></div> </div> </div> </div>',
