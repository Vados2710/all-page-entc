(function($){
    ...
    Landing.prototype.initCountDown = function() {
        ...
        var countDownTimer = setInterval( function () {
            ...
            var htmlTime = '<span class="timebox"><span class="black_bg">'+ Math.floor(h/10) +''+ h%10 +'</span></span>'+
                           '<span class="timebox"><span class="black_bg">'+ Math.floor(m/10) +''+ m%10 +'</span></span>'+
                           '<span class="timebox"><span class="black_bg">'+ Math.floor(s/10) +''+ s%10 +'</span></span>';
            $(_this.params.selectors.countDown).html(htmlTime);
        }, 1000);
    };
    Landing.prototype.scrollTop = function() {
