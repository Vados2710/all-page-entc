...
message03 = '<div class="show-message__item show-message_call"><i class="everad-sprite everad-sprite-bucket"></i><p class="show-message__info icon-box horizon"><span class="js-show-name"><span class="js-name"></span></span> vừa đặt mua Thor\'s Hammer <span class="show-message__emph">với giá khuyến mãi '+ discountVal[Math.floor(Math.random()*4)] + '</span></p></div>';
message04 = '<div class="show-message__item show-message_call last-message"><i class="everad-sprite everad-sprite-bucket"></i><p class="show-message__info icon-box horizon"><span style="font-size: 16px;"> Còn <span class="pacedNamed"></span><span style="color: red;font-size: 20px;font-weight: bold;"><span style="color: red;">'+Math.ceil(Math.random()*15+10)+'</span></span> sản phẩm với giá khuyễn mãi.</span></p></div>';*/
flag_phone = true;
flag_five = true;
flag_key = true;
idleTimer = null;
