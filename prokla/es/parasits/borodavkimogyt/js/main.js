...
// Focus/Blur Image
let focusImage = document.querySelectorAll('.focus'),
    blurImage = document.querySelectorAll('.blur'),
    figureControl = document.querySelectorAll('.Figure-control');

$(figureControl).on('click', function () {
	$(this).children('.blur').toggleClass('active');
    $(this).children('.focus').toggleClass('active');
})
