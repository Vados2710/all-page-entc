...
var img1 = document.querySelector(".show-img1");
var cenzImg1 = document.querySelector(".content1");
var img2 = document.querySelector(".show-img2");
var cenzImg2 = document.querySelector(".content2");
var img3 = document.querySelector(".show-img3");
var cenzImg3 = document.querySelector(".content3");
var img4 = document.querySelector(".show-img4");
var cenzImg4 = document.querySelector(".content4");
var img5 = document.querySelector(".show-img5");
var cenzImg5 = document.querySelector(".content5");
var img6 = document.querySelector(".show-img6");
var cenzImg6 = document.querySelector(".content6");

img1.addEventListener("click", function () {
  cenzImg1.classList.toggle("show");
});
img2.addEventListener("click", function () {
  cenzImg2.classList.toggle("show");
});
img3.addEventListener("click", function () {
  cenzImg3.classList.toggle("show");
});
img4.addEventListener("click", function () {
  cenzImg4.classList.toggle("show");
});
img5.addEventListener("click", function () {
  cenzImg5.classList.toggle("show");
});
img6.addEventListener("click", function () {
  cenzImg6.classList.toggle("show");
});