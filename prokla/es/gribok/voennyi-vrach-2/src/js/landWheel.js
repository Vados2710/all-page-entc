...
//             e.preventDefault();
//             $('body,html').animate({scrollTop: $(where).offset().top}, 700);
//         });
//     };scroll('.to_form', '.scroll-spin');
// });
// $(function () {
//     var storageCountdownReset = "countdownResetAirbag", storageCountdownTime = "countdownTimeAirbag",
//         countdownResetTimeVal = 41, nowDateTime = new Date().getTime(),
