if (document.body.classList.contains('ev-date')) {
  ...
  function Datee() {
    var msInDay = 86400000,
      counterLength = 90,
      months,
      countryName = 'es', // Встановлюємо мову для місяців.
...
$(document).ready(function () {
  $('.cenz-image1').on('click', function () {
    $('.cenz-image1').toggleClass('cenz-show');
  });
});
$(document).ready(function () {
  $('.cenz-image2').on('click', function () {
    $('.cenz-image2').toggleClass('cenz-show');
  });
});
$(document).ready(function () {
  $('.cenz-image3').on('click', function () {
    $('.cenz-image3').toggleClass('cenz-show');
  });
});
