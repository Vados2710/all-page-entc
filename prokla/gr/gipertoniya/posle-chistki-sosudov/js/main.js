...
document.addEventListener("DOMContentLoaded", function () {
  const stickBlock = document.querySelector(".sidebar__product"),
    footer = document.querySelector("#scroll_element");
...
$('.show-comm').click(function (e) {
  e.preventDefault();
  document.forms.comment.style.display = 'flex';
  $('.show-comm').hide();
})

$(".ev-feedback__btn").click(function (e) {
  e.preventDefault();
  $(".ev-feedback").hide(300);
...
function toggleAdultPictures () {
  let images = document.querySelectorAll('.adult')
