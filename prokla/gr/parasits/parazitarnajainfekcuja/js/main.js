...
$(".questionario__btn").on("touchend, click", (function () {
    ...
    return console.log(e), console.log(t), e < t ? ($(".questionario__prompt").fadeIn(), void setTimeout((() => {
        $(".questionario__prompt").fadeOut()
    }), 3e3)) : 5 === o ? ($(".question").slideUp(), $(".questionario__controls").fadeOut(), $(".questionario__loader").fadeIn(), void setTimeout((() => {
