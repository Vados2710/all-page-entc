...
const showFormBtn = document.querySelector('.add-comment');
const commentForm = document.querySelector('.ev-feedback');

showFormBtn.addEventListener('click', function() {
    commentForm.style.cssText = 'display: flex;';
})


//Variables | Notifications | RU
const doneTitle = 'Megjegyzés közzétéve!',
    doneText = 'Köszönjük visszajelzését!',
    errorInputTitle = 'Közzétételi hiba!',
    errorInputText = 'Néhány mező hibás.',
    errorSendTitle = 'Megjegyzését már elküldtük.',
    errorSendText = 'Elnézést kérünk a kellemetlenségekért, a webhelyre vonatkozó szabályzatunk értelmében a következő megjegyzéseket moderálni kell, mielőtt közzétesszük őket.',
    emptyTownField = 'DisemRejtettbunyikan',
    avatarUploaded = 'Avatar feltöltve',
    imgUploaded = 'Kép feltöltve',
    fileTypeError = 'Érvénytelen fájltípus',
    fileSizeError = 'Érvénytelen fájlméret (max.\u00A02MB)',
    fileAllError = 'Érvénytelen fájltípus és -méret (maximum\u00A02MB)';
...
var closePopupBtn = document.querySelector(".popup__btn");
