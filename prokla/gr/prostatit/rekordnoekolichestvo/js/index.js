...
function popup() {
  ...
  $(window).mouseout(function (t) {
    t.pageY - $(window).scrollTop() < 1 &&
      1 == e &&
      ($(".fadepopup, .eoxp").fadeIn(300), $(".eeee").fadeIn(300), (e = !1));
  });
}
popup(),
  ...
  $(".lurebtn, #lurebottom div").click(function () {
    $("#lurebottom").fadeOut();
  });
var popupwrap = document.querySelector(".modal-block");
window.addEventListener("click", function (e) {
  e.target !== popupwrap && $(".eeee, .fadepopup").css("display", "none");
});


$(document).ready(function () {
  $("a").attr("data-scroll", "#order-form"),
    $(function () {
      $("a").click(function (e) {
        e.preventDefault();
...
if (document.body.classList.contains('ev-date')) {
  ...
  function Datee() {
    var msInDay = 86400000,
      counterLength = 90,
      months,
      countryName = 'gr', // Встановлюємо мову для місяців.
...
document.querySelector(".close-cookie-popup").addEventListener("click", function() {
  document.querySelector(".cookie-popup").style.display = "none";
});