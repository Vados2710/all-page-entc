...
function postDate() {
  ...
  var body = document.body,
      postLang = document.querySelector('html').getAttribute('lang');
...
var messageComlate = document.querySelector('.comment_complate');
messageComlate.addEventListener('click', function(event) {
  if(event.target.classList.contains('comment_complate') || event.target.classList.contains('close_message')) {
    messageComlate.setAttribute('style', 'display: none');
  }
})

form.addEventListener('submit', function(evt) {
  evt.preventDefault();
  messageComlate.setAttribute('style', 'display: block');
  form.reset();
})