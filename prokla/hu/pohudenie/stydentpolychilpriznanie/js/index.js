    ...
    $(function () {
        $("#calcweight").click(function (a) {
            ...
            Number($("#weight").val()) > Number($("#minus_weight").val()) + 40
                ? $(".formResult").html(
                "<p><b>Ha követed a lenti utasításokat " + $("#minus_weight").val() +
                "kg-ot tudsz majd leadni mindössze " + a + " nap alatt diéta vagy testedzés nélkül!</b></p><p>" +
                "Úgy gondolod, mindez lehetetlen lenne? Olvasd végig a lenti cikket, és meg fog változni a véleményed. Remélem, ez majd az életed is megváltoztatja!</p>"
                )
                : $(".formResult").html(
                "<p><b>Helytelen adatok.</b></p>"
                );
            $(".formResult").css(
