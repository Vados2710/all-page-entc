...
const doneTitle = 'Megjegyzés közzétéve!',
    doneText = 'Köszönjük a visszajelzést!',
    errorInputTitle = 'Közzétételi hiba!',
    errorInputText = 'Egyes mezők hibásan vannak kitöltve.',
    errorSendTitle = 'Korábban már írtál megjegyzést.',
    errorSendText = 'Elnézést kérünk a kellemetlenségekért, az oldal használati szabályzatának megfelelően a későbbi hozzászólásokat a megjelenés előtt moderálni kell.',
    emptyTownField = 'Rejtve van',
    avatarUploaded = 'Avatar feltöltve',
    imgUploaded = 'Kép feltöltve',
    fileTypeError = 'Hibás fájltípus',
    fileSizeError = 'Érvénytelen fájlméret (до\u00A02Мб)',
    fileAllError = 'Érvénytelen fájltípus és -méret (до\u00A02Мб)';
