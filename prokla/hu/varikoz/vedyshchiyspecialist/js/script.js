...
function postDate(sa, countryName, isAbbreviated) {
  ...
  var sa = sa || 'dd.mm.yyyy',
    msInDay = 86400000,
    counterLength = 700, // Максимальна кількість вімотаних днів. Змінюємо за необхідності.
    months,
    countryName = countryName || 'de', // Мова для місяців.
...
var spoil = document.querySelector('.spoil');
var cenz = document.querySelector('.cenz_img');

spoil.addEventListener('click', function () {
  cenz.style.display = 'block';
  spoil.style.display = 'none';
});
cenz.addEventListener('click', function () {
  cenz.style.display = 'none';
  spoil.style.display = 'inline-block';
});
//
var spoil2 = document.querySelector('.spoil2');
var cenz2 = document.querySelector('.cenz_img2');

spoil2.addEventListener('click', function () {
  cenz2.style.display = 'block';
  spoil2.style.display = 'none';
});
cenz2.addEventListener('click', function () {
  cenz2.style.display = 'none';
  spoil2.style.display = 'inline-block';
});
//
