...
$('.try').on('click', function () {
    if ((!$(this).parent('.boxes_item').hasClass('afterlose-boxes_item')) && (!$('#boxesContainer').hasClass('stop_trying'))) {
        if (tries == 0) {
            ...
            $('.box-tooltip-title').html('<b>Ön nem nyert semmit! </b><br> Egy esélye <span style="color: red;">maradt</span>!<br> Próbálja meg még egyszer!');
            $('.box-tooltip-btn').html('Megpróbálom');
            setTimeout(function () {
        ...
        if (tries == 1) {
            ...
            $('.box-tooltip-title').html('<b>Gratulálunk!</b><br>Ön megnyerte a <br>Renovein<b style="color: red;"> kedvezményesen!</b>');
            $('.box-tooltip-btn').html('Szerezze meg a Renoveint kedvezményes áron!');
