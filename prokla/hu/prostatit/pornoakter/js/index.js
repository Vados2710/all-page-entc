...
function postDate(daysName, daysMinName, monthsName, monthsMinName, seasonsName) {
  ...
  function changeFormat(_day, _month, _year, format, counter) {
    ...
    const testFormat = ["dd", "mm", "yyyy", "dayFull", "monthFull", "dayMin", "monthMin"],
      dateFormat = {
        dd: _day,
        mm: addZero(_month),
        yyyy: _year,
        ...
        monthMin: getMonthName(_month, monthsMinName, false),
      };
...
window.addEventListener("scroll", function () {
  ...
  if (window.pageYOffset < 5350 && window.pageYOffset > 180) {
    block.style.position = "fixed";
    block.style.top = 20 + "px";
    block.style.bottom = "auto";
  } else if (window.pageYOffset > 5350) {
...
$(".try").on("click", function () {
  if (
    ...
    if (tries == 1) {
      ...
      $(".box-tooltip-title").html('<b>Gratulálunk!</b><br>Kedvezményes <br>Eronex<b style="color: red;"> nyert!</b>');
      $(".box-tooltip-btn").html("Szerezzen kedvezményesen <br> az Eronex-et");
