...
var Test = function() {
	...
	var dataTestResult = [{
			title: 'Köszönöm a válaszokat! Sajnos csak néhány lépés választ el a halálos következményektől. Annak érdekében, hogy ne álljon le a férfi a szó legvalószínűbb értelmében, kezdje el most a terápiát!',
	}, {
			title: 'Köszönöm a válaszokat! Sajnos csak néhány lépés választ el a halálos következményektől. Annak érdekében, hogy ne álljon le a férfi a szó legvalószínűbb értelmében, kezdje el most a terápiát!',
	}];
	return {
			...
			showQuestion: function showQuestion() {
					...
					btnTest.click(function(e) {
							...
							if (count == 4) {
									btnTest.text("Szerezd meg az eredményt");
							}
