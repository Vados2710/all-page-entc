    ...
    document
        ...
        .addEventListener("click", function() {
            document
                ...
                document
                .querySelector(".header .menu-icon .m-icon")
                .classList.toggle("m-icon-active");
            document
                .querySelector(".header-overlay")
                .classList.toggle("header__overlay-active");
        }),
        document
        .querySelector("header .header__nav")
        .addEventListener("click", function(e) {
            ...
            document
                ...
                document
                .querySelector(".header .menu-icon .m-icon")
                .classList.remove("m-icon-active");
            document
                .querySelector(".header-overlay")
                .classList.remove("header__overlay-active");
        });
})();
