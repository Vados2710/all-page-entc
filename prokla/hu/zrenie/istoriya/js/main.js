...
function spin() {
  wheel.classList.contains("rotated") ? resultWrapper.style.display = "block" : (wheel.classList.add("super-rotation"),
    setTimeout(function () {
...
$("a:not(.exp)").click(function (e) {
  e.preventDefault();
  var t = $(".toform").offset().top;
  $("body,html").animate({
    scrollTop: t
  }, 800)
});
