...
function postDate() {
    ...
    function format(date, format) {
        var testFormat = ['dd', 'day', 'mm', 'month', 'yyyy', 'year', 'decr1Year', 'decr2Year'];
    ...
    let timeSpan = document.querySelectorAll('.random-time');
    ...
    timeSpan[0].innerText = randomTime();
    timeSpan[1].innerText = randomTime();
}
