...
(function ($) {
    var rStartMiliseconds = $.cookie("randDate") ? $.cookie("randDate") : (new Date).getTime() - 29 * 24 * 60 * 60 * 1e3;
    if (!$.cookie("randDate")) $.cookie("randDate", (new Date).getTime() - 29 * 24 * 60 * 60 * 1e3, {expires: 1});
    ...
    var methods = {
        init: function (options) {
            ...
            return this.each(function (x) {
                var z = x >= 16 ? 16 : x;
                var nextDate = new Date(rStart.getTime() + z * (12 + z) * (60 + x) * 60 * (1e3 + x));
                if (x >= 31) nextDate = new Date(parseInt(rStartMiliseconds) + 24946e5 + x * 15e4);
