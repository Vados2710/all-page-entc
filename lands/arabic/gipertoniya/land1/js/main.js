...
(function () {
  var h = document.querySelector('.hours-a');
  m = document.querySelector('.minutes-a');
  s = document.querySelector('.seconds-a');
  if (h && m && s) {
  ...
  function timerSettings() {
    ...
    var hoursHTML = document.getElementsByClassName("hours-a");
    var minutesHTML = document.getElementsByClassName("minutes-a");
    var secondsHTML = document.getElementsByClassName("seconds-a");
    ...
    if (different) {
      ...
      diFilling(secondsHTML, seconds + 'm');
    } else {
  ...
  function convertArabicToBengali(value) {
    var arabicToBengali = {
      0: '٠',
      1: '١',
      2: '٢',
    ...
    return value.toString().split('').map(function (number) {
      return arabicToBengali[number];
    }).join('');
  }

  function filling(obj, value) {
    for (var i = 0; i < obj.length; i++) {
      obj[i].innerHTML = convertArabicToBengali(value);
    }
  }
  ...
  function diFilling(obj, value) {
    for (var i = 0; i < obj.length; i++) {
      ...
      obj[i].innerHTML = convertArabicToBengali(value[i % 2]);
    }
  }
})();