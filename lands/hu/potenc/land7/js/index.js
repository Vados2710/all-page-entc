...
if (document.body.classList.contains("ev-date")) {
    function postDate() {
        const t = new Date;
        let e;
        e = ['Január', 'Február', 'Március', 'Április', 'Május', 'Június', 'Július', 'Augusztus', 'Szeptember', 'Október', 'November', 'December'];
        for (let e = 0; e < 90; e++) {
            const s = "date-" + e,
                o = document.getElementsByClassName(s),
                c = new Date(t.getTime() - 864e5 * e);
            let d = 0,
                u = n(o);
            u = a(u);
            for (let t = 0; t < o.length; t++) {
                const e = o[t].dataset;
                e.format ? o[t].innerHTML = r(c, e.format) : o[t].innerHTML = r(c), /\btime\b/.test(o[t].className) && (o[t].innerHTML += " " + u[d], d++)
            }
        }
        for (let e = 0; e < 90; e++) {
            const s = "date-" + e,
            ...
            for (let t = 0; t < o.length; t++) {
                const e = o[t].dataset;
                e.format ? o[t].innerHTML = r(c, e.format) : o[t].innerHTML = r(c)
            }
        }
        ...
        function r(t, n) {
            ...
            switch (n || !0) {
                ...
                case "yyyy-2":
                    return a += "" + s - 2;
                case "mm.dd.yyyy":
                    return a += o < 10 ? "0" + o : o, a += ".", a += r < 10 ? "0" + r : r, a += "." + s;
                case "month .dd":
                    return a += e[o - 1], a += r < 10 ? " " + r : r, a += " d.";
                case "month":
                    return a += e[o - 1].toLowerCase();
                case "dd":
                    return a += r < 10 ? "0" + r : r;
                case "dd month":
                    return a += r < 10 ? "0" + r : r, a += " ", a += e[o - 1].toLowerCase();
                case "dd month yyyy":
                    return a += r < 10 ? "0" + r : r, a += " ", a += e[o - 1].toLowerCase(), a += " " + s;
                case "day dd, month yyyy":
                    return a += ["Воскресенье", "Понедельник", "Вторник", "Среда", "Четверг", "Пятница", "Суббота"][new Date(s, o - 1, r).getDay()], a += " ", a += r < 10 ? "0" + r : r, a += " ", a += e[o - 1], a += " " + s;
                case "dd/mm/yyyy":
                    return a += r < 10 ? "0" + r : r, a += "/", a += o < 10 ? "0" + o : o, a += "/" + s;
                case "dd-mm-yyyy":
                    return a += r < 10 ? "0" + r : r, a += "-", a += o < 10 ? "0" + o : o, a += "-" + s;
                default:
                    return a += r < 10 ? "0" + r : r, a += ".", a += o < 10 ? "0" + o : o, a += "." + s
