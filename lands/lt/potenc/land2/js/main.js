...
if (document.body.classList.contains('ev-date')) {
  ...
  var reviews = function () {
    $(".reviews-item__btn").on("click", function () {
      ...
      if (!$(this).data("status")) {
        $(this).html("paslėpti atsiliepimą");
        $(this).data("status", true);
      } else {
        $(this).html("perskaityti visą atsiliepimą");
    ...
    $(".feedback-btn").click(function () {
      ...
      if (
        ...
        fileText.html("Patalpinti jūsų nuotrauką");
        fileFlag = true;
        $(".input-file").val("");
  ...
  inputFile.change(function (e) {
    if (inputFile.val() && fileFlag) {
      fileText.html("Nuotrauka patalpinta");
      fileImg.hide();
      fileIcon.show();
      ...
      if (counter == 1) {
        $(".form__visitors p")
          .fadeOut(1100, function () {
            $(this).text("116 pardavimų per paskutinę valandą");
          })
          .fadeIn();
        counter = 0;
      } else {
        $(".form__visitors p")
          .fadeOut(1100, function () {
            $(this).text("Dabar svetainėje " + randNum + " žmonės");
          })
          .fadeIn();
        counter = 1;
      }
