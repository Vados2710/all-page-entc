  ...
  $(document).ready(function () {
    ...
    $(window).on("load resize", function () {
      if ($(document).width() <= 992) {
        ...
        $(".reviews__wrapper").trigger("destroy.owl.carousel");
      }
    });
  });
}
