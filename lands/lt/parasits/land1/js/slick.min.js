...
function postDate(daysName, daysMinName, monthsName) {
    ...
    function innerDate(counter, dateType) {
        ...
        const _msInDay = 864e5, _localDate = new Date(Date.now() + newCounter * _msInDay), _day = _localDate.getDate(),
            _month = _localDate.getMonth() + 1, _year = _localDate.getFullYear(), dayDefault = addZero(_day),
            monthDefault = addZero(_month), defaultDate = dayDefault + "." + monthDefault + "." + _year,
            dateClass = dateType + counter, nodeList = document.querySelectorAll("." + dateClass);
    ...
    function changeFormat(_day, _month, _year, format) {
        ...
        const testFormat = ["dd", "mm", "yyyy", "monthFull"], dateFormat = {
            dd: _day,
            mm: addZero(_month),
            yyyy: _year,
        ...
        for (let i = 0; i < testFormat.length; i++) {
            let string = testFormat[i], regExp = new RegExp(string);
...
var scrollSmooth = function () {
    $(document).on("click", 'a[href^="#"]', function (event) {
        ...
        $("html, body").animate({scrollTop: $($.attr(this, "href")).offset().top}, 1e3)
    })
}, nav = function () {
    ...
    $(window).on("scroll resize", function () {
        ...
        timeout = setTimeout(function () {
            hideBannerScroll(".x_order_form")
        }, 100)
    });

    function hideBannerScroll() {
        const bannerScroll = $(".banner"), bannerDelivery = $(".main-banner"), dT = $(window).scrollTop(),
            dB = dT + $(window).height(), dW = $(window).width();
        let cnt = 0;
        for (let iArr = 0; iArr < arguments.length; iArr++) {
            $(arguments[iArr]).each(function (i, hi) {
                let eT = $(hi).offset().top, eB = eT + $(hi).outerHeight(), eL = $(hi).offset().left,
                    eR = eL + $(hi).width();
        ...
        if (dT <= 100 || cnt > 0) {
            ...
            bannerScroll.fadeIn().css({bottom: bannerDelivery.outerHeight()})
        }
    }
}, reviews = function () {
    $(document).ready(function () {
        ...
        more.on("click", function () {
            var parent = $(this).parent(), text = parent.children(".js-comment");
            if ("false" == text.attr("data-expanded")) {
                var allText = $(".js-comment");
                text.addClass("show");
        ...
        var toggleFormBtn = $(".toggle-form-btn"), reviewsCta = $(".reviews-cta"),
            inputNum = document.querySelectorAll(".input-num"), reviewsInputsWrap = $(".reviews-form__field-wrap"),
            inputAgeWrap = $(".reviews-form__field-wrap--age"), inputAge = $(".input-age"),
            inputFile = $(".input-file"), labelFile = $(".reviews-form__file"), reviewsInput = $(".reviews-input"),
            reviewsInputText = $(".reviews-input-text"), reviewsInputTextarea = $(".reviews-form__textarea"),
            reviewsInputTextareaJS = document.querySelector(".reviews-form__textarea"),
            reviewsInputName = $(".reviews-form__input-name"), reviewsPopup = $(".reviews-popup"),
            fileText = $(".reviews-form__file-text"), fileImg = $(".reviews-form__file-img img"),
            fileIcon = $(".reviews-form__checkmark-icon"), fileFlag = true;
        ...
        reviewsInputText.on("input", function () {
            ...
            setTimeout(function () {
                ...
                if (0 === that.value.replace(res, "").length) {
        ...
        $(".reviews-form").submit(function () {
            if (Number(inputAge.val()) > 17 && Number(inputAge.val()) < 91 && 0 !== reviewsInputTextarea.val().length && 0 !== reviewsInputName.val().length) {
                reviewsCta.hide();
                toggleFormBtn.show();
                reviewsPopup.fadeIn();
                event.preventDefault();
                ...
                fileFlag = true;
                reviewsInput.val("");
                fileText.html("Įkraukite savo nuotrauką");
                fileImg.show();
                fileIcon.hide();
