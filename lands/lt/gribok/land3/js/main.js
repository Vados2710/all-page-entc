    ...
    Landing.prototype.initCountDown = function () {
        ...
        var countDownTimer = setInterval(function () {
            ...
            var htmlTime = ' <div class="timer">' + 
                                '<div class="block">' + '<div class="rect hours for-win">'+ h +'</div>' + '<p>Valandos</p>' +'</div>' +  
                                '<div class="block">' + '<div class="rect mins for-win">'+ m +'</div>'  + '<p>Minutės</p>' +'</div>' + 
                                '<div class="block">' + '<div class="rect secs for-win">'+ s +'</div>'  + '<p>Sekundės</p>' +'</div>' + 
                                '<div class="clear"></div>' +
                            '</div>' ;
