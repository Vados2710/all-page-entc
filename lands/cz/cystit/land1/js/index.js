...
//     setTimeout(function () {
//         if ((form.getBoundingClientRect().top - 1000) < 0 && (form.getBoundingClientRect().top*-1 < form.getBoundingClientRect().height + 2000)) {
//             let c = window.pageYOffset + form.getBoundingClientRect().top + 300;
//             window.scrollTo(0, c)
//         }
//     }, 1000)
// })
