...
$(document).ready(function() {
    ...
    $button.on("click", function(ev) {
        ...
        if (codeValues.test(codeValue) && $codeLenght == 15) {
            return $message.text("Р”Р°РЅРЅС‹Р№ РєРѕРґ РІРµСЂРµРЅ. CРїР°СЃРёР±Рѕ, С‡С‚Рѕ РІС‹Р±СЂР°Р»Рё РЅР°С€Сѓ РїСЂРѕРґСѓРєС†РёСЋ!");
        } else if ($code.val() !== '' && $code.val() !== ' ' && $code.val() !== '  ') {
            return $message.text("Рљ СЃРѕР¶Р°Р»РµРЅРёСЋ, РґР°РЅРЅС‹Р№ РєРѕРґ РЅРµ РЅР°Р№РґРµРЅ! Р’РµСЂРѕСЏС‚РЅРµРµ РІСЃРµРіРѕ, РІС‹ РїСЂРёРѕР±СЂРµР»Рё РїРѕРґРґРµР»СЊРЅС‹Р№ РїСЂРѕРґСѓРєС‚.");
        } else {
            return $message.text("Р’РІРµРґРёС‚Рµ, РїРѕР¶Р°Р»СѓР№СЃС‚Р°, РєРѕРґ.");
        }
