window.landing_data = {"id":"1420","created_at":"2016-04-06T14:46:27.057Z","updated_at":"2016-07-08T14:38:09.687Z","removed_at":null,"name":"Стоп Актив B -50%","status":"deploying","type":"landing","cpa_goal_id":"drY","crm_landing_id":"964","ua_price_current":null,"ua_price_previous":null,"ua_price_total":null,"ru_price_current":null,"ru_price_previous":null,"ru_price_total":null,"metric_code_ga":null,"metric_code_ym":"36609275","metric_code_vk":null,"metric_code_begun":null,"metric_code_target_mail":null,"metric_code_marketgid":null,"mobile_redirect_url":null,"is_mobile_redirect_enabled":0,"is_cdn_enabled":1,"transit_target_url":null,"ua_price_delivery":null,"ru_price_delivery":null,"kz_price_current":null,"kz_price_previous":null,"kz_price_total":null,"kz_price_delivery":null,"custom_html":null,"expertsender_list_id":null,"md_price_current":null,"md_price_previous":null,"md_price_total":null,"md_price_delivery":null,"by_price_current":null,"by_price_previous":null,"by_price_total":null,"by_price_delivery":null,"az_price_current":null,"az_price_previous":null,"az_price_total":null,"az_price_delivery":null,"ge_price_current":null,"ge_price_previous":null,"ge_price_total":null,"ge_price_delivery":null,"prices":{"ge":{"delivery":null,"current":null,"total":null,"previous":null},"by":{"delivery":"5","current":"30","total":"35","previous":"60"},"kz":{"delivery":"1000","current":"5490","total":"6490","previous":"10980"},"md":{"delivery":null,"current":null,"total":null,"previous":null},"ru":{"delivery":"290","current":"990","total":"1280","previous":"1980"},"az":{"delivery":null,"current":null,"total":null,"previous":null},"ua":{"delivery":null,"current":null,"total":null,"previous":null},"kg":{"current":"1590","total":"1890","delivery":"300","previous":"3180"}},"deployed_at":"2016-06-30T15:37:51.583Z","metric_code_gtm":null,"price_current":"990","price_previous":"1980","price_total":"1280","price_delivery":"290","currency":"руб","country_code":"ru"};
...
require('./js/direct-link.js');
require('./js/promo-code.js');
require('./js/client-data.js');
require('./js/update-geo.js');
require('./js/inject-metrics.js');
require('./js/subscribe.js');

},{"./js/client-data.js":2,"./js/direct-link.js":4,"./js/inject-metrics.js":5,"./js/promo-code.js":7,"./js/subscribe.js":9,"./js/update-geo.js":10,"./js/validator.js":11}],2:[function(require,module,exports){
var $ = require('../vendor/jquery/dist/jquery.js');
var cookies = require('./cookies.js');
var fields = ['client_name', 'client_phone', 'client_address'];

$(function() {
	fields.forEach(function (field) {
		var value = cookies[field];
...
},{"../vendor/jquery/dist/jquery.js":13,"./cookies.js":3}],3:[function(require,module,exports){
...
var $ = require('../vendor/jquery/dist/jquery.js');
var qs = require('./query-string.js');
var cookies = require('./cookies');

$(function() {
	if (qs['ref'] !== 'cpa' && qs['c']) {
		var url = 'http://r.everad.ru/'
			+ qs['c'] + window.location.search
			+ '&return_json=1'
			+ '&referrer=' + encodeURIComponent(document.referrer);

		$.getJSON(url).done(function(data){
			if (data.click_id) {
				document.cookie = encodeURIComponent('click_id') + '=' + encodeURIComponent(data.click_id);
			}
		});
	}
	var parkedLandingId = cookies['landing_page_id'];
	var parkedCampaignId = cookies['campaign_id'];
	var parkedAffiliate_id = cookies['affiliate_id'];
	if (parkedLandingId && parkedCampaignId && parkedAffiliate_id) {
		if (qs['click_id']) {
			document.cookie = encodeURIComponent('click_id') + '=' + encodeURIComponent(qs['click_id']);
		} else {
			var url = '/track' + (window.location.search || '?') +
			'&landing_page_id=' + parkedLandingId +
			'&campaign_id=' + parkedCampaignId +
			'&affiliate_id=' + parkedAffiliate_id +
			'&referrer=' + encodeURIComponent(document.referrer);
			$.getJSON(url).done(function(data){
				if (data.click_id) {
					document.cookie = encodeURIComponent('click_id') + '=' + encodeURIComponent(data.click_id);
...
},{"../vendor/jquery/dist/jquery.js":13,"./cookies":3,"./query-string.js":8}],5:[function(require,module,exports){
var $ = require('../vendor/jquery/dist/jquery.js');
var qs = require('./query-string.js');
require('../templates.js');

$(function() {
	$('body').append(JST['metrics'](qs));
});

},{"../templates.js":12,"../vendor/jquery/dist/jquery.js":13,"./query-string.js":8}],6:[function(require,module,exports){
window.landing_data.getPricing = function(country_code) {
	var prices = window.landing_data.prices[country_code] || {};
	var currency = window.landing_data.currency;

	return {
		'price_previous': prices.previous,
		'price_current': prices.current,
		'price_total': prices.total,
		'price_delivery': prices.price_delivery,
		'currency': currency
	};
};
...
module.exports = window.landing_data;
...
$(function() {
	if (qs['click_id']) {
		$('.x_ref_code').text(qs['click_id']);
	}
});

},{"../vendor/jquery/dist/jquery.js":13,"./query-string.js":8}],8:[function(require,module,exports){
var qs = (function(a) {
	if (a == "") return {};
	var b = {};
	for (var i = 0; i < a.length; ++i) {
...
// FACEPALM CODE GOES HERE
window.openbox1 = function openbox1 (id) {
	display = document.getElementById('popup').style.display;
	document.getElementById('popup').style.display='none';
	display = document.getElementById('pop1').style.display;
	document.getElementById('pop1').style.display='none';
};

window.openbox = function openbox (id) {
	display = document.getElementById('popup').style.display;
...
$('.form1').submit(function() {
	var k=document.getElementById("vhod_add_mail").value,
	k1=document.getElementById("vhod_add_mail1").value;
...
},{"../vendor/jquery/dist/jquery.js":13}],10:[function(require,module,exports){
var landingData = require('./landing-data');
var $ = require('../vendor/jquery/dist/jquery.js');
var fields = ['price_previous', 'price_current', 'price_total', 'price_delivery', 'currency'];

$(function() {
	var countrySelectItems = $('select[name="country_code"]');

	function updatePrices(countryCode) {
		var prices = landingData.getPricing(countryCode);

		fields.forEach(function (field) {
			var value = prices[field];
			if (value) {
				$('.x_' + field).text(value);
			}
		});

		countrySelectItems.val(countryCode);
	}

	countrySelectItems.change(function() {
		var countryCode = $(this).val();
		updatePrices(countryCode);
	});

	updatePrices(landingData.getCountryCode());

});

},{"../vendor/jquery/dist/jquery.js":13,"./landing-data":6}],11:[function(require,module,exports){
var $ = require('../vendor/jquery/dist/jquery.js');
...
$(function (){
	$('form[action="/submit"]').submit(function () {
		...
		var phone = ($('input[name="phone"]', this).val() || '').replace(/[^0-9]+/g, '');
		...
		if (phone.length < 8) {
			$.get('/invalid-phone/Z' + phone + 'Z');
			alert('Укажите корректный телефон, иначе мы не сможем с Вами связаться!');
			return false;
		}
	...
	$('form[action="/subscribe"]').submit(function () {
...
},{"../vendor/jquery/dist/jquery.js":13}],12:[function(require,module,exports){
window.JST = {};JST["metrics"] = function anonymous(it) {
var out='';if(it.metric_code_ym){out+='<script type="text/javascript"> (function (d, w, c) { (w[c] = w[c] || []).push(function() { try { w.yaCounter'+( it.metric_code_ym )+' = new Ya.Metrika({id:'+( it.metric_code_ym )+', webvisor:true, clickmap:true, trackLinks:true, accurateTrackBounce:true}); } catch(e) { } }); var n = d.getElementsByTagName("script")[0], s = d.createElement("script"), f = function () { n.parentNode.insertBefore(s, n); }; s.type = "text/javascript"; s.async = true; s.src = (d.location.protocol == "https:" ? "https:" : "http:") + "//mc.yandex.ru/metrika/watch.js"; if (w.opera == "[object Opera]") { d.addEventListener("DOMContentLoaded", f, false); } else { f(); } })(document, window, "yandex_metrika_callbacks");</script><noscript><div><img src="//mc.yandex.ru/watch/'+( it.metric_code_ym )+'" style="position:absolute; left:-9999px;" alt="" /></div></noscript>';}if(it.metric_code_vk){out+='<script type="text/javascript">(window.Image ? (new Image()) : document.createElement(\'img\')).src = location.protocol + \'//vk.com/rtrg?r='+( it.metric_code_vk )+'\';</script>';}if(it.metric_code_marketgid){out+='<script type="text/javascript"> (function() { var d = document, w = window; w.MgSensorData = {cid: "'+( it.metric_code_marketgid )+'", lng:"ru", nosafari:true}; var n = d.getElementsByTagName("script")[0]; var s = d.createElement("script"); s.type = "text/javascript"; s.async = true; var dt = !Date.now?new Date().valueOf():Date.now(); s.src = "//a.marketgid.com/mgsensor.js?d=" + dt; n.parentNode.insertBefore(s, n); })(); </script>';}if(it.metric_code_target_mail){out+='<script type="text/javascript"> var _tmr = _tmr || []; _tmr.push({id: "'+( it.metric_code_target_mail )+'", type: "pageView", start: (new Date()).getTime()}); (function (d, w) { var ts = d.createElement("script"); ts.type = "text/javascript"; ts.async = true; ts.src = (d.location.protocol == "https:" ? "https:" : "http:") + "//top-fwz1.mail.ru/js/code.js"; var f = function () {var s = d.getElementsByTagName("script")[0]; s.parentNode.insertBefore(ts, s);}; if (w.opera == "[object Opera]") { d.addEventListener("DOMContentLoaded", f, false); } else { f(); } })(document, window);</script><noscript><div style="position:absolute;left:-10000px;"> <img src="//top-fwz1.mail.ru/counter?id='+( it.metric_code_target_mail )+';js=na" style="border:0;" height="1" width="1" alt="Рейтинг@Mail.ru" /></div></noscript>';}if(it.metric_code_ga){out+='<script> (function(i,s,o,g,r,a,m){i[\'GoogleAnalyticsObject\']=r;i[r]=i[r]||function(){ (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o), m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m) })(window,document,\'script\',\'//www.google-analytics.com/analytics.js\',\'ga\'); ga(\'create\', \''+( it.metric_code_ga )+'\', \'auto\'); ga(\'require\', \'linkid\', \'linkid.js\'); ga(\'require\', \'displayfeatures\'); ga(\'send\', \'pageview\');</script>';}if(it.metric_code_begun){out+='<script type="text/javascript"> (function(w, p) { var a, s; (w[p] = w[p] || []).push({ counter_id: '+( it.metric_code_begun )+' }); a = document.createElement(\'script\'); a.type = \'text/javascript\'; a.async = true; a.src = (\'https:\' == document.location.protocol ? \'https://\' : \'http://\') + \'autocontext.begun.ru/analytics.js\'; s = document.getElementsByTagName(\'script\')[0]; s.parentNode.insertBefore(a, s); })(window, \'begun_analytics_params\');</script>';}if(it.metric_code_gtm){out+='<noscript> <iframe src="//www.googletagmanager.com/ns.html?id='+( it.metric_code_gtm )+'" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript><script> (function(w,d,s,l,i){wl=wl||[];wl.push( {\'gtm.start\': new Date().getTime(),event:\'gtm.js\'} );var f=d.getElementsByTagName(s)0, j=d.createElement(s),dl=l!=\'dataLayer\'?\'&l=\'+l:\'\';j.async=true;j.src= \'//www.googletagmanager.com/gtm.js?id=\'+i+dl;f.parentNode.insertBefore(j,f); })(window,document,\'script\',\'dataLayer\',\''+( it.metric_code_gtm )+'\');</script>';}return out;
};
