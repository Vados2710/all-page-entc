...
(function () {
    ...
    function reviews() {
      $(document).ready(function () {
        ...
        reviewsInputTextareaJS.value = '', reviewsInputTextarea.on('input', function () {
          ...
          inputFile.val() && fileFlag && (fileText.html('Zdjęcie zostało dołączone!'), fileImg.hide(), fileIcon.show(), labelFile.addClass('rloaded'), fileFlag = !1);
    ...
    function promo() {
      ...
      setInterval(function () {
        counter == 1 ? (people.fadeIn(), sold.fadeOut(), counter = 0) : (people.fadeOut(), sold.fadeIn(), counter = 1);
    ...
    function banner() {
      function hideBannerScroll() {
        var bannerScroll = $('.banner'),
          ...
          dW = $(window).width();
        var cnt = 0;
        for (var iArr = 0; iArr < arguments.length; iArr++) $(arguments[iArr]).each(function (i, hi) {
          var eT = $(hi).offset().top,
            eB = eT + $(hi).outerHeight(),
            eL = $(hi).offset().left,
            eR = eL + $(hi).width();
          eT <= dB && eB >= dT && eL <= dW && eR >= 0 && (cnt += +1);
        });
        dT <= 100 || cnt ? bannerScroll.fadeOut() : bannerScroll.fadeIn().css({
          bottom: bannerDelivery.outerHeight()
        });
      }
      var timeout = !1;
      $(window).on('scroll resize', function () {
        timeout !== !1 && clearTimeout(timeout), timeout = setTimeout(function () {
    ...
    function header() {
      $('.header__menu').on('click', function () {
        $('.header__menu-open').addClass('menu-opened'), $('.header__overlay').addClass('overlay');
      }), $('.close').on('click', function () {
        $('.header__menu-open').removeClass('menu-opened'), $('.header__overlay').removeClass('overlay');
      }), $('.close-menu').on('click', function () {
        $('.header__menu-open').removeClass('menu-opened'), $('.header__overlay').removeClass('overlay');
      }), $('.header__overlay').on('click', function () {
        $(this).removeClass('overlay'), $('.header__menu-open').removeClass('menu-opened');
      })
    }
