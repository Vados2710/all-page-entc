  ...
  a.fn.lightSlider = function (b) {
    ...
    return (
          ...
          if ("undefined" != typeof k && null !== k)
            for (var d in k.settings)
              k.settings.hasOwnProperty(d) &&
                (("undefined" == typeof f[d] || null === f[d]) && (f[d] = e[d]), (e[d] = k.settings[d]));
        ...
        initialStyle: function () {
          ...
          "fade" === e.mode && ((e.autoWidth = !1), (e.slideEndAnimation = !1)),
            ...
            g
              ...
              .wrap('<div class="lSSlideOuter ' + e.addClass + '"><div class="lSSlideWrapper"></div></div>'),
            (p = g.parent(".lSSlideWrapper")),
            e.rtl === !0 && p.parent().addClass("lSrtl"),
            e.vertical
              ? (p.parent().addClass("vertical"), (o = e.verticalHeight), p.css("height", o + "px"))
              : (o = g.outerWidth()),
            h.addClass("lslide"),
            e.loop === !0 &&
              "slide" === e.mode &&
              ...
              (z.clone = function () {
                if (z.calWidth(!0) > o) {
                  for (
                    var b = 0, c = 0, d = 0;
                    d < h.length &&
                    ((b += parseInt(g.find(".lslide").eq(d).width()) + e.slideMargin), c++, !(b >= o + e.slideMargin));
                    d++
                  );
        ...
        slide: function () {
          ...
          (z.calSlide = function () {
            m > o &&
              ...
              e.loop === !0 &&
                "slide" === e.mode &&
                (q >= l - g.find(".clone.left").length / e.slideMove && a.resetSlide(g.find(".clone.left").length),
          ...
          if ((p.css("transition-duration", e.speed + "ms"), "slide" === e.mode)) {
            ...
            var d = function (a) {
              ...
              if ((b || (a && (c = 1)), e.autoWidth))
                for (
                  var d = 0, f = 0;
                  f < h.length && ((d += parseInt(h.eq(f).width()) + e.slideMargin), (q = f + c), !(d >= t));
                  f++
                );
              else {
      ...
      (z.init = function () {
        z.chbreakpoint(),
          e.vertical === !0
            ? ((o = e.item > 1 ? e.verticalHeight : h.outerHeight()), p.css("height", o + "px"))
            : (o = p.outerWidth()),
          ...
          e.adaptiveHeight === !1 &&
            ("slide" === e.mode ? (e.vertical === !1 ? d.setHeight(g, !1) : d.auto()) : d.setHeight(g, !0)),
