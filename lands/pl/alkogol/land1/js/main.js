(function($) {
    ...
    Landing.prototype.initCountDown = function() {
        ...
        var countDownTimer = setInterval(function() {
            ...
            var htmlTime = '<div class="timebox"><span>'+h+'</span><em>часы</em></div>'+
                                '<div class="timebox"><span>'+m+'</span><em>минуты</em></div>'+
                                '<div class="timebox"><span>'+s+'</span><em>секунды</em></div>';
