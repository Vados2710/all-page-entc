    ...
    $('.js-getResult').on('change', function(){
        ...
        setTimeout(function(){
            ...
            if(CheckSlide){
                ...
                switch (valCheck) {
                    case 0:
                        $('.resheader').html('Малка вероятност от цистит');
                        $('.restext').html('Не забравяйте за сезонната профилактика<br> с <span><b>Cystonette</b></span>');
                        break;
                    case 1:
                        $('.resheader').html('Средната вероятност от цистит');
                        $('.restext').html('Препоръчителен курс за профилактика <span><b>Cystonette</b></span>.');
                        break;
                    case 2:
                        $('.resheader').html('Висока вероятност от цистит');
                        $('.restext').html('Препоръчват се редовни курсове <span><b>Cystonette</b></span><br> 3-4 пъти годишно.');
                        break;
                    default:
                        $('.resheader').html('Висока вероятност от цистит');
                        $('.restext').html('Препоръчват се редовни курсове <span><b>Cystonette</b></span><br>  3-4 пъти годишно.');
