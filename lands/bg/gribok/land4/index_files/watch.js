(function (h, f, ca) {
    ...
    function ia(a, b) {
        if (.01 > Math.random())try {
            (new N).log("jserrs", I, a.message, b, A.href, "", "string" == typeof a.stack && a.stack.replace(/\n/g, "\\n"))
        } catch (e) {
            var c = ["cp: " + b, a.name + ": " + a.message, "debug: ", "code: " + I, "stack: " + a.stack];
            (new Image).src = "//an.yandex.ru/jserr/101500?cnt-class=100&errmsg=" + encodeURIComponent(c.join("; ").replace(/\r?\n/g, "\\n"))
        }
    }

    function ab(a, b, c) {
        return h.setTimeout(u(a,
            c || "setTimeout"), b)
    }
    ...
    function eb(a) {
        var b = [], c = a._lastPerformanceTiming, e = Ka();
    ...
    function gb(a) {
        ...
        for (var c = a.patterns, e = 0; e < c.length; e++)if (b.match(new RegExp(c[e], "i"))) {
            var d = a.params || [];
            if (d.length)for (var h = g.safeDecodeURIComponent((RegExp.$1 || "").replace(/\+/g, "%20")), J = 0; J < d.length; J++) {
                if (h == g.safeDecodeURIComponent(d[J]))return !0
            } else return !0
        }
        return !1
    }
    ...
    function hb(a, b) {
        ...
        d && (d = -1 < d.indexOf(";") ? g.safeDecodeURIComponent(d) : S.decode(d.replace(/[-*_]/g, function (a) {
            return {"*": "+", "-": "/", _: "="}[a] || a
        })));
    ...
    function ib(a, b, c, e, d) {
        ...
        function F(a) {
            if (a[B])a:{
                ...
                if (0 < c) {
                    ...
                    var e = ta[c], g = a[0] + "x" + a[1], h = a[2] + "x" + a[3];
                    g != e.pos && (e.pos = g, m(d, 9), n(d, b), n(d, c), n(d, a[0]), n(d, a[1]));
                ...
                (c = l.getElementParent(a)) && F(c);
                a[B] = da;
                ta[da] = {};
                da++;
                if (a.nodeName)if (c = +a[B], !isFinite(c) || 0 >= c)b = null; else {
                    var d = 64, e = 0, f = l.getElementParent(a),
                        g = f && f[B] ? f[B] : 0;
                    0 > g && (g = 0);
                    var h = a.nodeName.toUpperCase(), q = ba[h];
                    q || (d |= 2);
                    var x = l.getElementNeighborPosition(a);
                    x || (d |= 4);
                    var r = l.getElementRegion(a);
                    (f = f ? l.getElementRegion(f) : null) && r[0] == f[0] && r[1] == f[1] && r[2] == f[2] && r[3] == f[3] && (d |= 8);
                    ta[c].pos = r[0] + "x" + r[1];
                    ta[c].size = r[2] + "x" + r[3];
                    a.id && "string" == typeof a.id && (d |= 32);
                    (f = l.calcTextChecksum(a)) && (d |= 16);
                    var J = l.calcAttribChecksum(a);
                    J && (e |= 2);
                    var k;
                    b:{
                        k = l.getElementChildren(l.getElementParent(a), a.tagName);
                        for (var G = 0; G < k.length; G++)if ((!k[G].id ||
                            "string" != typeof k[G].id) && l.calcAttribChecksum(k[G]) == J && l.calcTextChecksum(k[G]) == f) {
                            k = !0;
                            break b
                        }
                        k = !1
                    ...
                    q ? m(k, q) : p(k, h);
                    x && n(k, x);
                    d & 8 || (n(k, r[0]), n(k, r[1]), n(k, r[2]), n(k, r[3]));
                    d & 32 && p(k, a.id);
                    f && R(k, f);
                    d & 1 && R(k, b);
                    m(k, e);
        ...
        function x(a) {
            ...
            if (b && "SCROLLBAR" != b.nodeName) {
                if (/^INPUT|SELECT|TEXTAREA|BUTTON$/.test(b.tagName))if (b[B])F(b); else {
                    var c = b.form;
                    if (c)for (var c = c.elements, d = c.length, e = 0; e < d; e++)/^INPUT|SELECT|TEXTAREA|BUTTON$/.test(c[e].tagName) && !c[e][B] && F(c[e]); else F(b)
                } else F(b);
                w(y, [K(), a.type, b, C.getPos(a), a.which, a.button])
            }
        }
        ...
        function q(a) {
            ...
            a:{
                ...
                if ("string" == typeof b) {
                    ...
                    c && Da(c) || Q(c, !0) || b == Ea || (Ea = b, w(W, [K(), b]))
                }
            }
        }
        ...
        function G(a) {
            var b = J(), c = b - U;
            if (!(10 > c)) {
                var d = C.getPos(a), e = ha[0] - d[0], g = ha[1] - d[1], e = e * e + g * g;
                0 >= e || 16 > e && 100 > c || 20 > c && 256 > e || (U = b, ha = d, x(a))
            }
        }

        function ua() {
            var a = l.getDocumentScroll(), b = J();
            10 > b - na || 10 >
            Math.abs(a[0] - ja[0]) && 10 > Math.abs(a[1] - ja[1]) || (na = b, ja = a, w(H, [K(), a]))
        }
        ...
        function Fa() {
            w(E, [K(), l.getViewportSize(), l.getDocumentSize()])
        }
        ...
        function Da(a) {
            return "INPUT" == a.tagName ? "password" == a.type || a.name && fa.test(a.name) || a.id && fa.test(a.id) : !1
        }

        function Oa(a, b, c) {
            !(a = C.getTarget(a)) || Da(a) || Q(a) || (F(a), w(M, [K(), b, c, a]))
        }

        function Pa(a) {
            var b = a.keyCode, c = Na(a);
            if ({
                    3: 1,
                    8: 1,
                    9: 1,
                    ...
                    144: 1,
                    145: 1
                }[b] || 112 <= b && 123 >= b || 96 <= b && 105 >= b || c & 16)19 == b && 4 == (c & -17) && (b = 144), Oa(a, b, c | 16), ma = !1, g.setTimeout(function () {
                ma = !0
            }, 1), !(67 == b && c & 4) || c & 1 || c & 2 || Ga()
        }

        function Qa(a) {
            ma && !P && 0 !== a.which && (Oa(a, a.charCode || a.keyCode, Na(a)), P = !0, g.setTimeout(function () {
                P = !1
            }, 1))
        }

        function Ga() {
            Ha || (Ha = !0, Ea && w(X, [K()]), g.setTimeout(function () {
                Ha = !1
            }, 1))
        }
        ...
        function wa(a) {
            if ((a = C.getTarget(a)) && /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(a.tagName)) {
                if (a[B])F(a); else {
                    var b = a.form;
                    if (b)for (var b =
                        b.elements, c = b.length, d = 0; d < c; d++)/^INPUT|SELECT|TEXTAREA|BUTTON$/.test(b[d].tagName) && !b[d][B] && F(b[d]); else F(a)
                }
                w(Y, [K(), a])
            }
        }
        ...
        function xa(a) {
            (a = C.getTarget(a)) && /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(a.tagName) && (F(a), w(O, [K(), a]))
        }

        function ya(a) {
            if ((a = C.getTarget(a)) && !Da(a) && !Q(a) && /^INPUT|SELECT|TEXTAREA$/.test(a.tagName)) {
        ...
        function V(a) {
            if ((a = C.getTarget(a)) && !S(a) && "FORM" == a.nodeName) {
                for (var b = a.elements, c = 0; c <
                b.length; c++)l.isEmptyField(b[c]) || F(b[c]);
                w(ka, [K(), a], !0)
            }
        }
        ...
        function Z(a) {
            ...
            if (a.touches && a.touches.length) {
                ...
                if (b && b != f) {
                    F(b);
                    for (var c = 0; c < a.touches.length; c++)w(y, [K(), "touch", b, [a.touches[c].pageX, a.touches[c].pageY], 0, 0])
                }
            }
        }
        ...
        function T(a) {
            ...
            if (b) {
                ...
                c && (F(b), w(A, [K(), b, C.getPos(a), c]))
            }
        }

        function ea(a) {
            (a = C.getTarget(a)) && "BODY" == a.tagName && oa.append([],
                !0)
        }
        ...
        var oa = new ra({
            ...
            counterId: b,
            counterType: c,
            meta: {url: z().href, hitId: e, timezone: za, timestamp: Aa}
        }), ba = {
            A: 1,
            ABBR: 2,
            ACRONYM: 3,
        ...
        r(0);
        var I = 0, da = 1, U = 0, ha = [0, 0], na = 0, ja = [0, 0], la = {}, fa = /^(password|passwd|pswd)$/, ma = !0, P = !1, Ea = "", Ha = !1, pa = !0, ia = J(), B = "metrikaId_" + Math.random(), ta =
        {}, Ba = ":submit" + Math.random();
        if (!g.isMetrikaPlayer()) {
            k.on(f, "mousemove", G);
            k.on(f, "click,dblclick,mousedown", x);
            k.on(f, "mouseup", q);
            k.on(h, "scroll", ua);
            if ("onmousewheel" in f)k.on(f, "mousewheel", T); else k.on(f, "wheel", T);
            k.on(h, "beforeunload", va);
            if (!kb)k.on(h, "unload", va);
            k.on(h, "resize", Fa);
            k.on(f, "keydown", Pa);
            k.on(f, "keypress", Qa);
            k.on(f, "copy", Ga);
            k.on(f, "touchmove,touchstart", Z);
            if (f.body)k.on(f, "mouseleave", ea);
            f.attachEvent && !h.opera ? (k.on(f, "focusin", Ra), k.on(f, "focusout", Sa)) : (k.on(h, "focus",
                Ia), k.on(h, "blur", qa), k.on(f, "blur", qa));
            f.addEventListener ? (k.on(f, "scroll", D), k.on(f, "focus", wa), k.on(f, "blur", xa), k.on(f, "change", ya), k.on(f, "submit", V)) : f.attachEvent && (k.on(f, "focusin", wa), k.on(f, "focusout", xa), function () {
                for (var a = f.getElementsByTagName("form"), b = 0; b < a.length; b++) {
                    for (var c = a[b].getElementsByTagName("*"), d = 0; d < c.length; d++)if (/^INPUT|SELECT|TEXTAREA$/.test(c[d].tagName))k.on(c[d], "change", ya);
                    k.on(a[b], "submit", V)
                }
            }());
            (function () {
                ...
                if (a.length)for (var b =
                    0; b < a.length; b++) {
                    var c = a[b].submit;
                    if ("function" == typeof c || "object" == typeof c && /^\s*function submit\(\)/.test(String(c)))a[b][Ba] = c, a[b].submit = function () {
                        V({target: this});
                        return this[Ba]()
                    }
                }
            })();
            "0:0" != l.getDocumentScroll().join(":") && ua();
            Fa();
            d.uploadPage = u(function (d) {
                ...
                var q = h.XMLHttpRequest ? new h.XMLHttpRequest : new ActiveXObject("Msxml2.XMLHTTP"),
                    r = l.getDocumentCharset(), x = "text/html" + (r ? ";charset=" + r : ""), k = new lb({
                        protocol: a,
                        counterId: b,
                        counterType: c
                    });
                if ("html" == d)return d = RegExp("<script [^>]*?//mc\\.yandex\\.ru/watch/.*?\x3c/script>", "gi"), k.sendContent(l.getDocumentHTML().replace(d, ""), x, e, za, Aa), !0;
                q && (q.open("get", z().href, !0), q.onreadystatechange = u(function () {
                    if (4 == q.readyState) {
                        var a = q.getResponseHeader("content-type") || "";
                        r && -1 === a.indexOf("charset=") && (a = x);
                        k.sendContent(q.responseText, a, e, za, Aa)
                    }
                }, "updatePage.1"), q.overrideMimeType &&
                r && q.overrideMimeType(x), q.send(null));
                return !0
            }, "uploadPage")
        }
        return {
            start: function () {
                ...
                oa.clear();
                k.un(f, "mousemove", G);
                k.un(f, "click,dblclick,mousedown", x);
                k.un(f, "mouseup", q);
                k.un(f, "mousewheel,wheel", T);
                k.un(h, "scroll", ua);
                k.un(h, "beforeunload", va);
                k.un(h, "unload", va);
                k.un(h, "resize", Fa);
                k.un(f, "keydown", Pa);
                k.un(f, "keypress", Qa);
                k.un(f, "copy", Ga);
                k.un(f, "touchmove,touchstart", Z);
                f.body && k.un(f, "mouseleave", ea);
                k.un(f, "focusin", Ra);
                k.un(f, "focusout", Sa);
                k.un(h, "focus",
                    Ia);
                k.un(h, "blur", qa);
                k.un(f, "blur", qa);
                f.removeEventListener ? (k.un(f, "scroll", D), k.un(f, "focus", wa), k.un(f, "blur", xa), k.un(f, "change", ya), k.un(f, "submit", V)) : f.detachEvent && (k.un(f, "focusin", wa), k.un(f, "focusout", xa), function () {
                    for (var a = f.getElementsByTagName("form"), b = 0; b < a.length; b++) {
                        for (var c = a[b].getElementsByTagName("*"), d = 0; d < c.length; d++)/^INPUT|SELECT|TEXTAREA$/.test(c[d].tagName) && k.un(c[d], "change", ya);
                        k.un(a[b], "submit", V)
                    }
                }());
                (function () {
                    for (var a = f.getElementsByTagName("form"), b =
                        0; b < a.length; b++)a[b][Ba] && (a[b].submit = a[b][Ba])
                })()
            }, uploadPages: function (a, b) {
                function c() {
                    k.un(f, "DOMContentLoaded", c);
                    k.un(h, "load", c);
                    for (var e = a.split(/\n/), g = z().href, q = /regexp:/, r = 0; r < e.length; r++) {
                        var x = e[r];
                        if (x)if (q.test(x)) {
                            x = Ca(x.replace(q, ""));
                            try {
    ...
    var kb = !ja(/webkit/) && ja(/gecko/), l = {
        getDocumentCharset: function () {
            return ("" +
            (f.characterSet || f.charset || "")).toLowerCase()
            ...
            return "CSS1Compat" == f.compatMode ? a : f.body ||
            a
            ...
            return a && a != f.documentElement ? a == f.body ? f.documentElement : a.parentNode : null
        }
    }, g = {
        isArray: function (a) {
    ...
    l.getElementNeighborPosition = function (a) {
        ...
        if (b)for (var c = 0, b = b.childNodes, e, d =
            a && a.nodeName, g = 0; g < b.length; g++)if (e = b[g] && b[g].nodeName, d == e) {
            if (a == b[g])return c;
            c++
        }
        return 0
    ...
    l.getElementSize = function (a) {
        ...
        var b = a.getBoundingClientRect && a.getBoundingClientRect();
    ...
    g.fletcher = function (a) {
        for (var b = a.length, c = 0, e = 255, d = 255; b;) {
            ...
            do {
                var h =
                    "string" == typeof a ? a.charCodeAt(c) : a[c];
                c++;
    ...
    var V = {
        stringify: function (a) {
            ...
            for (c in a)if (a.hasOwnProperty(c)) {
                var e = a[c];
                if (g.isArray(e))for (var d = 0; d < e.length; d++)b.push(encodeURIComponent(c) + "=" + encodeURIComponent(String(e[d])));
    ...
    var y = H.inherit({
            postParams: [], _buildUrl: function (a, b) {
                return a + (-1 < a.indexOf("?") ? "&" : "?") + V.stringify(b)
    ...
    g.toJSON = function (a) {
        ...
        switch (a.constructor) {
            ...
            case Object:
                b = [];
                for (c in a)a.hasOwnProperty(c) && a[c] !== ca && (b[b.length] = g.toJSON(c) + ":" + g.toJSON(a[c]));
                return "{" + b.join(",") + "}";
            default:
                try {
    ...
    var p = {
        getLanguage: function () {
            return (h.navigator && (t.language || t.userLanguage || t.browserLanguage || t.systemLanguage) || "").toLowerCase()
        }
    }, nb = {
        baseUrl: "https://mc.yandex.",
        baseTld: "ru",
        syncTlds: ["ua", "by", "kz"],
        langToDomain: {uk: "ua", be: "by", kk: "kz"},
        sync: function () {
            ...
            c.length && (e = new mb({method: "GET"}), e.request(this.baseUrl + this.baseTld + "/sync_cookie_get", null, function (a, b) {
                var h, k, r;
                if (a) {
                    try {
                        h = JSON.parse(b), k = h.sync_token, r = h.sync_ok
                    } catch (l) {
                        return !1
                    }
                    e.setMethod("POST");
                    for (h = 0; h < c.length; h++)-1 == g.arrayIndexOf(r, c[h]) && function (a) {
                        e.request(f.baseUrl + a + "/sync_cookie_decide", {body: k}, function (b, c) {
                            b && e.request(f.baseUrl + f.baseTld + "/sync_cookie_decide_ok", {body: c}, function (b) {
                                b && (b = d.get("synced") || {}, b[a] = +new Date,
                                    d.set("synced", b))
                            })
                        })
                    }(c[h])
        ...
        _getTld: function () {
            var a = A.hostname.split("."), a = a[a.length - 1];
            return {"\u0443\u043a\u0440": "ua", "xn--j1amh": "ua"}[a] || a
        },
        _getDomainByLang: function () {
            var a;
            if (!h.navigator)return "ru";
            try {
                a = t.languages ? t.languages[0] : p.getLanguage()
            } catch (b) {
            }
        ...
        getPos: function (a) {
            ...
            return [a.pageX || a.clientX + c[0] - (b.clientLeft || 0) || 0, a.pageY || a.clientY + c[1] - (b.clientTop ||
            0) || 0]
            ...
            return a.which || a.button == ca ? a.which : a.button & 1 ? 1 : a.button & 2 ? 3 : a.button & 4 ? 2 : 0
        }, prevent: function (a) {
            a = a || h.event;
    ...
    C.dispatchCustomEvent = u(function (a, b) {
        var c;
        b = b || f;
    ...
    var k = H.inherit({
        _initComponent: function () {
            ...
            d = 5 > arguments.length ?
                !0 : !!d;
            for (var g = b.split(","), f = 0; f < g.length; f++) {
                var k = g[f], l = u(function (a) {
    ...
    var da = null, X = H.inherit({
        counterId: "",
        onlyCurrentDomain: !1, skipPrefix: !1, _initComponent: function () {
    ...
    X.isEnabled =
        function () {
            return (new X({onlyCurrentDomain: !0})).isEnabled()
        };
    var Y = H.inherit({
        transports: [], postParams: [], dontSendRequests: !1, send: function (a, b, c, e) {
            c = c || function () {
                };
            this.dontSendRequests ? c.call(e) : function r(g) {
                if (g < this.transports.length)try {
                    var h = new this.transports[g]({postParams: this.postParams});
                    h.request(a, b, function (a, b) {
                        a ? c.call(e, b) : r.call(this, g + 1)
                    }, this)
                } catch (f) {
                    ia(f, "send by " + (h && h.id)), r.call(this, g + 1)
                }
            }.call(this, 0)
        }
    });
    y.inherit({
        id: "beacon", request: function (a, b, c, e) {
            "function" == typeof t.sendBeacon ? (b = this._splitParams(b), c.call(e, t.sendBeacon(this._buildUrl(a, b.get), V.stringify(b.post)))) : c.call(e, !1)
        }
    });
    ...
    g.setTimeout = function (a, b, c) {
        return g.getNativeFunction("setTimeout")(u(a,
            c || "setTimeout"), b)
    };
    var Z = y.inherit({
    ...
    }), T = Z.inherit({id: "htmlfile", htmlfileOnly: !0}), E = y.inherit({
    ...
    var L = Y.inherit({
        ...
        _initComponent: function () {
            ...
            this.retry && (this._storage = new W)
        },
        ...
        _registerRequest: function (a, b) {
            if (this._isRetryEnabled()) {
                ...
                b.rqnl++;
                for (var c =
                    this._storage.get("retryReqs") || {}, e = 1; c[e];)e++;
                c[e] = {
    ...
    L.retransmit = function () {
        var a = new W, b = a.get("retryReqs") || {};
        a.remove("retryReqs");
        g.forEachKey(b, function (a, b) {
            h.Ya._metrika.firstReqStatus || (h.Ya._metrika.firstReqStatus = "complete");
            b.ghid && b.ghid != Ya._globalMetrikaHitId && b.time && b.time + 864E5 > +new Date && 2 >= b.browserInfo.rqnl && (new L({
                protocol: b.protocol,
                host: b.host,
                resource: b.resource,
    ...
    var S = {
        ...
        tailSafe: "*-_",
        encode: function (a, b) {
            for (var c = (this.abc + (b ? this.tailSafe : this.tail)).split(""), e = a.length, d = [], h = e - e % 3, f, k = 0; k < h; k += 3)f = (a[k] << 16) + (a[k + 1] << 8) + a[k + 2], g.mergeArrays(d, [c[f >> 18 & 63], c[f >> 12 & 63], c[f >> 6 & 63], c[f & 63]]);
            switch (e - h) {
                case 1:
                    f = a[h] << 4;
                ...
                case 2:
                    f = (a[h] << 10) + (a[h + 1] <<
                        2), g.mergeArrays(d, [c[f >> 12 & 63], c[f >> 6 & 63], c[f & 63], c[64]])
            }
            return d.join("")
        }
    }, U = {
        ...
        resource: "webvisor", transports: [M, Z], postParams: ["wv-data"], sendContent: function (a, b, c, e, d, g, f) {
            if (!a)return !1;
            -1 < a.indexOf("\r") && (a = a.replace(/\r\n/g, "\n"));
            a = {"wv-type": 1, "page-url": z().href, "wv-hit": c, "wv-data": S.encode(U.encode(a))};
    ...
    var Ta = H.inherit({
        ...
        append: function (a, b) {
            ...
            this.active && ((b || this._data.length >= this.maxBufferSize) && this._flush(), this._flushTID ||
            (this._flushTID = g.defer(this._flush, this.flushTimeout, this, [], "DataBuffer._flush")))
        },
        activate: function () {
        ...
        _saveToStorage: function () {
            this.storage && this._data.length && this.storage.set(this.storageKey, {
                data: this._data,
                meta: this.meta, pnum: this._packetNumber, time: +new Date
            })
        }
    });
    g.trim = function (a, b) {
    ...
    g.isMetrikaPlayer = function () {
        return "MetrikaPlayer" == h.name || this._playerRegexp.test(h.location.hostname)
    };
    p._jScriptVersion = 0;
    ...
    p.getSilverlightVersion = function () {
        ...
        } else if (a = h.navigator, a = a.plugins && a.plugins["Silverlight Plug-In"])p._silverlightVersion =
            a.description;
    ...
    p.getFlashVersion = function () {
        if (!p._flashVersion) {
            ...
            if ("undefined" != typeof a.plugins && "object" == typeof a.plugins["Shockwave Flash"]) {
                ...
                if ((b = b.description) || c)if (a = a.mimeTypes, "undefined" == typeof a || !a["application/x-shockwave-flash"] || a["application/x-shockwave-flash"].enabledPlugin)c ? p._flashVersion = c : b && (p._flashVersion = b.replace(/([a-zA-Z]|\s)+/, "").replace(/(\s+r|\s+b[0-9]+)/,
                    "."))
    ...
    p.getFingerPrint = function () {
        var a = [];
        if (t.plugins && t.plugins.length)for (var b = 0; b < t.plugins.length; b++) {
            var c = t.plugins[b];
            g.mergeArrays(a, [c.name, c.version, c.description, c.filename])
        }
        if (t.mimeTypes && t.mimeTypes.length)for (b = 0; b < t.mimeTypes.length; b++)c = t.mimeTypes[b], g.mergeArrays(a, [c.type, c.description, c.suffixes]);
        return g.fnv32a(a.join(";")) +
            "01"
    };
    p.isSafari = function () {
        try {
            return t.vendor && -1 < t.vendor.indexOf("Apple") && t.userAgent && !t.userAgent.match("CriOS")
        } catch (a) {
        }
        return !1
    };
    var ob = {
        url: "https://mc.yandex.ru/metrika/", _value: null, _storage: null, getVal: function () {
            var a;
            if (null !== this._value && this._value !== ca)return this._value;
        ...
        sendTitle: !0,
        _initComponent: function () {
            ea.superclass._initComponent.apply(this,
                arguments);
        ...
        sendGoal: function (a, b) {
            if (!/[\/&=?#]/.test(a)) {
                var c = a ? "goal://" + z().hostname + "/" + encodeURIComponent(a) : z().href, e = l.getDocumentTitle(), d = a ? z().href : f.referrer;
                this._hitExt({
                    url: c,
                    title: e,
                    referrer: d,
        ...
        sendClickLink: function (a) {
            this._hitExt({url: a.url, title: a.title, referrer: z().href, modes: a.modes})
        },
        ...
        sendFileUpload: function (a) {
            this._hitExt({
                url: a.url, title: a.title || "", referrer: z().href, userParams: a.userParams, modes: {
                    ar: !0,
                    ln: !0, dl: !0
        ...
        _hitExt: function (a) {
            ...
            if (!g.isMetrikaPlayer()) {
                var d = "undefined" != typeof a.referrer ? a.referrer : da, f = a.url, h = {};
                c.ar && !c.onlyData && (d = null === d || "" === d ? "" : this._prepareHitUrl(d), f = this._prepareHitUrl(a.url));
                b("page-ref", g.trim(d, fa));
                b("page-url",
                    g.trim(f, fa));
                -1 != z().hostname.search(/(?:^|\.)(?:ya|yandex|narod|narod2)\.(?:\w+|com\.\w+)$/) ? b("ut", la) : "undefined" != typeof c.ut && b("ut", g.trim(c.ut, pb));
                if (g.isObject(a.experiments)) {
                    var k = ["esid", "eeid", "egid"];
                    g.forEachKey(a.experiments, function (a, b) {
                        -1 != g.arrayIndexOf(k, a) && b && (e[a] = b)
                    })
                }
                if (a.userParams)if (f = g.toJSON(a.userParams), this.trimParams && f.length > qb)var l = !0; else b("site-info", f);
                c.saveRef && (da = d);
                g.mixin(e, this._getTechInfo(a.title, c, this.counterId, a.ts, a.tz, this._trackHash, this.hitId,
        ...
        _prepareHitUrl: function (a) {
            var b = z(), c = b.host, b = b.href, e;
            if (!g.isString(a))return b;
            if (-1 != a.search(/^\w+:\/\//))return a;
            e = a.charAt(0);
            if ("?" == e)return e =
                b.search(/\?/), -1 == e ? b + a : b.substr(0, e) + a;
        ...
        _getTechInfo: function (a, b, c, e, d, f, k, u, R) {
            function m(a, b) {
                a && b && (z[a] = b)
            }
            ...
            ba && m("s", ba.width + "x" + ba.height + "x" + (ba.colorDepth || ba.pixelDepth));
            h.devicePixelRatio &&
            m("sk", h.devicePixelRatio);
            p.isIframe() && m("ifr", "1");
            m("adb", ob.getVal());
            m("f", p.getFlashVersion());
            m("l", p.getSilverlightVersion());
            m("fpr", p.getFingerPrint());
            m("cn", this.counterNum);
            if (!b.pa) {
                var y = l.getViewportSize();
                m("w", y[0] + "x" + y[1])
            }
            m("z", d);
            m("i", e);
            ...
            m("v", I);
            m("c", t.cookieEnabled ? "1" : "");
            m("jv", p.getJScriptVersion());
            m("la", p.getLanguage());
            m("ntf", p.getNotificationPermission());
            f && m("wh", "1");
            d = "ar ln dl ad nb pa pq pv ex".split(" ");
            for (e = 0; e < d.length; e++)n(d[e]);
            d = ["va", "vt", "sn", "sa", "he"];
            b.nb && d.push("cl");
            for (e = 0; e < d.length; e++)f = d[e], m(f, b[f]);
            c = new W({counterId: c});
            ...
            m("hid", k);
            m("ds", eb(R));
            R._firstPaint || (R._firstPaint = fb(), m("fp", R._firstPaint));
            if (u) {
        ...
        _getTitle: function (a) {
            var b = "";
            b = "undefined" == typeof a ? (b = l.getDocumentTitle()) ? g.trim(b, Ua) : "" : g.trim(a, Ua);
            return b
        }
    });
    ...
    var N = H.inherit({
        sampling: 1, counterId: 26302566, _initComponent: function () {
            N.superclass._initComponent.apply(this,
                arguments);
            this._sender = new ea({protocol: "https:", counterId: this.counterId, retry: !1, counter: {}})
        }, log: function () {
            this.logParams(g.array2Props(arguments))
        }, logParams: function (a) {
            Math.random() < this.sampling && this._sender.sendHit({url: A.href, title: "", referrer: "", userParams: a})
        }
    }), rb = L.inherit({
        resource: "webvisor", retry: !0, postParams: ["wv-data"], sendPacket: function (a, b, c, e, d, f, k, l) {
            if (!a || !a.length)return !1;
            var p = S.encode(a, !0);
            0 == p.indexOf("AAAAAAAAADw") && h.Error && "string" == typeof Error().stack && (new N({sampling: .1})).log("bad visor packet 5",
                1);
            a = {
                rn: g.random(),
                "page-url": b,
        ...
        active: !1,
        _initComponent: function () {
            this.storage = new W({counterId: this.counterId});
            this._sender = new rb({protocol: this.protocol, counterId: this.counterId, counterType: this.counterType});
    ...
    var ga = {};
    ga._cookie = new X({onlyCurrentDomain: !0});
    ga.log = u(function () {
        var a =
            -1 < A.href.indexOf("_ym_debug=1") || h._ym_debug;
        a && this._cookie.create("debug", "1");
        h.console && console.log && (a || "1" === this._cookie.read("debug")) && console.log.apply(console, arguments)
    }, "DebugConsole.log");
    var sb = L.inherit({
        resource: "clmap", retry: !0, transports: [E], sendClick: function (a, b, c, e) {
        ...
        _handler: function (a) {
            a = {el: C.getTarget(a), pos: C.getPos(a), button: C.getMouseButton(a), time: +new Date};
            if (this._isTrackingClick(a)) {
                var b = l.getElementSize(a.el), c = l.getElementXY(a.el),
                    b = ["rn", g.random(), "x", Math.floor(65535 * (a.pos[0] - c[0]) / (b[0] || 1)), "y", Math.floor(65535 * (a.pos[1] - c[1]) / (b[1] || 1)), "t", Math.floor((a.time - this.startTime) / 100), "p", this._getElPath(a.el)], c = z().href;
                this.isTrackHash ? g.mergeArrays(b, ["wh", "1"]) : c = c.split("#")[0];
                this._sender.sendClick(g.trim(c, fa), b.join(":"));
                this._lastClick = a
            }
        },
        _isTrackingClick: function (a) {
            if (h.ymDisabledClickmap || g.isMetrikaPlayer() || !a.el)return !1;
            var b = a.el.tagName;
            if ((2 == a.button || 3 == a.button) && "A" != b || this.filter && !this.filter(a.el,
                    b))return !1;
            for (var c = 0; c < this._ignoreTags.length; c++)if (this._ignoreTags[c] == b)return !1;
            for (b = a.el; b;) {
    ...
    var Wa = H.inherit({
        counter: null, prefsEcommerce: null, dataLayerName: "dataLayer", _initComponent: function () {
            var a = "customArr";
            ...
            var b = [], c, e;
            for (c = 0; c < a.length; c++)(e = a[c]) && e.ecommerce && (b[b.length] = e.ecommerce);
    ...
    U.decode = function (a) {
        for (var b = "", c = 0, e = 0, d = 0, g = 0; c < a.length;)e = a.charCodeAt(c), 128 > e ? (b += String.fromCharCode(e), c++) : 191 < e && 224 > e ? (d = a.charCodeAt(c + 1), b += String.fromCharCode((e & 31) << 6 | d & 63), c += 2) : (d = a.charCodeAt(c + 1), g = a.charCodeAt(c + 2), b += String.fromCharCode((e &
            15) << 12 | (d & 63) << 6 | g & 63), c += 3);
        return b
    };
    S.decode = function (a, b) {
        for (; a.length % 4;)a += "=";
    ...
    var Xa = ea.inherit({
        transports: [y],
        trimParams: !0, _initComponent: function () {
            Xa.superclass._initComponent.apply(this, arguments);
            this._ilStorage = new W({counterId: this.counterId})
        }, sendHit: function (a) {
            var b = {}, c = this._ilStorage.get("il");
            a.visitColor && (b.vc = a.visitColor);
            a.hasPrerender && (b.pr = 1);
            c && (this._ilStorage.remove("il"), b.ilt = S.encode(U.encode(g.trim(c, Za))));
            this._hitExt({
                url: a.url,
                title: a.title,
                referrer: a.referrer,
    ...
    var A = z(), za = aa.getTimezone(), Aa = aa.getTimestamp(), t = h.navigator, ba = h.screen, I = "ver696".slice(3), pb = 64, fa = p.isIE() ? 512 : 2048, qb = p.isIE() ? 512 : 2048, Ua = p.isIE() ? 100 : 400, Za = 100, la = "noindex", $a = /\.(3gp|7z|aac|ac3|acs|ai|avi|ape|apk|asf|bmp|bz2|cab|cdr|crc32|css|csv|cue|divx|dmg|djvu?|doc(x|m|b)?|emf|eps|exe|flac?|flv|iso|swf|gif|t?gz|jpe?g?|js|m3u8?|m4a|mp(3|4|e?g?)|m4v|md5|mkv|mov|msi|ods|og(g|m|v)|pdf|phps|png|ppt(x|m|b)?|psd|rar|rss|rtf|sea|sfv|sit|sha1|svg|tar|tif?f|torrent|ts|txt|vob|wave?|wma|wmv|wmf|webm|xls(x|m|b)?|xpi|g?zip)$/i,
        ub = +new Date, ma, ha, na = !!Ya._metrika.oo;
    Ya._metrika.v = I;
    h.Ya.Metrika = function (a, b, c, e) {
        ...
        return u(function () {
            function r(x) {
                var q = !1;
                if (Ya._metrika.hitParam[I]) {
                    if (1 != c || Ya._metrika.counters[I])return !1;
                    q = !0
                }
                Ya._metrika.counters[I] = d;
                Ya._metrika.hitParam[I] = 1;
                d._webvisor = !e && (v && v.webvisor || !1);
                d._directCampaign = v && v.directCampaign;
                v && v.trackHash && Q(!0);
                if (!e && !q) {
                    d.replacePhones();
                    var G = new X({counterId: a}), n = G.read("visorc");
                    "b" != n && "w" != n && (n = "");
                    if (!G.isEnabled() || ja("opera mini"))n = "b";
                    ma = +new Date;
                    var q = new Xa({
                        protocol: "https:",
                        counterType: c,
                        ...
                        dontSendRequests: na,
                        counterNum: ba
                    }), p = {ut: S, he: v ? ~~v.httpError : 0, ad: 1 == c && h.Ya && h.Ya.Direct, pv: !0, saveRef: !0};
                    q.sendHit({
                        url: A.href,
                        ...
                        tz: za,
                        callback: function (c) {
                            ga.log("PageView. Counter " + a + ". URL: " + A.href + ". Referrer: " + f.referrer, ". Params: ", b);
                            ha || (ha = +new Date);
                            c = c || {};
                            var e = c.webvisor || {};
                            if (P) {
                                ...
                                n || (n = U % 1E4 / 1E4 < q ? "w" : "b");
                                G.create("visorc", n, 30);
                                "w" == n ? (P.start(), q = e.arch_type, (e = e.urls) && q && "none" != q && P.uploadPages(e, q)) : P.stop()
                            }
                            c = c.mp2;
                            G.erase("mp2_substs");
                            if (c) {
                                b:if ((e = c.conditions) && e.length)for (q = 0; q < e.length; q++) {
                                    var x;
                                    x = e[q];
                                    if ("ref" == x.type)x = gb(x); else if ("adv" == x.type) {
                                        var l = x, m = Ya._metrika.counter._directCampaign, p = l.ServiceNamePattern, r = l.RefererPattern;
                                        x = m ? l.direct_orders : l.direct_camp;
                                        for (var t =
                                            f.referrer, u = V.parse(A.search), y = hb(A.search, A.hash), z = {}, D = ["source", "medium", "campaign", "term", "content"], v = 0; v < D.length; v++)u["utm_" + D[v]] && (z[D[v]] = u["utm_" + D[v]]);
                                        v = m ? "direct.yandex.ru" : y && y.service || z.source;
                                        D = !1;
                                        if (!D && p && p.length)for (var w = 0; w < p.length; w++)if ((new RegExp(p[w], "i")).test(v)) {
                                            D = !0;
                                            break
                                        }
                                        if (!D && !l.yandex_direct && r && r.length)for (p = 0; p < r.length; p++)if ((new RegExp(r[p], "i")).test(t)) {
                                            D = !0;
                                            break
                                        }
                                        !D && l.google_adwords && u.gclid && (D = !0);
                                        if (D && x && x.length && (D = !1, l = m || y && y.campaign || z &&
                                                z.campaign))for (m = 0; m < x.length; m++)if (x[m] == l) {
                                            D = !0;
                                            break
                                        }
                                        x = D
                                    ...
                                    if (x) {
                                        e[q].track_id && G.create("mp2_track", e[q].track_id, 43200);
                                        break b
                                    }
                                }
                                e = G.read("mp2_track");
                                c = c.substs && c.substs[e];
                                e && c ? (G.create("mp2_substs", g.toJSON(c)), c = La(c), d.params("__ym", c ? "mp_trackid" : "mp_trackid_bad", e)) : Ma()
                            } else Ma();
                            k.on(h, "load", d.replacePhones, d);
                            d._inited = !0;
                            h.Ya._metrika.startSync || (h.Ya._metrika.startSync = !0, nb.sync())
                        }
                    })
                }
                y();
                v && (v.enableAll ? (t(!0), m(!0), E()) : (v.clickmap && m(v.clickmap), v.trackLinks && t(v.trackLinks),
                v.accurateTrackBounce && E(v.accurateTrackBounce)), (v.ecommerce || v.useDataLayer) && new Wa({
                    counter: d,
                    prefsEcommerce: v.ecommerce
                }), v.triggerEvent && ab(function () {
                    C.dispatchCustomEvent("yacounter" + a + "inited")
                }, 0, "triggerEvent"));
                d._webvisor && !na && (P = new ib("https:", a, c, U, d))
            }
            ...
            function y() {
                ...
                k.on(f, "click", function (a) {
                    d._trackLinks && d._trackLinks.on &&
                    H(a)
                })
            }
            ...
            function H(a) {
                ...
                if (b) {
                    a = !1;
                    var c = "" + b.href, d = c ? c.split(/\?/)[0] : "", e = function (a) {
                        var d = Ca(b.innerHTML.replace(/<\/?[^>]+>/gi, ""));
                        O.sendClickLink({url: c, title: c == d ? "" : d, modes: a})
                    };
                    if ($a.test(d) || $a.test(c) || Ja(c, ka) || Ja(d, ka))a = !0;
                    var f = l.classNameExists(b, "ym-disable-tracklink"), d = l.classNameExists(b, "ym-external-link");
                    f || (f = {
                        ln: !0,
                        dl: a
                    }, d ? e(f) : (d = b.hostname || g.parseUrl(b.href).hostname || "", cb(z().hostname, d) ? a ? (f.ln = !1, e(f)) : (a = Ca(b.innerHTML.replace(/<\/?[^>]+>/gi, ""))) && a != c &&
                    fa.set("il", g.trim(a, Za)) : c && -1 != c.search(/^ *(data|javascript):/i) || (f.ut = la, e(f))))
                }
            }
            ...
            function n(a, b) {
                ...
                function m(a) {
                    for (var b = 0; b < w.length; b += 3)if (a)k.on(w[b], w[b + 1], w[b + 2]); else k.un(w[b], w[b + 1], w[b + 2])
                }

                var n = !1, r = !1, u = !0, t = 0, v = +new Date, y = null, z = !1;
                if (p.isIE())g.setTimeout(a, b, "trackUserTime"); else {
                    var w = [h, "blur", d, h, "focus", e, f, "click", l, f, "mousemove", l, f, "keydown", l, f, "scroll", l];
                    m(!0);
                    c()
                }
            }
            ...
            function E(b) {
                ...
                if (!d._isAccurateTrackBounce) {
                    ...
                    var c = new W({counterId: a}), e = c.get("lastHit");
                    c.set("lastHit", +new Date);
                    ((c = c.get("lastHit")) && (!e || e < c - 18E5) || !db(f.referrer, z().href) || .1 > Math.random()) && n(function () {
                        d.notBounce()
                    }, b)
                }
            }
            ...
            function M(a) {
                ...
                (function D() {
                    var d = b();
                    d !== c && (a(), c = d);
                    ia = g.setTimeout(D, 200, "trackHash")
                })()
            }

            function Q(a) {
                if (!1 ===
                    a)w && ("onhashchange" in h ? k.un(h, "hashchange", T) : g.clearTimeout(ia), w = !1); else if (a = T, !w) {
                    if ("onhashchange" in h)k.on(h, "hashchange", a); else M(a);
                    w = !0
                }
                O.setTrackHash(w);
                d._trackHash = w
            ...
            function T() {
                aa = da = Z;
                var a = {ut: S, ad: 1 == c && h.Ya && h.Ya.Direct, wh: !0, saveRef: !0, pv: !0};
                O.sendAjaxHit({url: z().href, title: l.getDocumentTitle(), referrer: aa, modes: a});
                Z = z().href
            }

            function N(a, b, c) {
                a = F.parseValidate(a, b);
                b = [];
            ...
            var I, S = "", Y, Z = da = A.href, aa = "", v;
            Ya._metrika.counter || (Ya._metrika.counter = d);
            "object" == typeof a && (v = a, e = a.defer, S = a.ut, c = a.type, b = a.params, Y = v.experiments, a = a.id);
            a = a || 0;
            /^\d+$/.test(a) || (a = 0);
            c = c || 0;
            I = a + ":" + c;
            if (Ya._metrika.counters[I])return Ya._metrika.counters[I];
            var U = Ya._metrika.hitId;
            Ya._metrika.counterNum++;
            var ba = Ya._metrika.counterNum;
            L.initCookie();
            L.retransmit();
            var O = new ea({
                    protocol: "https:",
                ...
                P;
            d.replacePhones = u(function () {
                try {
                    var b = (new X({counterId: a})).read("mp2_substs");
                    if (b) {
            ...
            d.reachGoal = u(function (b, c, e, g) {
                2 <= arguments.length && "function" === typeof c && (g = e, e = c, c = ca);
                ga.log("Reach goal. Counter: " + a + ". Goal id: " + b + ". Params: ", c);
                O.sendGoal(b, {userParams: c, callback: e, ctx: g});
                return d
            }, "counter.reachGoal");
            d.trackLinks = u(function (a) {
                t(a);
                return d
            }, "counter.trackLinks");
            var fa = new W({counterId: a});
            d.hit = u(function (b, c, e, f, h, k) {
                b && (g.isObject(c) && (e = c.referer, f = c.params, h = c.callback, k = c.ctx, c = c.title), ga.log("PageView. Counter " + a + ". URL: " + b + ". Referrer: " + e + ". Params: ", f), O.sendHit({
                    url: b,
                    title: c,
                    referrer: e,
                    userParams: f,
            ...
            d.params = u(function (b) {
                var c = arguments.length, e = c, f, h, k = [].slice.call(arguments, 0);
                b && (1 < arguments.length && (g.isFunction(arguments[c - 1]) ? (f = arguments[c - 1], e = c - 1) : g.isFunction(arguments[c - 2]) && (f = arguments[c - 2], h = arguments[c - 1],
                    e = c - 2), k = [].slice.call(k, 0, e), 1 < k.length && (k = [g.array2Props(k)])), ga.log("User params. Counter " + a + ". Params: ", k[0]), O.sendParams(k[0], f, h));
                return d
            }, "counter.params");
            d.file = u(function (a, b) {
            ...
            d.notBounce = u(function (a) {
                var b =
                    0;
                a = a || {};
                ma && ha && (b = ha - ma);
                O.sendNotBounce(b, {callback: a.callback, ctx: a.ctx});
                return d
            }, "counter.notBounce");
            var ka = [];
            ...
            var F = {
                requiredEcommerceFields: ["currency", "goods"], parseValidate: function (a,
                                                                                         b) {
                    ...
                    if (g.isObject(b))switch (a) {
                        ...
                        case "add":
                        case "remove":
                            g.isArray(b.goods) && b.goods.length ? (c = g.arrayEvery(b.goods,
                                function (a) {
            ...
            d.ecommerceDetail = u(function (a, b) {
                    N("detail", a, b);
                    return d
                },
                "ecommerce.detail");
            d.ecommerceAdd = u(function (a, b) {
                N("add", a, b);
                return d
            }, "ecommerce.add");
            d.ecommerceRemove = u(function (a, b) {
                N("remove", a, b);
                return d
            }, "ecommerce.remove");
            d.ecommercePurchase = u(function (a, b) {
                N("purchase", a, b);
                return d
            }, "ecommerce.purchase");
            d.userParams = u(function (a, b, c) {
                g.isObject(a) && d.params({__ymu: a}, b || function () {
                    }, c);
                return d
            }, "uparams");
            d.experiments = u(function (a, b, c) {
                O.sendExperiments({callback: b, ctx: c, experiments: a});
                return d
            }, "exps");
            d.id = d.setUserID = u(function (a, b, c) {
                (g.isString(a) ||
                g.isNumber(a)) && d.params({__ym: {user_id: a}}, b || function () {
                    }, c);
                return d
            }, "id");
            var sa = new X;
            d.getClientID = u(function () {
                return sa.read("uid")
            }, "guid");
            ...
            d._performanceTiming = Ka;
            if (a)if ("prerender" == f.webkitVisibilityState) {
                O.sendPrerenderHit({url: A.href, title: l.getDocumentTitle(), referrer: f.referrer});
                var ra = function () {
                    "prerender" != f.webkitVisibilityState && (k.un(f, "webkitvisibilitychange", ra), r(!0))
                };
                k.on(f, "webkitvisibilitychange",
                    ra)
            } else r(!1)
        }, "init")()
    };
    if (h.performance && "function" == typeof performance.getEntries) {
        ...
        Y = performance.getEntries();
        T = {};
        for (y = 0; y < Y.length; y++) {
            var E = Y[y], P = E.name.replace(/^https?:\/\//, "").split("?")[0], vb = g.fnv32a(P);
            M[vb] && !T[P] && 0 < E.duration && (T[P] = {
        ...
        (new N({sampling: .001})).logParams({timings8: T})
    }
    h.Ya._metrika.remoteCtrlInited || (h.Ya._metrika.remoteCtrlInited = !0, new Va);
    h.Ya.Metrika.counters = function () {
        var a = [];
    ...
    y = h.yandex_metrika_callback;
    M = h.yandex_metrika_callbacks;
    "function" == typeof y && y();
    if ("object" == typeof M)for (y = 0; y < M.length; y++)if (Y = M[y])M[y] = null, Y();
    ...
    h.Ya.Metrika.informer = function (a) {
        ...
        if (!b) {
            ...
            a.type =
                "text/javascript";
            a.async = !0;
            a.src = "https://informer.yandex.ru/metrika/informer.js";
            try {
    ...
    k.on(f, "click", u(function (a) {
        var b = C.getTarget(a), c, e;
        b && "ym-advanced-informer" == b.className && (c = b.getAttribute("data-lang"), e = b.getAttribute("data-cid"), Ya.Metrika.informer({
            i: b,
            id: +e,
            lang: c
        }), C.prevent(a))
    ...
    (function () {
        ...
        g.random(200) || Ya._metrika.isAd || (Ya._metrika.isAd = !0, "http:" == A.protocol && "object" == typeof c && h.addEventListener && (c.timing && c.timing.loadEventStart ? a() : h.addEventListener("load", b, !1)))
    })()
})(this, this.document);
