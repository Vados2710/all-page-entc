...
$(function() {
	...
	var timerIdPackCountNumber = 69;
	var timerIdPackCount = setTimeout(function tick() {
		if (timerIdPackCountNumber > 3) {
			timerIdPackCount = setTimeout(tick, 28000);
		}
		if (timerIdPackCountNumber % 4 === 0) {
			timerIdPackCountNumber -= 2;
		} else {
			timerIdPackCountNumber--;
		}
		$('.last-pack1').html(timerIdPackCountNumber);
	}, 0);
});
