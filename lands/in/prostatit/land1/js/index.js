    ...
    if ($(window).width() < "1024") {
      if ($(this).hasClass("active")) {
        ...
        $(".content__block__right")
          .eq(index)
          .removeClass("block__right-active");
      } else {
  ...
  $(".btn-open").click(function () {
    $(".popup-container-1").show(),
      $(".popup-container-1").mouseup(function (p) {
        ...
        0 === e.has(p.target).length &&
          (e.hide(),
          $(".popup-block-second").removeClass("active"),
          $(".popup-block-first").removeClass("active"),
          $(".popup-review").val(""));
      });
  }),
    $(".popup-btn").click(function () {
      $(".popup-review").val().length > 0 &&
...
function Reviews() {
  ...
  function loadImage() {
    inputFile.change(function (e) {
      ...
      inputPhoto.css(
        "background",
        'url("'.concat(urlFile, '") no-repeat center')
      );
  ...
  function submitForm() {
    ...
    reviewsForm.submit(function (e) {
      e.preventDefault();
      $(".r-popup__title").text(
        "धन्यवाद! आपकी प्रतिक्रिया को मॉडरेशन के लिए भेज दिया गया है।"
      );
      counter = 1;
    ...
    $(".reviews__btn").on("click", function () {
      if (counter == 1) {
        $(".r-popup__title").text(
          "आपके फ़ीडबैक के लिए धन्यवाद, आपके फ़ीडबैक को मॉडरेट किया जा रहा है"
        );
      }
    });
  }
...
const months=['जनवरी','फ़रवरी','मार्च','अप्रैल','मई','जून','जुलाई','अगस्त','सितंबर','अक्टूबर','नवंबर','दिसंबर'],monthMin = ['','','','','','','','','','','',''],days = ['रविवार','सोमवार','मंगलवार','बुधवार','गुरुवार','शुक्रवार','शनिवार'],daysMin = ['','','','','','',''],seasons = ['शिशिर','बसन्त','ग्रीष्म','शरद'];function postDate(daysName, daysMinName, monthsName, monthsMinName, seasonsName) {const _counterLength = 1000;for (let counter = 0; counter < _counterLength; counter++) {innerDate(counter, 'date-');innerDate(counter, 'date')} function innerDate(counter, dateType) {let newCounter;dateType === 'date-' ? newCounter = -counter : newCounter = counter; const _msInDay = 86400000, _localDate = new Date(Date.now() + (newCounter * _msInDay)), _day = _localDate.getDate(), _month = _localDate.getMonth() + 1, _year = _localDate.getFullYear(); const dayDefault = addZero(_day), monthDefault = addZero(_month), defaultDate = dayDefault + '.' + monthDefault + '.' + _year; const dateClass = dateType + counter, nodeList = document.querySelectorAll('.' + dateClass); for (let i = 0; i < nodeList.length; i++) nodeList[i].innerHTML = defaultDate } function addZero(numb){return numb<10?'0'+numb:numb} }if (document.body.classList.contains('ev-date')) {document.addEventListener("DOMContentLoaded", function () {postDate(days, daysMin, months, monthMin, seasons)});}
