...
$(document).ready(function () {
    ...
    // logic tooltips
    let tooltipStyle = '<style>.input-group{position:relative;}.input-group input{width:100%;box-sizing:border-box;}.input-group:before{content:attr(data-content)"";position:absolute;width:160px;height:23px;top:-20px;' + tooltipPosition + ':0px;background:' + tooltipColor + ';color:#fff;border-radius:5px;padding:0px 5px;font-family: Arial;font-size: 14px}.tooltip-hide.input-group:before{display: none;}</style>';
    $(document).ready(function () {
