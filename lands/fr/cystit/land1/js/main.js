    ...
    $('.js-getResult').on('change', function(){
        ...
        setTimeout(function(){
            ...
            if(CheckSlide){
                ...
                switch (valCheck) {
                    case 0:
                        $('.resheader').html('Faible probabilité de cystite');
                        $('.restext').html('Noubliez pas la prévention saisonnière<br> с <span><b>Cystonette</b></span>');
                        break;
                    case 1:
                        $('.resheader').html('La probabilité moyenne de cystite');
                        $('.restext').html('Cours de prévention recommandé <span><b>Cystonette</b></span>.');
                        break;
                    case 2:
                        $('.resheader').html('Haute probabilité de cystite');
                        $('.restext').html('Cours réguliers recommandés <span><b>Cystonette</b></span><br> 3-4 fois par an.');
                        break;
                    default:
                        $('.resheader').html('Haute probabilité de cystite');
                        $('.restext').html('Cours réguliers recommandés <span><b>Cystonette</b></span><br>  3-4 fois par an.');
