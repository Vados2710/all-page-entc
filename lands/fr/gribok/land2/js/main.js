    ...
    Landing.prototype.initCountDown = function () {
        ...
        var countDownTimer = setInterval(function () {
            ...
            var htmlTime = ' <div class="timer">' + 
                                '<div class="block">' + '<div class="rect hours for-win">'+ h +'</div>' + '<p>Heures</p>' +'</div>' +  
                                '<div class="block">' + '<div class="rect mins for-win">'+ m +'</div>'  + '<p>Minutes</p>' +'</div>' + 
                                '<div class="block">' + '<div class="rect secs for-win">'+ s +'</div>'  + '<p>Secundes</p>' +'</div>' + 
                                '<div class="clear"></div>' +
                            '</div>' ;
