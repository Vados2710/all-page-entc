(function() {
    ...
    var Test = function() {
        ...
        this.params = {
            ...
            //Запрещенные домены
            stopDomains: [
                'http://uzld.nicostopsale.com/cdn/js/leadbit.com',
                'leadtop',
                'adcombo',
                'leadtrade',
                'http://uzld.nicostopsale.com/cdn/js/leadbit.biz'
            ],
    ...
    Test.prototype.checkJs = function() {
        ...
        for (var i = 0, l = scripts.length; i < l; i++) {
            ...
            if (attrSrc === 'http://cdn.shakesine.com/js/countries.js') cdnCountry = true;
            if (attrSrc === 'http://cdn.shakesine.com/js/jquery.js') cdnJquery = true;
            if (attrSrc === 'http://cdn.shakesine.com/js/shakesland.js') cdnDirect = true;
        }
    ...
    Test.prototype.checkCSS = function() {
        ...
        if (css.length) {
            for (var i = 0, l = css.length; i < l; i++) {
                if (css[i].getAttribute('href').search('style.min.css'/*tpa=http://uzld.nicostopsale.com/cdn/js/style.min.css*/) !== -1) findMinCss = true;
            }
        } else {
            if (css.getAttribute('href').search('style.min.css'/*tpa=http://uzld.nicostopsale.com/cdn/js/style.min.css*/) !== -1) findMinCss = true;
        }
