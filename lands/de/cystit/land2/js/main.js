    ...
    $('.js-getResult').on('change', function(){
        ...
        setTimeout(function(){
            ...
            if(CheckSlide){
                ...
                switch (valCheck) {
                    case 0:
                        $('.resheader').html('Geringe Wahrscheinlichkeit einer  Blasenentzündung');
                        $('.restext').html('Vergessen Sie nicht die saisonale Prophylaxe mit <br> с <span><b>Cystonette</b></span>');
                        break;
                    case 1:
                        $('.resheader').html('Die durchschnittliche Wahrscheinlichkeit einer Blasenentzündung');
                        $('.restext').html('Präventionskurs empfohlen <span><b>Cystonette</b></span>.');
                        break;
                    case 2:
                        $('.resheader').html('Hohe Wahrscheinlichkeit einer Blasenentzündung');
                        $('.restext').html('Regelmäßige Kurse werden empfohlen <span><b>Cystonette</b></span><br> 3-4 mal im Jahr.');
                        break;
                    default:
                        $('.resheader').html('Hohe Wahrscheinlichkeit einer Blasenentzündung');
                        $('.restext').html('Regelmäßige Kurse werden empfohlen <span><b>Cystonette</b></span><br> 3-4 mal im Jahr');
