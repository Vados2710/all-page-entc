...
var customCSS = {
	callBackDiam: 150,
	callBackFontSize: 14,
	callBackColor: 'rgba(16,178, 241, 1)',
	callBackShadowColor: 'rgba(16,178, 241, 0.47)',
	callBackWaveColor: 'rgba(16,178, 241, 1)'
	// topPluginHeight: 34
};
	...
	(function () {
		...
		var addPopupForm = function addPopupForm() {
			...
			if(params.isCheckBox){
				if(params.lang=="hi"){
					popupForm.innerHTML = '<span class="close-m1"></span><div><h2 class="popup-m1-title">' + popupText[params.lang].title + '</h2><div class="popup-m1-cont"><p class="popup-m1-text1">' + popupText[params.lang].desc + '</p><form method="POST" action="/submit" class="popup-m1-form al-form"><select class="al-country" style="display: none;"></select><div class="input-wrapper"><input type="text" id="popup-name" name="name" placeholder="' + popupText[params.lang].name + '" required=""><label for="popup-name"></label></div><div class="input-wrapper"><input type="text" name="phone" id="popup-phone" placeholder="' + popupText[params.lang].phone + '" required=""><label for="popup-phone"></label></div> <div class="input-wrapper"><input type="checkbox" checked name="policy" class="form__checkbox" id="policy-callback"><label for="policy-callback" class="form__check"><a class="link" href="privacy.html">'+popupText[params.lang].policy[0]+'</a> '+popupText[params.lang].policy[1]+'  </label></div><button type="submit" class="form__submit js-submit">' + popupText[params.lang].order + '</button></form><p class="popup-m1-text2">' + popupText[params.lang].desc2 + '</p></div>\n</div>';
				} else{
					popupForm.innerHTML = '<span class="close-m1"></span>\n<div><h2 class="popup-m1-title">' + popupText[params.lang].title + '</h2><div class="popup-m1-cont"><p class="popup-m1-text1">' + popupText[params.lang].desc + '</p><form method="POST" action="/submit" class="popup-m1-form al-form"><select class="al-country" style="display: none;"></select><div class="input-wrapper"><input type="text" id="popup-name" name="name" placeholder="' + popupText[params.lang].name + '" required=""><label for="popup-name"></label></div><div class="input-wrapper"><input type="text" name="phone" id="popup-phone" placeholder="' + popupText[params.lang].phone + '" required=""><label for="popup-phone"></label></div> <div class="input-wrapper"><input type="checkbox" checked name="policy" class="form__checkbox" id="policy-callback"><label for="policy-callback" class="form__check">'+popupText[params.lang].policy[0]+' <a class="link" href="privacy.html">'+popupText[params.lang].policy[1]+'</a> </label></div><button type="submit" class="form__submit js-submit">' + popupText[params.lang].order + '</button></form><p class="popup-m1-text2">' + popupText[params.lang].desc2 + '</p></div>\n</div>';
				}
			}else{
				popupForm.innerHTML = '<span class="close-m1"></span>\n<div><h2 class="popup-m1-title">' + popupText[params.lang].title + '</h2><div class="popup-m1-cont"><p class="popup-m1-text1">' + popupText[params.lang].desc + '</p><form method="POST" action="/submit" class="popup-m1-form al-form"><select class="al-country" style="display: none;"></select><div class="input-wrapper"><input type="text" id="popup-name" name="name" placeholder="' + popupText[params.lang].name + '" required=""><label for="popup-name"></label></div><div class="input-wrapper"><input type="text" name="phone" id="popup-phone" placeholder="' + popupText[params.lang].phone + '" required=""><label for="popup-phone"></label></div><button type="submit" class="form__submit js-submit">' + popupText[params.lang].order + '</button></form><p class="popup-m1-text2">' + popupText[params.lang].desc2 + '</p></div>\n</div>';
			}
