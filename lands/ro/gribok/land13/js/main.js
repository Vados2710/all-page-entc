    ...
    Landing.prototype.initCountDown = function () {
        ...
        var countDownTimer = setInterval(function () {
            ...
            var htmlTime = ' <div class="timer">' + 
                                '<div class="block">' + '<div class="rect hours for-win">'+ h +'</div>' + '<p>Ore</p>' +'</div>' +  
                                '<div class="block">' + '<div class="rect mins for-win">'+ m +'</div>'  + '<p>Minute</p>' +'</div>' + 
                                '<div class="block">' + '<div class="rect secs for-win">'+ s +'</div>'  + '<p>Secunde</p>' +'</div>' + 
                                '<div class="clear"></div>' +
                            '</div>' ;
