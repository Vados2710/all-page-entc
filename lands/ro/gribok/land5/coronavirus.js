function CoronavirusWarning(language) {
    ...
    this.langs = {
        'BG': {
            desk: '<div><p>Не се тревожете! Ние се отнасяме сериозно към безопасността на клиентите си! Нашите куриери сменят маски и ръкавици на всеки 2 часа. Предаването на колета и поемане на парите се извършва безконтактно.</p></div>',
            mob: '<div><p>Не се тревожете!</p><p> Ние се отнасяме сериозно към безопасността на клиентите си! Нашите куриери сменят маски и ръкавици на всеки 2 часа. Предаването на колета и поемане на парите се извършва безконтактно.</p></div>'
        },
        'DE': {
