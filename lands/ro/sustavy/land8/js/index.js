...
(function () {
    ...
    function postDate() {
      ...
      months,
          countryName = postLang ? postLang : window.country_code ? window.country_code.toLowerCase() : 'ro',
          // Мова для місяців. 
    ...
    var check = (function () {
      var item = $('.check__list-el');
      var btn = $('.check__btn');
      var close = $('.check-close');
      item.on('click', function () {
        var $this = $(this);
        btn.addClass('visible-btn');

        if ($this.hasClass('check__list-el--active')) {
          $this.removeClass('check__list-el--active');
        } else {
          $this.addClass('check__list-el--active');
        }

        for (var i = 0; i < item.length; i++) {
          if (!$('.check__list-el').hasClass('check__list-el--active')) {
      ...
      btn.on('click', function () {
        if (!btn.hasClass('visible-btn')) {
          alert('Alege-ți simptomele.');
          counter = 0;
        }
        ...
        for (var i = 0; i < item.length; i++) {
          ...
          if (document.querySelectorAll('.check__list-el')[i].classList.contains('check__list-el--active')) {
            countItem++;
          }
        }
        ...
        if (counter > 0) {
          if (countItem == 1) {
            var innerPopup1 = $('.check__list-el.check__list-el--active .check__list-el--text').html();
            $('.check__popup-ask--1').html(innerPopup1);
            $('.check__popup--1').addClass('show-popup');
          } else if (countItem == 2) {
            var innerPopup2 = $('.check__list-el.check__list-el--active')[0].innerText;
            $('.check__popup-ask--2').html(innerPopup2);
            var innerPopup3 = $('.check__list-el.check__list-el--active')[1].innerText;
            $('.check__popup-ask--3').html(innerPopup3);
            $('.check__popup--2').addClass('show-popup');
          } else {
            if (countItem == 3) {
              $('.check__popup-title-3').html('3 sintomi');
            } else if (countItem == 4) {
              $('.check__popup-title-3').html('4 sintomi');
            } else if (countItem == 5) {
              $('.check__popup-title-3').html('5 sintomi');
            } else if (countItem == 6) {
              $('.check__popup-title-3').html('6 sintomi');
            }

            $('.check__popup--3').addClass('show-popup');
          }

          item.removeClass('check__list-el--active');
          btn.removeClass('visible-btn');
          countItem = 0;
        }
      });
      close.on('click', function () {
        $('.check__popup--1').removeClass('show-popup');
        $('.check__popup--2').removeClass('show-popup');
        $('.check__popup--3').removeClass('show-popup');
      });
    });
    ...
    //     for (let i = 0; i < $('.other-el').length; i++) {
    //       let n = 2000*(i+1);
    //       if (getCoords($('.other-el')[0]).top < 200) {
    //         setTimeout(function () {
    //           $('.other-el')[i].classList.add("active");
    //         }, n);  
    //   }
    //     }
    //   });
    ...
    var other = (function () {
      ...
      function greenActive () {
        $('.other-el').addClass('active');
        $('.other-btn').removeClass('other-active-btn');
        $('.other-2').addClass('other-active-btn');
        $('.other__main-prod-1').removeClass('other-img-active');
        $('.other__main-prod-2').addClass('other-img-active');
        $('.other-text-1').removeClass('other-text-active');
        $('.other-btn-639').addClass('order-active');
      }
 
      function redActive () {
        $('.other-el').removeClass('active');
        $('.other-btn').removeClass('other-active-btn');
        $('.other-1').addClass('other-active-btn');
        $('.other__main-prod-2').removeClass('other-img-active');
        $('.other__main-prod-1').addClass('other-img-active');
        $('.other-text-1').addClass('other-text-active');
        $('.other-btn-639').removeClass('order-active');
      }
      ...
      $('.other-1').on('click', function () {
        redActive();
      });
 
      $('.other-2').on('click', function () {
        greenActive();
      });
    ...
    var question = (function () {
      $(function () {
        var questionItem = $('.question__item');
        questionItem.on('click', function () {
          $(this).children('.question__text').toggleClass('show');
    ...
    var reviews = (function () {
      ...
      }); //  Write comment | Window show/hide
      ...
      var modal = $('.reviews .modal');
      $('.reviews__feedback').on('submit', function (e) {
        e.preventDefault();
      ...
      var names = document.querySelectorAll('.comments__name');

      for (var n = 0; n < names.length; n++) {
        names[n].parentElement.previousElementSibling.innerHTML = names[n].innerHTML.charAt(0);
      }
    });
