...
<head>
    ...
    <title>Thanks</title>
    <link rel="stylesheet" href="thankyou-page/css/thanks.css">
</head>
...
<body>
            ...
            <div class="order-steps">
                <div class="order-steps__item">
                    <div class="order-steps__img">
                        <img src="thankyou-page/img/tp-step-1.png" alt="">
                    </div>
                ...
                <div class="order-steps__item">
                    <div class="order-steps__img">
                        <img src="thankyou-page/img/tp-step-2.png" alt="">
                    </div>
                    <div class="order-steps__title">
                        <p id="step2">
                            <?= @$translation['a6']; ?>
                ...
                <div class="order-steps__item">
                    <div class="order-steps__img">
                        <img src="thankyou-page/img/tp-step-3.png" alt="">
                    </div>
                    <div class="order-steps__title">
                        <p id="step3">
                            <?= @$translation['a7']; ?>
    ...
    <script>
     ...
     <!-- <img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=YOUR_PIXEL_ID&ev=Lead&noscript=1" /> -->
</body>
