(function($) {
    ...
    var Lang = {
        ...
        en: {
            ...
            //Месяца в родительcком падеже
            monthsRp: [ 'January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'],
            //Месяца в предложном падеже
            monthsPp: [ 'January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'],
            maxPurchase: 'Best selling day - (_COUNT_) items was a _MONTH_ the _DATE_  of 2016.',
            stockInfoTitle: 'More than 100 000 pirchases in ',
            stockInfoTime: 'Special offer lasts from _STARTMONTH_, _STARTDATE_  till  _ENDMONTH_, _ENDDATE_ '
        }
    };
    ...
    Landing.prototype.initEvents = function() {
        ...
        $('.close').click(function() {
            $('.footer-panel').slideUp(250, function() {
                $('.footer-panel .holder').fadeOut(250)
            });
            return false;
        });
    };
