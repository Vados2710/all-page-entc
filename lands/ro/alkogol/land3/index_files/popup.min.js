$(document).ready(function () {
	function s() {
		...
		function e() {
			a = Math.floor(301 * Math.random() + 300)
		}
		function n() {
			m = 1,
			$(".show-message__item:nth-child(" + m + ")").fadeIn(0).delay(6e3).fadeOut(0),
			e(),
		...
		function p() {
			_ > 5 && (d = 0 == t ? 3 : 1 == t ? 4 : 2 == t ? 6 : 3 == t ? 8 : 4 == t ? 10 : 5 == t || 9 == t ? 3 : 6 == t || 10 == t ? 5 : 4, $(".blink").html(_), _ -= d, t++, l = r * d, $(".bay").html(d), $(".blink_me").html(_), $(".x_price").html(l), $(".count").html(t), $(".lastpack").html(_), i = 3 == t || 5 == t || 8 == t || 10 == t || 12 == t || 15 == t || 17 == t || 20 == t ? o : b, setTimeout(p, i, _)),
			_ <= 5 && (setTimeout(function () {
		...
		function c() {
			...
			n = [];
			for (e = 0; e < 36; e++)
				s = (Math.random() * v).toFixed(0), h[s] == n ? s = (Math.random() * v).toFixed(0) : ($(".js-name").eq(e).html(h[s]), n = h[s]), a += 1
		}
		
		var l,
		i = 12e3,
		r = Number($(".x_price_current").html()),
		_ = 60,
		m = 0,
		d = 0,
		t = 0,
		...
		setTimeout(function () {
			setInterval(function () {
				m++,
				m > 38 && (m = 1),
				$(".show-message__item:nth-child(" + m + ")").fadeIn(500).delay(6e3).fadeOut(500)
			}, 24e3),
			n()
		}, 0),
		s(),
	...
	function c() {
		1 == i && s(),
		1 == r && (e(), setInterval(e, 6e4)),
		1 == _ && n(),
		1 == l && $(window).width() > 991 && p()
	}
	var l = !0,
	i = !0,
	r = !0,
