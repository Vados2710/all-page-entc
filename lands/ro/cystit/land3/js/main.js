    ...
    $('.js-getResult').on('change', function(){
        ...
        setTimeout(function(){
            ...
            if(CheckSlide){
                ...
                switch (valCheck) {
                    case 0:
                        $('.resheader').html('Probabilitate redusă de cistită');
                        $('.restext').html('Nu uitați de prevenirea sezonieră<br> с <span><b>Cystonette</b></span>');
                        break;
                    case 1:
                        $('.resheader').html('Probabilitatea medie de cistită');
                        $('.restext').html('Curs de prevenire recomandat <span><b>Cystonette</b></span>.');
                        break;
                    case 2:
                        $('.resheader').html('Probabilitate mare de cistită');
                        $('.restext').html('Cursuri regulate recomandate <span><b>Cystonette</b></span><br> De 3-4 ori pe an.');
                        break;
                    default:
                        $('.resheader').html('Probabilitate mare de cistită');
                        $('.restext').html('Cursuri regulate recomandate <span><b>Cystonette</b></span><br>  De 3-4 ori pe an.');
