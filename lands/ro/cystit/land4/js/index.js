...
// то делать это необходимо в контейнере с классом .-build
// false (показывать контейнер) / true (не показывать контейнер)

var popupBuild = true; // false/true


//.-btn - класс для для открытия попапа
...
function postDate() {
    ...
    var sa = body.getAttribute('data-post-format') || 'http://evrhst-a.akamaihd.net/8967/dd.mm.yyyy',
        msInDay = 86400000,
