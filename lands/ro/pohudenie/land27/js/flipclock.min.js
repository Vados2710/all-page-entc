    ...
    FlipClock.DailyCounterFace = FlipClock.Face.extend({
        ...
        build: function (b) {
            ...
            b = b ? b : this.factory.time.getDayCounter(this.showSeconds), b.length > d.length && a.each(b, function (a, b) {
                c.createList(b)
            }), this.showSeconds ? a(this.createDivider("Secunde")).insertBefore(this.lists[this.lists.length - 2].$el) : e = 2, a(this.createDivider("Minute")).insertBefore(this.lists[this.lists.length - 4 + e].$el), a(this.createDivider("Ore")).insertBefore(this.lists[this.lists.length - 6 + e].$el), a(this.createDivider("Days", !0)).insertBefore(this.lists[0].$el), this.base()
        },
        flip: function (a, b) {
    ...
    FlipClock.HourlyCounterFace = FlipClock.Face.extend({
        ...
        build: function (b, c) {
            ...
            c = c ? c : this.factory.time.getHourCounter(), c.length > e.length && a.each(c, function (a, b) {
                d.createList(b)
            }), a(this.createDivider("Secunde")).insertBefore(this.lists[this.lists.length - 2].$el), a(this.createDivider("Minute")).insertBefore(this.lists[this.lists.length - 4].$el), b || a(this.createDivider("Ore", !0)).insertBefore(this.lists[0].$el), this.base()
        },
        flip: function (a, b) {
...
function () {
    FlipClock.Lang.Arabic = {
        years: "Ð¨Ñ–Ð©â€ Ð©â‚¬Ð¨Â§Ð¨Ð„",
        months: "Ð¨Ò‘Ð©â€¡Ð©â‚¬Ð¨Â±",
        days: "Ð¨ÐˆÐ©Ð‰Ð¨Â§Ð©â€¦",
        hours: "Ð¨Ñ–Ð¨Â§Ð¨â„–Ð¨Â§Ð¨Ð„",
        minutes: "Ð¨Ð‡Ð©â€šÐ¨Â§Ð¨Â¦Ð©â€š",
        seconds: "Ð¨Â«Ð©â‚¬Ð¨Â§Ð©â€ Ð©Ð‰"
...
function () {
    FlipClock.Lang.Russian = {
        years: "Ð Â»Ð ÂµÐ¡â€š",
        months: "Ð Ñ˜Ð ÂµÐ¡ÐƒÐ¡ÐÐ¡â€ Ð ÂµÐ Ð†",
        days: "Ð Ò‘Ð Ð…Ð ÂµÐ â„–",
        hours: "Ð¡â€¡Ð Â°Ð¡ÐƒÐ Ñ•Ð Ð†",
        minutes: "Ð Ñ˜Ð Ñ‘Ð Ð…Ð¡Ñ“Ð¡â€š",
        seconds: "Ð¡ÐƒÐ ÂµÐ Ñ”Ð¡Ñ“Ð Ð…Ð Ò‘"
