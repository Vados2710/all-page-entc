    ...
    Landing.prototype.initCountDown = function () {
        ...
        var countDownTimer = setInterval(function () {
            ...
            var htmlTime = ' <div class="timer">' + 
                                '<div class="block">' + '<div class="rect hours for-win">'+ h +'</div>' + '<p>ώρες</p>' +'</div>' +  
                                '<div class="block">' + '<div class="rect mins for-win">'+ m +'</div>'  + '<p>λεπτά</p>' +'</div>' + 
                                '<div class="block">' + '<div class="rect secs for-win">'+ s +'</div>'  + '<p>δευτερόλεπτα</p>' +'</div>' + 
                                '<div class="clear"></div>' +
                            '</div>' ;
