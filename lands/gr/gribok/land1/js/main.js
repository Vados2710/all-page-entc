(function($){
    ...
    var Landing = function () {
        ...
        this.params = {
            ...
            selectors: {
                ...
                scrollTo: '.landing__scrollTo',
                slider: '.landing__slider',
                modal: '.landing__modal',
    ...
    Landing.prototype.initEvents = function() {
        $(this.params.selectors.scrollTo).on('click', this.scrollToForm);
    };
    ...
    Landing.prototype.initModal = function(event) {
        var _this = this;
        ouibounce(document.getElementsByClassName('landing__modal')[0], {
           aggressive: true,
           timer: 0,
           oneEvent: false,
           sensitivity: 100
       ...
       $(this.params.selectors.modal + ' .close-modal-mouse').on('click', function () {
           $(_this.params.selectors.modal).hide();
       });

       $(this.params.selectors.modal + '.modal').on('click', function (event) {
           event.stopPropagation();
       });
    };
    Landing.prototype.initSlider = function(event) {
        $(this.params.selectors.slider).bxSlider({
            minSLides: 1
        });
    };
    $(function() {
