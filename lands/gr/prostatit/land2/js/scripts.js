...
function(t, e) {
    t.exports = {
        render: function() {
            ...
            return t.showModals ? n("div", {
            ...
            }), t._v(" "), n("span", [t._v(t._s(t.name) + " сделал(а) заказ на " + t._s(t.randomSold) + " акционных упаковок. Осталось упаковок по акции "), n("span", {
                staticClass: "blink"
            }, [t._v(t._s(t.prodsTotal + t.randomSold))]), t._v(" " + t._s(t.prodsTotal))])]) : t.isSpecial147 ? n("div", [n("i", {
                staticClass: "everad-sprite everad-sprite-bucket"
            }), t._v(" "), n("span", [t._v(t._s(t.name) + " сделал(а) заказ на сумму " + t._s(t.amount * t.randomSold) + " " + t._s(t.currency) + ", заказано " + t._s(t.randomSold) + " порций. Осталось упаковок по акции "), n("span", {
                staticClass: "blink"
            }, [t._v(t._s(t.prodsTotal + t.randomSold))]), t._v(" " + t._s(t.prodsTotal))])]) : n("div", [n("i", {
                staticClass: "everad-sprite everad-sprite-bucket"
            }), t._v(" "), n("span", [t._v(t._s(t.name) + " сделал(а) заказ на сумму " + t._s(t.amount * t.randomSold) + " " + t._s(t.currency) + ", заказано " + t._s(t.randomSold) + " акционных упаковок. Осталось упаковок по акции "), n("span", {
                staticClass: "blink"
            ...
            }), t._v(" "), n("span", [t._v("Уже " + t._s(t.usersOnline) + " человек(а) получили упаковку по акции за " + t._s(t.amount) + " " + t._s(t.currency) + ".")])]) : t.isFree ? n("div", [n("i", {
                staticClass: "everad-sprite everad-sprite-online_user"
            }), t._v(" "), n("span", [t._v("Уже " + t._s(t.usersOnline) + " человек(а) получили упаковку бесплатно")])]) : n("div", [n("i", {
                staticClass: "everad-sprite everad-sprite-online_user"
            }), t._v(" "), n("span", [t._v("Количество посетителей на сайте: " + t._s(t.usersOnline))])])]), t._v(" "), n("div", {
                staticClass: "user-online order-modal",
                class: {
            ...
            }), t._v(" "), n("span", [t._v(t._s(t.name) + ", сделал(а) заявку на обратный звонок")])])]), t._v(" "), n("div", {
                staticClass: "user-online order-modal",
                class: {
                ...
                staticClass: "everad-sprite everad-sprite-bucket"
            }), t._v(" "), n("span", [t._v("Осталось упаковок по акции "), n("span", {
...
function lastpack(numpack) {
    var minNumPack = 12; // Минимальное количество упаковок
