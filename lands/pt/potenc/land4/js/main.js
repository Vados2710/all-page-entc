 ...
 if (document.body.classList.contains('ev-date')) {
  ...
  var reviews = function () {
    $(".reviews-item__btn").on("click", function () {
      ...
      if (!$(this).data("status")) {
        $(this).html("Ocultar crítica");
        $(this).data("status", true);
      } else {
        $(this).html("Leia a crítica completa");
    ...
    $(".js-reviews-btn").click(function () {
      fileText.html("Carregar sua foto");
      labelFile.removeClass("rloaded");
      $(".feedback-form__checkmark-icon").hide();
      $(".feedback").fadeIn();
    });
      ...
      if (counter == 1) {
        $(".form__visitors p")
          .fadeOut(1100, function () {
            $(this).text("116 de vendas para a última hora");
          })
          .fadeIn();
        counter = 0;
      } else {
        $(".form__visitors p")
          .fadeOut(1100, function () {
            $(this).text("Agora existem " + randNum + " pessoas no site");
          })
          .fadeIn();
        counter = 1;
      }
